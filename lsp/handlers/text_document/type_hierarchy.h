...
std::optional<json> prepare_type_hierarchy_handler(Workspace& workspace,
                                                   int /*id*/,
                                                   json raw_params) {
  ...
  type_item.selectionRange.m_start = {(uint32_t)def_loc->line_idx, (uint32_t)def_loc->char_idx + 8};
...
std::optional<json> supertypes_type_hierarchy_handler(Workspace& workspace,
                                                      int /*id*/,
                                                      json raw_params) {
...
std::optional<json> subtypes_type_hierarchy_handler(Workspace& workspace,
                                                    int /*id*/,
                                                    json raw_params) {
  auto params = raw_params.get<LSPSpec::TypeHierarchySupertypesParams>();
  const std::optional<GameVersion> game_version =
