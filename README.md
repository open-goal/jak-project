...
This project is to port the original Jak and Daxter and Jak II to PC. Over 98% of the games is written in GOAL, a custom Lisp language developed by Naughty Dog. Our strategy is:
