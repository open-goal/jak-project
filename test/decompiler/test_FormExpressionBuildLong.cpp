...
TEST_F(FormRegressionTest, ExprArrayMethod2) {
  ...
  std::string expected =
      ...
      "          (+\n"
      "           (shl s5-8 4)\n"
      "           (the-as int (the-as (array uint128) arg0))\n"
      "           )\n"
      "          )\n"
      "         (.lq a2-8 12 v1-42)\n"
      ...
      "       (if\n"
      "        (zero? s5-10)\n"
      "        (format (quote #t) L343 (-> (the-as (array float) arg0) s5-10))\n"
      "        (format (quote #t) L337 (-> (the-as (array float) arg0) s5-10))\n"
      "        )\n"
      "       (set! s5-10 (+ s5-10 1))\n"
      "       )\n"
      "      (set! v1-59 (quote #f))\n"
      ...
      "       (if\n"
      "        (zero? s5-11)\n"
      "        (format (quote #t) L336 (-> (the-as (array basic) arg0) s5-11))\n"
      "        (format (quote #t) L335 (-> (the-as (array basic) arg0) s5-11))\n"
      "        )\n"
      "       (set! s5-11 (+ s5-11 1))\n"
      "       )\n"
      "      (set! v1-68 (quote #f))\n"
...
TEST_F(FormRegressionTest, ExprArrayMethod3) {
  ...
  std::string expected =
      "(begin\n"
      "  (format (quote #t) L333 arg0 (-> arg0 type))\n"
      "  (format (quote #t) L332 (-> arg0 allocated-length))\n"
      "  (format (quote #t) L331 (-> arg0 length))\n"
      "  (format (quote #t) L330 (-> arg0 content-type))\n"
      "  (format (quote #t) L329 (-> arg0 allocated-length) (-> arg0 data))\n"
      "  (cond\n"
      "   ((type-type? (-> arg0 content-type) integer)\n"
      "    (set! v1-1 (-> arg0 content-type symbol))\n"
      "    (cond\n"
      ...
      "      (while\n"
      "       (< s5-0 (-> arg0 length))\n"
      "       (format (quote #t) L328 s5-0 (-> (the-as (array int32) arg0) s5-0))\n"
      "       (set! s5-0 (+ s5-0 1))\n"
      "       )\n"
      "      (set! v1-5 (quote #f))\n"
      "      (quote #f)\n"
      ...
      "      (while\n"
      "       (< s5-1 (-> arg0 length))\n"
      "       (format (quote #t) L328 s5-1 (-> (the-as (array uint32) arg0) s5-1))\n"
      "       (set! s5-1 (+ s5-1 1))\n"
      "       )\n"
      "      (set! v1-10 (quote #f))\n"
      "      (quote #f)\n"
      ...
      "      (while\n"
      "       (< s5-2 (-> arg0 length))\n"
      "       (format (quote #t) L328 s5-2 (-> (the-as (array int64) arg0) s5-2))\n"
      "       (set! s5-2 (+ s5-2 1))\n"
      "       )\n"
      "      (set! v1-15 (quote #f))\n"
      "      (quote #f)\n"
      ...
      "      (while\n"
      "       (< s5-3 (-> arg0 length))\n"
      "       (format (quote #t) L327 s5-3 (-> (the-as (array uint64) arg0) s5-3))\n"
      "       (set! s5-3 (+ s5-3 1))\n"
      "       )\n"
      "      (set! v1-20 (quote #f))\n"
      "      (quote #f)\n"
      ...
      "      (while\n"
      "       (< s5-4 (-> arg0 length))\n"
      "       (format (quote #t) L328 s5-4 (-> (the-as (array int8) arg0) s5-4))\n"
      "       (set! s5-4 (+ s5-4 1))\n"
      "       )\n"
      "      (set! v1-24 (quote #f))\n"
      "      (quote #f)\n"
      ...
      "      (while\n"
      "       (< s5-5 (-> arg0 length))\n"
      "       (format (quote #t) L328 s5-5 (-> (the-as (array int8) arg0) s5-5))\n"
      "       (set! s5-5 (+ s5-5 1))\n"
      "       )\n"
      "      (set! v1-28 (quote #f))\n"
      "      (quote #f)\n"
      ...
      "      (while\n"
      "       (< s5-6 (-> arg0 length))\n"
      "       (format (quote #t) L328 s5-6 (-> (the-as (array int16) arg0) s5-6))\n"
      "       (set! s5-6 (+ s5-6 1))\n"
      "       )\n"
      "      (set! v1-33 (quote #f))\n"
      "      (quote #f)\n"
      ...
      "      (while\n"
      "       (< s5-7 (-> arg0 length))\n"
      "       (format (quote #t) L328 s5-7 (-> (the-as (array uint16) arg0) s5-7))\n"
      "       (set! s5-7 (+ s5-7 1))\n"
      "       )\n"
      "      (set! v1-38 (quote #f))\n"
      "      (quote #f)\n"
      ...
      "        (while\n"
      "         (< s5-9 (-> arg0 length))\n"
      "         (format (quote #t) L328 s5-9 (-> arg0 s5-9))\n"
      "         (set! s5-9 (+ s5-9 1))\n"
      "         )\n"
      "        (set! v1-49 (quote #f))\n"
      "        (quote #f)\n"
      ...
      "      (while\n"
      "       (< s5-10 (-> arg0 length))\n"
      "       (format (quote #t) L326 s5-10 (-> (the-as (array float) arg0) s5-10))\n"
      "       (set! s5-10 (+ s5-10 1))\n"
      "       )\n"
      "      (set! v1-55 (quote #f))\n"
      "      (quote #f)\n"
      ...
      "      (while\n"
      "       (< s5-11 (-> arg0 length))\n"
      "       (format (quote #t) L325 s5-11 (-> (the-as (array basic) arg0) s5-11))\n"
      "       (set! s5-11 (+ s5-11 1))\n"
      "       )\n"
      "      (set! v1-60 (quote #f))\n"
      "      (quote #f)\n"
...
TEST_F(FormRegressionTest, ExprValid) {
  ...
  std::string expected =
      ...
      "      (if arg2 (set! v1-4 (format arg4 L321 arg0 arg2)))\n"
      "      (quote #f)\n"
      "      )\n"
      "     ((not v1-1) (if arg2 (set! v1-6 (format arg4 L320 arg0 arg2))) (quote #f))\n"
      "     (else (quote #t))\n"
      "     )\n"
      "    )\n"
      ...
      "        (if arg2 (set! v1-8 (format arg4 L319 arg0 arg2 arg1)))\n"
      "        (quote #f)\n"
      "        )\n"
      "       ((or\n"
      "         (not v1-1)\n"
      ...
      "          )\n"
      "         )\n"
      "        (if arg2 (set! v1-13 (format arg4 L318 arg0 arg2 arg1)))\n"
      "        (quote #f)\n"
      "        )\n"
      "       (else (quote #t))\n"
      "       )\n"
      ...
      "        (if arg2 (set! v1-15 (format arg4 L319 arg0 arg2 arg1)))\n"
      "        (quote #f)\n"
      "        )\n"
      "       ((not v1-1)\n"
      "        (if arg2 (set! v1-17 (format arg4 L318 arg0 arg2 arg1)))\n"
      "        (quote #f)\n"
      "        )\n"
      "       (else (quote #t))\n"
      "       )\n"
      ...
      "       (else\n"
      "        (if arg2 (set! v1-20 (format arg4 L319 arg0 arg2 arg1)))\n"
      "        (quote #f)\n"
      "        )\n"
      "       )\n"
      "      )\n"
      "     ((!= (logand (the-as int arg0) 7) 4)\n"
      "      (if arg2 (set! v1-22 (format arg4 L319 arg0 arg2 arg1)))\n"
      "      (quote #f)\n"
      "      )\n"
      "     ((not v1-1)\n"
      "      (if arg2 (set! v1-24 (format arg4 L318 arg0 arg2 arg1)))\n"
      "      (quote #f)\n"
      "      )\n"
      "     ((and (= arg1 type) (!= (rtype-of arg0) type))\n"
      "      (if arg2 (set! v1-31 (format arg4 L317 arg0 arg2 arg1 (rtype-of arg0))))\n"
      "      (quote #f)\n"
      "      )\n"
      "     (else\n"
      "      (set!\n"
      ...
      "      (cond\n"
      "       (v1-33\n"
      "        (if arg2 (set! v1-37 (format arg4 L317 arg0 arg2 arg1 (rtype-of arg0))))\n"
      "        (quote #f)\n"
      "        )\n"
      "       ((not (type-type? (rtype-of arg0) arg1))\n"
      "        (if arg2 (set! v1-41 (format arg4 L316 arg0 arg2 arg1 (rtype-of arg0))))\n"
      "        (quote #f)\n"
      "        )\n"
      "       ((= arg1 symbol)\n"
      "        (set! v1-43 32768)\n"
      ...
      "          (if arg2 (set! v1-46 (format arg4 L315 arg0 arg2 arg1)))\n"
      "          (quote #f)\n"
      "          )\n"
      "         (else (quote #t))\n"
      "         )\n"
      ...
      "         )\n"
      "        (if arg2 (set! v1-50 (format arg4 L314 arg0 arg2 arg1)))\n"
      "        (quote #f)\n"
      "        )\n"
      "       (else (quote #t))\n"
      "       )\n"
