...
std::vector<ReplaceInfo> replace_info_jak2 = {
    ...
    {"~Y~26L<FLAG_PART_FILL>~]~-1H~Y~26L<FLAG_PART_FILL>~Z~-10H~-3V~5L<PAD_PART_DPAD_D>~Z~-10H"
     ...
     "<FLAG_BRAZIL>"},
    {"~Y~3L~~~Z~1L<FLAG_PART_HORZ_STRIPE_MIDDLE>~Z~26L<FLAG_PART_HORZ_STRIPE_BOTTOM>~]~-1H~Y~3L~~"
     "~Z~1L<FLAG_PART_HORZ_STRIPE_MIDDLE>~Z~26L<FLAG_PART_HORZ_STRIPE_BOTTOM>~Z~+26H",
     "<FLAG_HUNGARY>"},
    {"~Y~3L<FLAG_PART_FILL>~Z~5L<FLAG_PART_USA_STRIPES_RIGHT>~]~-1H~Y~3L<FLAG_PART_FILL>~Z~5L"
     "<FLAG_PART_USA_STRIPES_RIGHT>~Z~+26H",
     "<FLAG_CATALAN>"},
    {"~Y~1L<FLAG_PART_FILL>~Z~3L<FLAG_PART_HORZ_STRIPE_BOTTOM>~Z~-5V~3L<FLAG_PART_HORZ_STRIPE"
     "_BOTTOM>~]~-1H~+5V~Y~1L<FLAG_PART_FILL>~Z~3L<FLAG_PART_HORZ_STRIPE_BOTTOM>~Z~-5V~3L"
     "<FLAG_PART_HORZ_STRIPE_BOTTOM>~Z~+26H",
     "<FLAG_POLAND>"},
    {"~Y~5L~~~Z~26L<FLAG_PART_HORZ_STRIPE_MIDDLE>~Z~3L<FLAG_PART_HORZ_STRIPE_BOTTOM>~]~-1H~Y~5L~~"
     "~Z~26L<FLAG_PART_HORZ_STRIPE_MIDDLE>~Z~3L<FLAG_PART_HORZ_STRIPE_BOTTOM>~Z~+26H",
     "<FLAG_LITHUANIA>"},
    {"~Y~1L<FLAG_PART_FILL>~Z~3L<FLAG_PART_HORZ_STRIPE_BOTTOM>~]~-1H~Y~1L<FLAG_PART_FILL>~Z~3L"
     "<FLAG_PART_HORZ_STRIPE_BOTTOM>~Z~-5V~3L<FLAG_PART_HORZ_STRIPE_BOTTOM>~Z~-23H~-5V~3L"
     "<FLAG_PART_HORZ_STRIPE_BOTTOM>~Z~-23H~7L<FLAG_PART_VERT_STRIPE_LARGE>~Z~-4V~-18H~1L"
     "<PAD_PART_STICK_DOWN>~Z~-10V~-21H~1L<PAD_PART_STICK_DOWN>~Z~-8V~-19H~1L<PAD_PART_STICK_DOWN>"
     "~Z~+6V~-18H~3L<PAD_PART_STICK_UP>~Z~+12V~-21H~3L<PAD_PART_STICK_UP>~Z~+10V~-19H~3L"
     "<PAD_PART_STICK_UP>~Z~+26H",
     "<FLAG_CZECH>"},
    {"~Y~3L~~~Z~1L<FLAG_PART_HORZ_STRIPE_MIDDLE>~Z~7L<FLAG_PART_HORZ_STRIPE_BOTTOM>~]~-1H~Y~3L~~"
     "~Z~1L<FLAG_PART_HORZ_STRIPE_MIDDLE>~Z~7L<FLAG_PART_HORZ_STRIPE_BOTTOM>~Z~-11H~+2V~3L"
     "<FLAG_PART_JAPAN_SUN>~Z~-9H~-3V~1L+~Z~-8V~-8H~7L-~Z~-8V~-3H~7L-~Z~+26H",
     "<FLAG_CROATIA>"},
    {"~Y~1L<FLAG_PART_FILL>~Z~21L<FLAG_PART_UK_CROSS_LEFT>~Z~1L<FLAG_PART_HORZ_STRIPE_MIDDLE>"
     "~Z~1L<FLAG_PART_HORZ_STRIPE_BOTTOM>~]~-1H~Y~1L<FLAG_PART_FILL>~Z~21L<FLAG_PART_UK_CROSS_RIGHT>"
     "~Z~1L<FLAG_PART_HORZ_STRIPE_MIDDLE>~Z~-4H~1L<FLAG_PART_VERT_STRIPE_LEFT>~Z~1L~~"
