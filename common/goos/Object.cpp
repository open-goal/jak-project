...
const char* SymbolTable::intern(const char* str) {
...
Object* EnvironmentMap::lookup(const char* str) {
  ...
  u32 hash = crc32((const u8*)&str, sizeof(const char*));
...
void EnvironmentMap::set(const char* str, const Object& obj) {
  u32 hash = crc32((const u8*)&str, sizeof(const char*));
 ...
 */
template <>
std::string fixed_to_string(FixedSymbolPtr x) {
  return x.name_ptr;
}
