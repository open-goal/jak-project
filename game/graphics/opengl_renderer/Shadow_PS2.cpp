...
void ShadowRenderer::handle_bal52_jak2() {
  // clang-format off
  // nop                        |  subw.w vf31, vf30, vf31      736
  vu.vf31.sub(Mask::w, vu.vf30, vu.vf31.w());
  // div Q, vf30.w, vf31.w      |  sub.xyzw vf16, vf15, vf14
  vu.vf16.sub(Mask::xyzw, vu.vf15, vu.vf14);   vu.Q = vu.vf30.w() / vu.vf31.w();
  // waitq                      |  mul.xyzw vf16, vf16, Q         737
  vu.vf16.mul(Mask::xyzw, vu.vf16, vu.Q);
  // jr vi11                    |  add.xyzw vf16, vf14, vf16      738
  vu.vf16.add(Mask::xyzw, vu.vf14, vu.vf16);
...
void ShadowRenderer::handle_bal53() {
  // clang-format off
  //  nop                        |  subw.w vf30, vf30, vf31
  vu.vf30.sub(Mask::w, vu.vf30, vu.vf31.w());
  //  div Q, vf31.w, vf30.w      |  sub.xyzw vf16, vf14, vf15
  vu.vf16.sub(Mask::xyzw, vu.vf14, vu.vf15);   vu.Q = vu.vf31.w() / vu.vf30.w();
  //  waitq                      |  mul.xyzw vf16, vf16, Q
  vu.vf16.mul(Mask::xyzw, vu.vf16, vu.Q);
  //  jr vi11                    |  sub.xyzw vf16, vf15, vf16
  vu.vf16.sub(Mask::xyzw, vu.vf15, vu.vf16);
  //  nop                        |  nop
  //  lq. vf00, 0(vi00)          |  addx. vf00, vf00, vf00
  // TODO
}

// TODO missing cases for jak 2
...
void ShadowRenderer::run_mscal_vu2c_jak2(u16 imm) {
  u32 cf = 0, sf0, sf1;
  bool bc;
  switch (imm) {
    case 2:
  ...
  vu.vf17.mul(Mask::z, vu.vf17, vu.vf12.w());
  // nop                        |  opmsub.xyz vf29, vf30, vf29    69
  vu.acc.opmsub(vu.vf29, vu.vf30, vu.vf29);
  // div Q, vf12.x, vf19.w      |  mul.xyz vf18, vf18, Q          72
  vu.vf18.mul(Mask::xyz, vu.vf18, vu.Q);   vu.Q = vu.vf12.x() / vu.vf19.w();
  ...
  vu.vf18.mul(Mask::z, vu.vf18, vu.vf12.w());
  // nop                        |  mul.xy vf25, vf25, vf04        75
  vu.vf25.mul(Mask::xy, vu.vf25, vu.vf04);
  // nop                        |  mul.xyz vf19, vf19, Q          76
  vu.vf19.mul(Mask::xyz, vu.vf19, vu.Q);
  // nop                        |  ftoi4.xyzw vf17, vf17          78
  vu.vf17.ftoi4(Mask::xyzw, vu.vf17);
  // fcset 0x0                  |  addy.x vf29, vf29, vf29        79
  vu.vf29.add(Mask::x, vu.vf29, vu.vf29.y());   cf = 0x0;
  // nop                        |  add.xyzw vf18, vf18, vf05      80
  vu.vf18.add(Mask::xyzw, vu.vf18, vu.vf05);
  // nop                        |  clipw.xyz vf21, vf21           85
  cf = clip(vu.vf21, vu.vf21.w(), cf);
  // nop                        |  mulw.z vf19, vf19, vf12        86
  vu.vf19.mul(Mask::z, vu.vf19, vu.vf12.w());
  // sq.xyzw vf25, 4(vi02)      |  mul.xy vf26, vf26, vf04        87
  vu.vf26.mul(Mask::xy, vu.vf26, vu.vf04);   sq_buffer(Mask::xyzw, vu.vf25, vu.vi02 + 4);
  // sq.xyzw vf17, 5(vi02)      |  addz.x vf29, vf29, vf29
  vu.vf29.add(Mask::x, vu.vf29, vu.vf29.z());  sq_buffer(Mask::xyzw, vu.vf17, vu.vi02 + 5);
  // nop                        |  ftoi4.xyzw vf18, vf18          88
  vu.vf18.ftoi4(Mask::xyzw, vu.vf18);
  // nop                        |  add.xy vf27, vf19, vf03        89
  vu.vf27.add(Mask::xy, vu.vf19, vu.vf03);
  ...
  // b L5                       |  nop                            95
  bc = true;
  // lq.xyzw vf31, 887(vi00)    |  nop                            96
  lq_buffer(Mask::xyzw, vu.vf31, 887);
  if (bc) { goto L5; }

  L4:
  // lq.xyzw vf31, 886(vi00)    |  nop                            97
  lq_buffer(Mask::xyzw, vu.vf31, 886);
  L5:
  // fcand vi01, 0x3ffff        |  ftoi4.xyzw vf19, vf19          98
  vu.vf19.ftoi4(Mask::xyzw, vu.vf19);   fcand(vu.vi01, 0x3ffff, cf);
  ...
  ilw_buffer(Mask::y, vu.vi01, vu.vi03);
  // iaddi vi03, vi03, 0x1      |  nop                            111
  vu.vi03 = vu.vi03 + 1;
  L7:
  // lqi.xyzw vf16, vi03        |  nop                            112
  ...
  // nop                        |  mul.xy vf25, vf25, vf04        147
  vu.vf25.mul(Mask::xy, vu.vf25, vu.vf04);
  // nop                        |  mul.xyz vf19, vf19, Q          148
  vu.vf19.mul(Mask::xyz, vu.vf19, vu.Q);
  // nop                        |  ftoi4.xyzw vf17, vf17          150
  vu.vf17.ftoi4(Mask::xyzw, vu.vf17);
  // fcset 0x0                  |  addy.x vf29, vf29, vf29        151
  vu.vf29.add(Mask::x, vu.vf29, vu.vf29.y());   cf = 0x0;
  // nop                        |  add.xyzw vf18, vf18, vf05      152
  vu.vf18.add(Mask::xyzw, vu.vf18, vu.vf05);
  // nop                        |  clipw.xyz vf21, vf21           157
  cf = clip(vu.vf21, vu.vf21.w(), cf);
  // sq.xyzw vf25, 4(vi02)      |  mulw.z vf19, vf19, vf12        158
  vu.vf19.mul(Mask::z, vu.vf19, vu.vf12.w());   sq_buffer(Mask::xyzw, vu.vf25, vu.vi02 + 4);
  // sq.xyzw vf17, 5(vi02)      |  mul.xy vf26, vf26, vf04
  vu.vf26.mul(Mask::xy, vu.vf26, vu.vf04);   sq_buffer(Mask::xyzw, vu.vf17, vu.vi02 + 5);
  // iaddi vi08, vi08, -0x1     |  addz.x vf29, vf29, vf29        159
  sf0 = vu.vf29.add_and_set_sf_s(Mask::x, vu.vf29, vu.vf29.z());   vu.vi08 = vu.vi08 + -1;
  // nop                        |  ftoi4.xyzw vf18, vf18          160
  vu.vf18.ftoi4(Mask::xyzw, vu.vf18);
  ...
  // b L9                       |  nop                            167
  bc = true;
  // lq.xyzw vf31, 887(vi00)    |  nop                            168
  lq_buffer(Mask::xyzw, vu.vf31, 887);
  if (bc) { goto L9; }

  L8:
  // lq.xyzw vf31, 886(vi00)    |  nop                            169
  lq_buffer(Mask::xyzw, vu.vf31, 886);
  L9:
  // fcand vi01, 0x3ffff        |  ftoi4.xyzw vf19, vf19          170
  vu.vf19.ftoi4(Mask::xyzw, vu.vf19);   fcand(vu.vi01, 0x3ffff, cf);
  ...
  sq_buffer(Mask::xyzw, vu.vf25, vu.vi02 + 4);
  // sq.xyzw vf17, 5(vi02)      |  nop
  sq_buffer(Mask::xyzw, vu.vf17, vu.vi02 + 5);
  // nop                        |  add.xyzw vf18, vf18, vf05      282
  vu.vf18.add(Mask::xyzw, vu.vf18, vu.vf05);
  // nop                        |  clipw.xyz vf21, vf21           286
  cf = clip(vu.vf21, vu.vf21.w(), cf);
  ...
  // nop                        |  add.xy vf27, vf19, vf03        290
  vu.vf27.add(Mask::xy, vu.vf19, vu.vf03);
  // sq.xyzw vf26, 6(vi02)      |  mulw.z vf19, vf19, vf12        291
  vu.vf19.mul(Mask::w, vu.vf19, vu.vf12.w());   sq_buffer(Mask::xyzw, vu.vf26, vu.vi02 + 6);
  // fsand vi01, 0x2            |  clipw.xyz vf22, vf22           292
  cf = clip(vu.vf22, vu.vf22.w(), cf);   fsand(vu.vi01, 0x2, sf0);
  ...
  // nop                        |  add.xy vf28, vf20, vf03        295
  vu.vf28.add(Mask::xy, vu.vf20, vu.vf03);
  // nop                        |  mulw.z vf20, vf20, vf12        296
  vu.vf20.mul(Mask::w, vu.vf20, vu.vf12.w());
  // nop                        |  mul.xy vf27, vf27, vf04        297
  vu.vf27.mul(Mask::xy, vu.vf27, vu.vf04);
  // nop                        |  add.xyzw vf19, vf19, vf05      298
  vu.vf19.add(Mask::xyzw, vu.vf19, vu.vf05);
  // nop                        |  nop                            299
  // BRANCH!
  // ibeq vi00, vi01, L17       |  mul.xy vf28, vf28, vf04        300
  vu.vf28.mul(Mask::xy, vu.vf28, vu.vf04);   bc = (vu.vi01 == 0);
  // nop                        |  add.xyzw vf20, vf20, vf05      301
  vu.vf20.add(Mask::xyzw, vu.vf20, vu.vf05);
  if (bc) { goto L17; }
  ...
  // b L18                      |  nop                            302
  bc = true;
  // lq.xyzw vf31, 887(vi00)    |  nop                            303
  lq_buffer(Mask::xyzw, vu.vf31, 887);
  if (bc) { goto L18; }

  L17:
  // lq.xyzw vf31, 886(vi00)    |  nop                            304
  lq_buffer(Mask::xyzw, vu.vf31, 886);
  L18:
  // fcand vi01, 0xffffff       |  ftoi4.xyzw vf19, vf19          305
  vu.vf19.ftoi4(Mask::xyzw, vu.vf19);   fcand(vu.vi01, 0xffffff, cf);
  ...
  // nop                        |  mul.xyz vf19, vf19, Q          399
  vu.vf19.mul(Mask::xyz, vu.vf19, vu.Q);
  // sq.xyzw vf25, 4(vi02)      |  nop                            400
  sq_buffer(Mask::xyzw, vu.vf25, vu.vi02 + 4);
  // sq.xyzw vf17, 5(vi02)      |  add.xyzw vf18, vf18, vf05      401
  vu.vf18.add(Mask::xyzw, vu.vf18, vu.vf05);   sq_buffer(Mask::xyzw, vu.vf17, vu.vi02 + 5);
  // nop                        |  clipw.xyz vf21, vf21           402
  cf = clip(vu.vf21, vu.vf21.w(), cf);
  // nop                        |  mul.xy vf26, vf26, vf04        403
  vu.vf26.mul(Mask::xy, vu.vf26, vu.vf04);
  ...
  // nop                        |  add.xy vf27, vf19, vf03        406
  vu.vf27.add(Mask::xy, vu.vf19, vu.vf03);
  // sq.xyzw vf26, 6(vi02)      |  mulw.z vf19, vf19, vf12      407
  vu.vf19.mul(Mask::z, vu.vf19, vu.vf12.w());   sq_buffer(Mask::xyzw, vu.vf26, vu.vi02 + 6);
  // fsand vi01, 0x2            |  clipw.xyz vf22, vf22           408
  cf = clip(vu.vf22, vu.vf22.w(), cf);   fsand(vu.vi01, 0x2, sf0);
  ...
  // ibeq vi00, vi01, L25       |  mul.xy vf27, vf27, vf04        410
  vu.vf27.mul(Mask::xy, vu.vf27, vu.vf04);   bc = (vu.vi01 == 0);
  // nop                        |  add.xyzw vf19, vf19, vf05     411
  vu.vf19.add(Mask::xyzw, vu.vf19, vu.vf05);
  if (bc) { goto L25; }
  ...
  // b L26                      |  nop                            412
  bc = true;
  // lq.xyzw vf31, 887(vi00)    |  nop                            413
  lq_buffer(Mask::xyzw, vu.vf31, 887);
  if (bc) { goto L26; }

  L25:
  // lq.xyzw vf31, 886(vi00)    |  nop                            414
  lq_buffer(Mask::xyzw, vu.vf31, 886);
  L26:
  // fcand vi01, 0x3ffff        |  ftoi4.xyzw vf19, vf19          415
  vu.vf19.ftoi4(Mask::xyzw, vu.vf19);   fcand(vu.vi01, 0x3ffff, cf);
  ...
  // nop                        |  mul.xyz vf19, vf19, Q          475
  vu.vf19.mul(Mask::xyz, vu.vf19, vu.Q);
  // sq.xyzw vf25, 4(vi02)      |  nop                            476
  sq_buffer(Mask::xyzw, vu.vf25, vu.vi02 + 4);
  // sq.xyzw vf17, 5(vi02)      |  add.xyzw vf18, vf18, vf05      477
  vu.vf18.add(Mask::xyzw, vu.vf18, vu.vf05);   sq_buffer(Mask::xyzw, vu.vf17, vu.vi02 + 5);
  // nop                        |  clipw.xyz vf21, vf21           478
  cf = clip(vu.vf21, vu.vf21.w(), cf);
  // nop                        |  mul.xy vf26, vf26, vf04        479
  ...
  // nop                        |  add.xy vf27, vf19, vf03        482
  vu.vf27.add(Mask::xy, vu.vf19, vu.vf03);
  // sq.xyzw vf26, 6(vi02)      |  mulw.z vf19, vf19, vf12      483
  vu.vf19.mul(Mask::z, vu.vf19, vu.vf12.w());   sq_buffer(Mask::xyzw, vu.vf26, vu.vi02 + 6);
  // fsand vi01, 0x2            |  clipw.xyz vf22, vf22           484
  cf = clip(vu.vf22, vu.vf22.w(), cf);   fsand(vu.vi01, 0x2, sf0);
  ...
  // ibeq vi00, vi01, L31       |  mul.xy vf27, vf27, vf04        486
  vu.vf27.mul(Mask::xy, vu.vf27, vu.vf04);   bc = (vu.vi01 == 0);
  // nop                        |  add.xyzw vf19, vf19, vf05     487
  vu.vf19.add(Mask::xyzw, vu.vf19, vu.vf05);
  if (bc) { goto L31; }
  ...
  // b L32                      |  nop                            488
  bc = true;
  // lq.xyzw vf31, 887(vi00)    |  nop                            489
  lq_buffer(Mask::xyzw, vu.vf31, 887);
  if (bc) { goto L32; }

  L31:
  // lq.xyzw vf31, 886(vi00)    |  nop                            490
  lq_buffer(Mask::xyzw, vu.vf31, 886);
  L32:
  // fcand vi01, 0x3ffff        |  ftoi4.xyzw vf19, vf19          491
  vu.vf19.ftoi4(Mask::xyzw, vu.vf19);   fcand(vu.vi01, 0x3ffff, cf);
  ...
  // sq.xyzw vf00, 928(vi00)    |  nop                            537
  sq_buffer(Mask::xyzw, vu.vf00, 928);
  // iaddiu vi01, vi00, 0x2d3   |  nop                            538
  vu.vi01 = 0x2d3; /* 724 */
  // isw.z vi01, 893(vi00)      |  nop                            539
  isw_buffer(Mask::z, vu.vi01, 893);
  // iaddiu vi01, vi00, 0x2d5   |  nop                            540
  vu.vi01 = 0x2d5; /* 726 */
  // isw.z vi01, 900(vi00)      |  nop                            541
  isw_buffer(Mask::z, vu.vi01, 900);
  // iaddiu vi01, vi00, 0x2d7   |  nop                            542
  vu.vi01 = 0x2d7; /* 728 */
  // isw.z vi01, 907(vi00)      |  nop                            543
  isw_buffer(Mask::z, vu.vi01, 907);
  // iaddiu vi01, vi00, 0x2d9   |  nop                            544
  vu.vi01 = 0x2d9; /* 730 */
  // isw.z vi01, 914(vi00)      |  nop                            545
  isw_buffer(Mask::z, vu.vi01, 914);
  // iaddiu vi01, vi00, 0x2db   |  nop                            546
  vu.vi01 = 0x2db; /* 732 */
  // isw.z vi01, 921(vi00)      |  nop                            547
  isw_buffer(Mask::z, vu.vi01, 921);
  // iaddiu vi01, vi00, 0x2dd   |  nop                            548
  vu.vi01 = 0x2dd; /* 734 */
  // isw.z vi01, 928(vi00)      |  nop                            549
  isw_buffer(Mask::z, vu.vi01, 928);
  // iaddiu vi03, vi00, 0x3b0   |  nop                            550
  ...
  // sq.xyzw vf00, 928(vi00)    |  nop                            567
  sq_buffer(Mask::xyzw, vu.vf00, 928);
  // iaddiu vi01, vi00, 0x2d3   |  nop                            568
  vu.vi01 = 0x2d3; /* 724 */
  // isw.z vi01, 893(vi00)      |  nop                            569
  isw_buffer(Mask::z, vu.vi01, 893);
  // iaddiu vi01, vi00, 0x2d5   |  nop                            570
  vu.vi01 = 0x2d5; /* 726 */
  // isw.z vi01, 900(vi00)      |  nop                            571
  isw_buffer(Mask::z, vu.vi01, 900);
  // iaddiu vi01, vi00, 0x2d7   |  nop                            572
  vu.vi01 = 0x2d7; /* 728 */
  // isw.z vi01, 907(vi00)      |  nop                            573
  isw_buffer(Mask::z, vu.vi01, 907);
  // iaddiu vi01, vi00, 0x2d9   |  nop                            574
  vu.vi01 = 0x2d9; /* 730 */
  // isw.z vi01, 914(vi00)      |  nop                            575
  isw_buffer(Mask::z, vu.vi01, 914);
  // iaddiu vi01, vi00, 0x2db   |  nop                            576
  vu.vi01 = 0x2db; /* 732 */
  // isw.z vi01, 921(vi00)      |  nop                            577
  isw_buffer(Mask::z, vu.vi01, 921);
  // iaddiu vi01, vi00, 0x2dd   |  nop                            578
  vu.vi01 = 0x2dd; /* 734 */
  // isw.z vi01, 928(vi00)      |  nop                            579
  isw_buffer(Mask::z, vu.vi01, 928);
  // iaddiu vi03, vi00, 0x3b0   |  nop                            580
  ...
  vu.vf14.mul(Mask::z, vu.vf14, vu.vf12.w());
  // nop                        |  add.xyzw vf14, vf14, vf05      650
  vu.vf14.add(Mask::xyzw, vu.vf14, vu.vf05);
  // nop                        |  mul.xy vf26, vf26, vf04        651
  vu.vf26.mul(Mask::xy, vu.vf26, vu.vf04);
