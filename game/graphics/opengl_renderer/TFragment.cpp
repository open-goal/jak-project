...
void TFragment::handle_initialization(DmaFollower& dma, SharedRenderState* render_state) {
  ...
  unpack_to_stcycl(&m_matrix_0, mat0_upload, VifCode::Kind::UNPACK_V4_32, 4, 4, 64,
                   TFragDataMem::TFragMatrix0, false, false);
  m_debug_string += fmt::format("Matrix 0:\n {}\n", m_matrix_0.to_string_aligned());

  // matrix 1
  auto mat1_upload = dma.read_and_advance();
  unpack_to_stcycl(&m_matrix_1, mat1_upload, VifCode::Kind::UNPACK_V4_32, 4, 4, 64,
                   TFragDataMem::TFragMatrix1, false, false);
  ...
  m_globals.vf04_ambient = m_tfrag_data.ambient;
