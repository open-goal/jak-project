...
//  vu.vf25.move(Mask::zw, vu.vf27);
//  // sq.xyzw vf25, 3(vi00)      |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf25, 3);
//  // 2048.0                     |  nop :i
//  vu.I = 2048.0;
//  // 255.0                      |  maxi.x vf17, vf00, I :i
//  vu.vf17.maxi(Mask::x, vu.vf00, vu.I);
//  vu.I = 255.0;
//  // -65537.0                   |  maxi.y vf17, vf00, I :i
//  vu.vf17.maxi(Mask::y, vu.vf00, vu.I);
//  vu.I = -65537.0;
//  // mr32.xyzw vf02, vf01       |  minii.z vf17, vf00, I
//  vu.vf02.mr32(Mask::xyzw, vu.vf01);
//  vu.vf17.minii(Mask::z, vu.vf00, vu.I);
//  // lq.xyzw vf22, 2(vi00)      |  minii.z vf18, vf00, I
//  lq_buffer(Mask::xyzw, vu.vf22, 2);
//  vu.vf18.minii(Mask::z, vu.vf00, vu.I);
//  // 0.003921569                |  minii.z vf19, vf00, I :i
//  vu.vf19.minii(Mask::z, vu.vf00, vu.I);
//  vu.I = 0.003921569;
//  // sq.xyzw vf28, 4(vi00)      |  minii.w vf29, vf00, I :e
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf28, 4);
//  vu.vf29.minii(Mask::w, vu.vf00, vu.I);
//  // mr32.xyzw vf03, vf02       |  nop
//  vu.vf03.mr32(Mask::xyzw, vu.vf02);
//  return;
//
...
//  lq_buffer(Mask::xyz, vu.vf02, 133);
//  // lq.xyz vf03, 134(vi00)     |  addy.xy vf19, vf00, vf25
//  lq_buffer(Mask::xyz, vu.vf03, 134);
//  vu.vf19.add(Mask::xy, vu.vf00, vu.vf25.y());
//  // lq.xyzw vf04, 135(vi00)    |  mulx.xyzw vf26, vf26, vf25
//  lq_buffer(Mask::xyzw, vu.vf04, 135);
//  vu.vf26.mul(Mask::xyzw, vu.vf26, vu.vf25.x());
//  // lq.xyzw vf05, 136(vi00)    |  nop
//  lq_buffer(Mask::xyzw, vu.vf05, 136);
//  // lq.xyzw vf06, 137(vi00)    |  nop
//  lq_buffer(Mask::xyzw, vu.vf06, 137);
...
//  bc = true;
//  // sq.xyzw vf26, 5(vi00)      |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf26, 5);
//  if (bc) {
//    goto L4;
//  }
//
...
//L4:
//  // lq.xyzw vf28, 139(vi00)    |  minix.xyzw vf15, vf00, vf00
//  lq_buffer(Mask::xyzw, vu.vf28, 139);
//  vu.vf15.mini(Mask::xyzw, vu.vf00, vu.vf00.x());
//  // xtop vi15                  |  nop
//  vu.vi15 = xtop();
//  // iaddiu vi12, vi15, 0x8c    |  nop
//  vu.vi12 = vu.vi15 + 0x8c; /* 140 */
...
//  bc = (vu.vi15 == 0);
//  // ilwr.w vi03, vi12          |  maxz.xy vf18, vf00, vf28
//  ilw_buffer(Mask::w, vu.vi03, vu.vi12);
//  vu.vf18.max(Mask::xy, vu.vf00, vu.vf28.z());
//  if (bc) {
//    goto L5;
//  }
//
...
//  // iaddiu vi05, vi00, 0x7f    |  addw.xyz vf15, vf15, vf00
//  vu.vi05 = 0x7f; /* 127 */
//  vu.vf15.add(Mask::xyz, vu.vf15, vu.vf00.w());
//  // iand vi09, vi09, vi05      |  nop
//  vu.vi09 = vu.vi09 & vu.vi05;
//  // ilw.y vi06, 1(vi12)        |  miniz.w vf19, vf00, vf27
//  ilw_buffer(Mask::y, vu.vi06, vu.vi12 + 1);
//  vu.vf19.mini(Mask::w, vu.vf00, vu.vf27.z());
//  // BRANCH!
//  // ibeq vi00, vi02, L8        |  miniy.w vf18, vf00, vf27
//  bc = (vu.vi02 == 0);
//  vu.vf18.mini(Mask::w, vu.vf00, vu.vf27.y());
//  // ilwr.z vi01, vi12          |  minix.w vf17, vf00, vf27
//  ilw_buffer(Mask::z, vu.vi01, vu.vi12);
//  vu.vf17.mini(Mask::w, vu.vf00, vu.vf27.x());
//  if (bc) {
//    goto L8;
//  }
//
...
//  bc = (vu.vi09 != 0);
//  // sq.yzw vf14, 0(vi15)       |  nop
//  sq_buffer(__LINE__, Mask::yzw, vu.vf14, vu.vi15);
//  if (bc) {
//    goto L7;
//  }
//
...
//  vu.vi08 = vu.vf09.w_as_u16();
//  // sqi.xyzw vf13, vi02        |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf13, vu.vi02++);
//  fmt::print("adgif store @ {} from load at {}\n", vu.vi02 - 1, vu.vi03 - 5);
//  // sqi.xyzw vf08, vi02        |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf08, vu.vi02++);
//  // sqi.xyzw vf09, vi02        |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf09, vu.vi02++);
//  // mfir.x vf14, vi08          |  nop
//  vu.vf14.mfir(Mask::x, vu.vi08);
//  // sqi.xyzw vf10, vi02        |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf10, vu.vi02++);
//  // sqi.xyzw vf11, vi02        |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf11, vu.vi02++);
//  // BRANCH!
//  // ibeq vi00, vi10, L10       |  nop
//  bc = (vu.vi10 == 0);
//  // sqi.xyzw vf12, vi02        |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf12, vu.vi02++);
//  if (bc) {
//    goto L10;
//  }
//
...
//  bc = ((s16)vu.vi08) > 0;
//  // sq.xyzw vf14, 0(vi02)      |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf14, vu.vi02);
//  if (bc) {
//    goto L9;
//  }
//
...
//  lq_buffer(Mask::xyzw, vu.vf20, 4);
//  // ilw.z vi09, 3(vi12)        |  mul.xyzw vf27, vf28, vf15
//  ilw_buffer(Mask::z, vu.vi09, vu.vi12 + 3);
//  vu.vf27.mul(Mask::xyzw, vu.vf28, vu.vf15);
//  // ior vi11, vi08, vi00       |  mul.xyzw vf28, vf28, vf00
//  vu.vi11 = vu.vi08;
//  vu.vf28.mul(Mask::xyzw, vu.vf28, vu.vf00);
//  // BRANCH!
//  // ibeq vi00, vi08, L13       |  mul.xyzw vf15, vf16, vf15
//  bc = (vu.vi08 == 0);
//  vu.vf15.mul(Mask::xyzw, vu.vf16, vu.vf15);
//  // iaddi vi13, vi12, 0x3      |  mul.xyzw vf16, vf16, vf00
//  vu.vi13 = vu.vi12 + 3;
//  vu.vf16.mul(Mask::xyzw, vu.vf16, vu.vf00);
//  if (bc) {
//    goto L13;
//  }
//
//// we seem to fall through to here, then store adgifs in bogus places.
//L12:
//
//  // lq.xyzw vf08, 0(vi08)      |  addax.xyzw vf20, vf00
//  lq_buffer(Mask::xyzw, vu.vf08, vu.vi08);
//  vu.acc.adda(Mask::xyzw, vu.vf20, vu.vf00.x());
//  // lq.xyzw vf10, 1(vi08)      |  madda.xyzw ACC, vf27, vf25
//  lq_buffer(Mask::xyzw, vu.vf10, vu.vi08 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf27, vu.vf25);
//  // lq.xyzw vf12, 2(vi08)      |  maddz.xyzw vf26, vf28, vf25
//  lq_buffer(Mask::xyzw, vu.vf12, vu.vi08 + 2);
//  vu.acc.madd(Mask::xyzw, vu.vf26, vu.vf28, vu.vf25.z());
//  // lq.xyzw vf25, 3(vi08)      |  nop
//  lq_buffer(Mask::xyzw, vu.vf25, vu.vi08 + 3);
//  // sq.xyzw vf09, 0(vi11)      |  mula.xyzw ACC, vf15, vf08
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf09, vu.vi11);
//  fmt::print("adgif store 2 @ {}\n", vu.vi11);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf08);
//  // sq.xyzw vf11, 1(vi11)      |  maddz.xyzw vf09, vf16, vf08
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf11, vu.vi11 + 1);
//  vu.acc.madd(Mask::xyzw, vu.vf09, vu.vf16, vu.vf08.z());
//  // sq.xyzw vf13, 2(vi11)      |  mula.xyzw ACC, vf15, vf10
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf13, vu.vi11 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf10);
//  // sq.xyzw vf26, 3(vi11)      |  maddz.xyzw vf11, vf16, vf10
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf26, vu.vi11 + 3);
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf16, vu.vf10.z());
//  // BRANCH!
//  // ibeq vi00, vi08, L13       |  mula.xyzw ACC, vf15, vf12
//  bc = (vu.vi08 == 0);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf12);
//  // ilwr.w vi10, vi13          |  maddz.xyzw vf13, vf16, vf12
//  ilw_buffer(Mask::w, vu.vi10, vu.vi13);
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf16, vu.vf12.z());
//  if (bc) {
//    goto L13;
//  }
//
//  // lq.xyzw vf08, 0(vi09)      |  addax.xyzw vf20, vf00
//  lq_buffer(Mask::xyzw, vu.vf08, vu.vi09);
//  vu.acc.adda(Mask::xyzw, vu.vf20, vu.vf00.x());
//  // lq.xyzw vf10, 1(vi09)      |  madda.xyzw ACC, vf27, vf25
//  lq_buffer(Mask::xyzw, vu.vf10, vu.vi09 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf27, vu.vf25);
//  // lq.xyzw vf12, 2(vi09)      |  maddz.xyzw vf26, vf28, vf25
//  lq_buffer(Mask::xyzw, vu.vf12, vu.vi09 + 2);
//  vu.acc.madd(Mask::xyzw, vu.vf26, vu.vf28, vu.vf25.z());
//  // lq.xyzw vf25, 3(vi09)      |  nop
//  lq_buffer(Mask::xyzw, vu.vf25, vu.vi09 + 3);
//  // sq.xyzw vf09, 0(vi08)      |  mula.xyzw ACC, vf15, vf08
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf09, vu.vi08);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf08);
//  // sq.xyzw vf11, 1(vi08)      |  maddz.xyzw vf09, vf16, vf08
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf11, vu.vi08 + 1);
//  vu.acc.madd(Mask::xyzw, vu.vf09, vu.vf16, vu.vf08.z());
//  // sq.xyzw vf13, 2(vi08)      |  mula.xyzw ACC, vf15, vf10
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf13, vu.vi08 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf10);
//  // sq.xyzw vf26, 3(vi08)      |  maddz.xyzw vf11, vf16, vf10
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf26, vu.vi08 + 3);
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf16, vu.vf10.z());
//  // BRANCH!
//  // ibeq vi00, vi09, L13       |  mula.xyzw ACC, vf15, vf12
//  bc = (vu.vi09 == 0);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf12);
//  // ilw.x vi11, 1(vi13)        |  maddz.xyzw vf13, vf16, vf12
//  ilw_buffer(Mask::x, vu.vi11, vu.vi13 + 1);
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf16, vu.vf12.z());
//  if (bc) {
//    goto L13;
//  }
//
//  // lq.xyzw vf08, 0(vi10)      |  addax.xyzw vf20, vf00
//  lq_buffer(Mask::xyzw, vu.vf08, vu.vi10);
//  vu.acc.adda(Mask::xyzw, vu.vf20, vu.vf00.x());
//  // lq.xyzw vf10, 1(vi10)      |  madda.xyzw ACC, vf27, vf25
//  lq_buffer(Mask::xyzw, vu.vf10, vu.vi10 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf27, vu.vf25);
//  // lq.xyzw vf12, 2(vi10)      |  maddz.xyzw vf26, vf28, vf25
//  lq_buffer(Mask::xyzw, vu.vf12, vu.vi10 + 2);
//  vu.acc.madd(Mask::xyzw, vu.vf26, vu.vf28, vu.vf25.z());
//  // lq.xyzw vf25, 3(vi10)      |  nop
//  lq_buffer(Mask::xyzw, vu.vf25, vu.vi10 + 3);
//  // sq.xyzw vf09, 0(vi09)      |  mula.xyzw ACC, vf15, vf08
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf09, vu.vi09);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf08);
//  // sq.xyzw vf11, 1(vi09)      |  maddz.xyzw vf09, vf16, vf08
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf11, vu.vi09 + 1);
//  vu.acc.madd(Mask::xyzw, vu.vf09, vu.vf16, vu.vf08.z());
//  // sq.xyzw vf13, 2(vi09)      |  mula.xyzw ACC, vf15, vf10
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf13, vu.vi09 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf10);
//  // sq.xyzw vf26, 3(vi09)      |  maddz.xyzw vf11, vf16, vf10
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf26, vu.vi09 + 3);
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf16, vu.vf10.z());
//  // BRANCH!
//  // ibeq vi00, vi10, L13       |  mula.xyzw ACC, vf15, vf12
//  bc = (vu.vi10 == 0);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf12);
//  // ilw.y vi08, 1(vi13)        |  maddz.xyzw vf13, vf16, vf12
//  ilw_buffer(Mask::y, vu.vi08, vu.vi13 + 1);
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf16, vu.vf12.z());
//  if (bc) {
//    goto L13;
//  }
//
//  // lq.xyzw vf08, 0(vi11)      |  addax.xyzw vf20, vf00
//  lq_buffer(Mask::xyzw, vu.vf08, vu.vi11);
//  vu.acc.adda(Mask::xyzw, vu.vf20, vu.vf00.x());
//  // lq.xyzw vf10, 1(vi11)      |  madda.xyzw ACC, vf27, vf25
//  lq_buffer(Mask::xyzw, vu.vf10, vu.vi11 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf27, vu.vf25);
//  // lq.xyzw vf12, 2(vi11)      |  maddz.xyzw vf26, vf28, vf25
//  lq_buffer(Mask::xyzw, vu.vf12, vu.vi11 + 2);
//  vu.acc.madd(Mask::xyzw, vu.vf26, vu.vf28, vu.vf25.z());
//  // lq.xyzw vf25, 3(vi11)      |  nop
//  lq_buffer(Mask::xyzw, vu.vf25, vu.vi11 + 3);
//  // sq.xyzw vf09, 0(vi10)      |  mula.xyzw ACC, vf15, vf08
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf09, vu.vi10);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf08);
//  // sq.xyzw vf11, 1(vi10)      |  maddz.xyzw vf09, vf16, vf08
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf11, vu.vi10 + 1);
//  vu.acc.madd(Mask::xyzw, vu.vf09, vu.vf16, vu.vf08.z());
//  // sq.xyzw vf13, 2(vi10)      |  mula.xyzw ACC, vf15, vf10
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf13, vu.vi10 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf10);
//  // sq.xyzw vf26, 3(vi10)      |  maddz.xyzw vf11, vf16, vf10
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf26, vu.vi10 + 3);
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf16, vu.vf10.z());
//  // iaddi vi13, vi13, 0x1      |  nop
//  vu.vi13 = vu.vi13 + 1;
//  // BRANCH!
...
//  vu.acc.mula(Mask::xyzw, vu.vf15, vu.vf12);
//  // ilwr.z vi09, vi13          |  maddz.xyzw vf13, vf16, vf12
//  ilw_buffer(Mask::z, vu.vi09, vu.vi13);
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf16, vu.vf12.z());
//  if (bc) {
//    goto L12;
//  }
...
//  // iaddi vi04, vi04, -0x1     |  add.xyzw vf14, vf14, vf19
//  vu.vi04 = vu.vi04 + -1;
//  vu.vf14.add(Mask::xyzw, vu.vf14, vu.vf19);
//  // iadd vi02, vi02, vi12      |  nop
//  vu.vi02 = vu.vi02 + vu.vi12;
//  // lqi.xyzw vf24, vi02        |  mulaz.xyzw ACC, vf29, vf08
//  lq_buffer(Mask::xyzw, vu.vf24, vu.vi02++);
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf08.z());
//  // mtir vi10, vf11.x          |  maddaz.xyzw ACC, vf30, vf11
//  vu.vi10 = vu.vf11.x_as_u16();
//  vu.acc.madda(Mask::xyzw, vu.vf30, vu.vf11.z());
//  // mtir vi13, vf11.y          |  maddz.xyz vf11, vf31, vf14
//  vu.vi13 = vu.vf11.y_as_u16();
//  vu.acc.madd(Mask::xyz, vu.vf11, vu.vf31, vu.vf14.z());
//  // lq.xyzw vf25, 0(vi08)      |  nop
//  lq_buffer(Mask::xyzw, vu.vf25, vu.vi08);
//  // lq.xyzw vf26, 1(vi08)      |  itof0.xyzw vf24, vf24
//  lq_buffer(Mask::xyzw, vu.vf26, vu.vi08 + 1);
//
//  vu.vf24.itof0(Mask::xyzw, vu.vf24);
//
//  // lq.xyzw vf27, 2(vi08)      |  nop
//  lq_buffer(Mask::xyzw, vu.vf27, vu.vi08 + 2);
//  // erleng.xyz P, vf11         |  nop
//  vu.P = erleng(Mask::xyz, vu.vf11); /* TODO erleng */
//  // lq.xyzw vf28, 3(vi08)      |  mulaw.xyzw ACC, vf25, vf08
//  lq_buffer(Mask::xyzw, vu.vf28, vu.vi08 + 3);
//  vu.acc.mula(Mask::xyzw, vu.vf25, vu.vf08.w());
//  // ior vi15, vi07, vi00       |  maddaw.xyzw ACC, vf26, vf11
//  vu.vi15 = vu.vi07;
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf11.w());
//  // mr32.z vf14, vf00          |  maddw.xyzw vf08, vf27, vf14
//  vu.vf14.mr32(Mask::z, vu.vf00);
//  vu.acc.madd(Mask::xyzw, vu.vf08, vu.vf27, vu.vf14.w());
//  // lqi.xyzw vf09, vi01        |  nop
//  lq_buffer(Mask::xyzw, vu.vf09, vu.vi01++);
//  // ilwr.y vi03, vi12          |  nop
//  ilw_buffer(Mask::y, vu.vi03, vu.vi12);
...
//  ilw_buffer(Mask::z, vu.vi07, vu.vi12 + 1);
//  // lqi.xyzw vf12, vi01        |  add.xyzw vf08, vf08, vf28
//  lq_buffer(Mask::xyzw, vu.vf12, vu.vi01++);
//  vu.vf08.add(Mask::xyzw, vu.vf08, vu.vf28);
//  // lqi.xyzw vf15, vi01        |  nop
//  lq_buffer(Mask::xyzw, vu.vf15, vu.vi01++);
//  // mtir vi08, vf09.x          |  nop
//  vu.vi08 = vu.vf09.x_as_u16();
...
//L14:
//  // div Q, vf01.w, vf08.w      |  add.zw vf09, vf09, vf17
//  vu.Q = vu.vf01.w() / vu.vf08.w();
//  vu.vf09.add(Mask::zw, vu.vf09, vu.vf17);
//  // iadd vi04, vi04, vi03      |  add.xyzw vf12, vf12, vf18
//  vu.vi04 = vu.vi04 + vu.vi03;
//  vu.vf12.add(Mask::xyzw, vu.vf12, vu.vf18);
//  // lq.xyz vf29, 4(vi08)       |  add.xyzw vf15, vf15, vf19
//  lq_buffer(Mask::xyz, vu.vf29, vu.vi08 + 4);
//  vu.vf15.add(Mask::xyzw, vu.vf15, vu.vf19);
//  // lq.xyz vf30, 5(vi08)       |  nop
//  lq_buffer(Mask::xyz, vu.vf30, vu.vi08 + 5);
//  // iadd vi06, vi06, vi04      |  nop
//  vu.vi06 = vu.vi06 + vu.vi04;
...
//  vu.vf08.mul(Mask::xyz, vu.vf08, vu.Q); /* TODO mulq */
//  // mtir vi11, vf12.x          |  mul.xyzw vf14, vf14, Q
//  vu.vi11 = vu.vf12.x_as_u16();
//  vu.vf14.mul(Mask::xyzw, vu.vf14, vu.Q); /* TODO mulq */
//  // mtir vi14, vf12.y          |  nop
//  vu.vi14 = vu.vf12.y_as_u16();
//  // lq.xyzw vf27, 2(vi08)      |  nop
//  lq_buffer(Mask::xyzw, vu.vf27, vu.vi08 + 2);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf08, vf08, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
//  vu.vf08.add(Mask::xyzw, vu.vf08, vu.vf22);
//  // iadd vi07, vi07, vi06      |  mulaz.xyzw ACC, vf29, vf09
//  vu.vi07 = vu.vi07 + vu.vi06;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf09.z());
//  // lq.xyzw vf28, 3(vi08)      |  maddaz.xyzw ACC, vf30, vf12
...
//  // mfp.w vf20, P              |  maddz.xyz vf12, vf31, vf15
//  vu.vf20.mfp(Mask::w, vu.P);
//  vu.acc.madd(Mask::xyz, vu.vf12, vu.vf31, vu.vf15.z());
//  // nop                        |  nop
//
//  // 1024.0                     |  miniw.w vf08, vf08, vf03 :i
//  vu.vf08.mini(Mask::w, vu.vf08, vu.vf03.w());
//  vu.I = 1024.0;
//  // BRANCH!
//  // ibne vi00, vi15, L81       |  mulaw.xyzw ACC, vf25, vf09
//  bc = (vu.vi15 != 0);
//  vu.acc.mula(Mask::xyzw, vu.vf25, vu.vf09.w());
//  // ilw.y vi09, -6(vi01)       |  mulw.xyzw vf11, vf11, vf20
//  ilw_buffer(Mask::y, vu.vi09, vu.vi01 + -6);
//  vu.vf11.mul(Mask::xyzw, vu.vf11, vu.vf20.w());
//  if (bc) {
//    goto L81;
//  }
//
...
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf12.w());
//  // mr32.z vf15, vf00          |  maddw.xyzw vf09, vf27, vf15
//  vu.vf15.mr32(Mask::z, vu.vf00);
//  vu.acc.madd(Mask::xyzw, vu.vf09, vu.vf27, vu.vf15.w());
//  // lqi.xyzw vf10, vi01        |  mulax.xyzw ACC, vf01, vf11
//  lq_buffer(Mask::xyzw, vu.vf10, vu.vi01++);
//  vu.acc.mula(Mask::xyzw, vu.vf01, vu.vf11.x());
//  // BRANCH!
//  // ibne vi04, vi03, L16       |  madday.xyzw ACC, vf02, vf11
//  bc = (vu.vi04 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf02, vu.vf11.y());
...
//  vu.acc.mula(Mask::xyzw, vu.vf01, vu.vf11.x());
//  // sq.xyzw vf13, 1(vi12)      |  madday.xyzw ACC, vf02, vf11
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf13, vu.vi12 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf02, vu.vf11.y());
//  // sq.xyzw vf13, 1(vi15)      |  maddz.xyzw vf11, vf03, vf11
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf13, vu.vi15 + 1);
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf03, vu.vf11.z());
//L16:
//  // lqi.xyzw vf13, vi01        |  add.xyzw vf09, vf09, vf28
//  lq_buffer(Mask::xyzw, vu.vf13, vu.vi01++);
//  vu.vf09.add(Mask::xyzw, vu.vf09, vu.vf28);
//  // lqi.xyzw vf16, vi01        |  maxw.w vf08, vf08, vf02
//  lq_buffer(Mask::xyzw, vu.vf16, vu.vi01++);
//  vu.vf08.max(Mask::w, vu.vf08, vu.vf02.w());
//  // mtir vi08, vf10.x          |  itof0.xyzw vf23, vf23
//  vu.vi08 = vu.vf10.x_as_u16();
//  vu.vf23.itof0(Mask::xyzw, vu.vf23);
//  // ilw.y vi09, -9(vi01)       |  maxx.xyzw vf11, vf11, vf00
//  ilw_buffer(Mask::y, vu.vi09, vu.vi01 + -9);
//  vu.vf11.max(Mask::xyzw, vu.vf11, vu.vf00.x());
//  // div Q, vf01.w, vf09.w      |  add.zw vf10, vf10, vf17
//  vu.Q = vu.vf01.w() / vu.vf09.w();
//  vu.vf10.add(Mask::zw, vu.vf10, vu.vf17);
//  // move.xyzw vf21, vf08       |  add.xyzw vf13, vf13, vf18
//  vu.vf21.move(Mask::xyzw, vu.vf08);
//  vu.vf13.add(Mask::xyzw, vu.vf13, vu.vf18);
//  // lq.xyz vf29, 4(vi08)       |  add.xyzw vf16, vf16, vf19
//  lq_buffer(Mask::xyz, vu.vf29, vu.vi08 + 4);
//  vu.vf16.add(Mask::xyzw, vu.vf16, vu.vf19);
//  // lq.xyz vf30, 5(vi08)       |  mulax.xyzw ACC, vf04, vf11
//  lq_buffer(Mask::xyz, vu.vf30, vu.vi08 + 5);
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf11.x());
//  // BRANCH!
//  // ibgtz vi09, L17            |  madday.xyzw ACC, vf05, vf11
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf11.y());
//  // lq.xyzw vf31, 6(vi08)      |  maddaz.xyzw ACC, vf06, vf11
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi08 + 6);
//  vu.acc.madda(Mask::xyzw, vu.vf06, vu.vf11.z());
//  if (bc) {
...
//  // lq.xyzw vf26, 1(vi08)      |  mul.xyz vf09, vf09, Q
//  lq_buffer(Mask::xyzw, vu.vf26, vu.vi08 + 1);
//  vu.vf09.mul(Mask::xyz, vu.vf09, vu.Q); /* TODO mulq */
//  // mtir vi12, vf13.x          |  mul.xyzw vf15, vf15, Q
//  vu.vi12 = vu.vf13.x_as_u16();
//  vu.vf15.mul(Mask::xyzw, vu.vf15, vu.Q); /* TODO mulq */
//  // mtir vi15, vf13.y          |  ftoi4.xyzw vf21, vf21
//  vu.vi15 = vu.vf13.y_as_u16();
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // lq.xyzw vf27, 2(vi08)      |  mul.xyzw vf11, vf11, vf23
//  lq_buffer(Mask::xyzw, vu.vf27, vu.vi08 + 2);
//  vu.vf11.mul(Mask::xyzw, vu.vf11, vu.vf23);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf09, vf09, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
//  vu.vf09.add(Mask::xyzw, vu.vf09, vu.vf22);
//  // BRANCH!
//  // ibne vi00, vi09, L18       |  mulaz.xyzw ACC, vf29, vf10
//  bc = (vu.vi09 != 0);
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf10.z());
//  // sq.xyzw vf21, 2(vi10)      |  maddaz.xyzw ACC, vf30, vf13
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi10 + 2);
//  vu.acc.madda(Mask::xyzw, vu.vf30, vu.vf13.z());
//  if (bc) {
//    goto L18;
//  }
//
...
//  // mfp.w vf20, P              |  maddz.xyz vf13, vf31, vf16
//  vu.vf20.mfp(Mask::w, vu.P);
//  vu.acc.madd(Mask::xyz, vu.vf13, vu.vf31, vu.vf16.z());
//  // sq.xyzw vf14, 0(vi10)      |  miniy.xyzw vf11, vf11, vf17
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf14, vu.vi10);
//  vu.vf11.mini(Mask::xyzw, vu.vf11, vu.vf17.y());
//  // sq.xyzw vf14, 0(vi13)      |  miniw.w vf09, vf09, vf03
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf14, vu.vi13);
//  vu.vf09.mini(Mask::w, vu.vf09, vu.vf03.w());
//  // sq.xyzw vf21, 2(vi13)      |  mulaw.xyzw ACC, vf25, vf10
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi13 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf25, vu.vf10.w());
//  // lq.xyzw vf28, 3(vi08)      |  mulw.xyzw vf12, vf12, vf20
//  lq_buffer(Mask::xyzw, vu.vf28, vu.vi08 + 3);
//  vu.vf12.mul(Mask::xyzw, vu.vf12, vu.vf20.w());
//  // erleng.xyz P, vf13         |  ftoi0.xyzw vf11, vf11
//  vu.P = erleng(Mask::xyz, vu.vf13); /* TODO erleng */
//  vu.vf11.ftoi0(Mask::xyzw, vu.vf11);
//  // BRANCH!
//  // ibne vi04, vi03, L19       |  maddaw.xyzw ACC, vf26, vf13
//  bc = (vu.vi04 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf13.w());
//  // mr32.z vf16, vf00          |  maddw.xyzw vf10, vf27, vf16
//  vu.vf16.mr32(Mask::z, vu.vf00);
//  vu.acc.madd(Mask::xyzw, vu.vf10, vu.vf27, vu.vf16.w());
//  if (bc) {
//    goto L19;
//  }
//
...
//  // lqi.xyzw vf08, vi01        |  mulax.xyzw ACC, vf01, vf12
//  lq_buffer(Mask::xyzw, vu.vf08, vu.vi01++);
//  vu.acc.mula(Mask::xyzw, vu.vf01, vu.vf12.x());
//  // sq.xyzw vf11, 1(vi10)      |  madday.xyzw ACC, vf02, vf12
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf11, vu.vi10 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf02, vu.vf12.y());
//  // sq.xyzw vf11, 1(vi13)      |  maddz.xyzw vf12, vf03, vf12
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf11, vu.vi13 + 1);
//  vu.acc.madd(Mask::xyzw, vu.vf12, vu.vf03, vu.vf12.z());
//  // lqi.xyzw vf11, vi01        |  add.xyzw vf10, vf10, vf28
//  lq_buffer(Mask::xyzw, vu.vf11, vu.vi01++);
//  vu.vf10.add(Mask::xyzw, vu.vf10, vu.vf28);
//  // lqi.xyzw vf14, vi01        |  maxw.w vf09, vf09, vf02
//  lq_buffer(Mask::xyzw, vu.vf14, vu.vi01++);
//  vu.vf09.max(Mask::w, vu.vf09, vu.vf02.w());
//  // mtir vi08, vf08.x          |  itof0.xyzw vf23, vf23
//  vu.vi08 = vu.vf08.x_as_u16();
//  vu.vf23.itof0(Mask::xyzw, vu.vf23);
//  // ilw.y vi09, -9(vi01)       |  maxx.xyzw vf12, vf12, vf00
//  ilw_buffer(Mask::y, vu.vi09, vu.vi01 + -9);
//  vu.vf12.max(Mask::xyzw, vu.vf12, vu.vf00.x());
//  // div Q, vf01.w, vf10.w      |  add.zw vf08, vf08, vf17
//  vu.Q = vu.vf01.w() / vu.vf10.w();
//  vu.vf08.add(Mask::zw, vu.vf08, vu.vf17);
//  // move.xyzw vf21, vf09       |  add.xyzw vf11, vf11, vf18
//  vu.vf21.move(Mask::xyzw, vu.vf09);
//  vu.vf11.add(Mask::xyzw, vu.vf11, vu.vf18);
//  // lq.xyz vf29, 4(vi08)       |  add.xyzw vf14, vf14, vf19
//  lq_buffer(Mask::xyz, vu.vf29, vu.vi08 + 4);
//  vu.vf14.add(Mask::xyzw, vu.vf14, vu.vf19);
...
//  // ibgtz vi09, L20            |  madday.xyzw ACC, vf05, vf12
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf12.y());
//  // lq.xyzw vf31, 6(vi08)      |  maddaz.xyzw ACC, vf06, vf12
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi08 + 6);
//  vu.acc.madda(Mask::xyzw, vu.vf06, vu.vf12.z());
//  if (bc) {
...
//  // lq.xyzw vf26, 1(vi08)      |  mul.xyz vf10, vf10, Q
//  lq_buffer(Mask::xyzw, vu.vf26, vu.vi08 + 1);
//  vu.vf10.mul(Mask::xyz, vu.vf10, vu.Q); /* TODO mulq */
//  // mtir vi10, vf11.x          |  mul.xyzw vf16, vf16, Q
//  vu.vi10 = vu.vf11.x_as_u16();
//  vu.vf16.mul(Mask::xyzw, vu.vf16, vu.Q); /* TODO mulq */
//  // mtir vi13, vf11.y          |  ftoi4.xyzw vf21, vf21
//  vu.vi13 = vu.vf11.y_as_u16();
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // lq.xyzw vf27, 2(vi08)      |  mul.xyzw vf12, vf12, vf23
...
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf10, vf10, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
//  vu.vf10.add(Mask::xyzw, vu.vf10, vu.vf22);
//  // BRANCH!
//  // ibne vi00, vi09, L21       |  mulaz.xyzw ACC, vf29, vf08
//  bc = (vu.vi09 != 0);
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf08.z());
//  // sq.xyzw vf21, 2(vi11)      |  maddaz.xyzw ACC, vf30, vf11
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi11 + 2);
//  vu.acc.madda(Mask::xyzw, vu.vf30, vu.vf11.z());
//  if (bc) {
//    goto L21;
//  }
...
//  vu.acc.madd(Mask::xyz, vu.vf11, vu.vf31, vu.vf14.z());
//  // sq.xyzw vf15, 0(vi11)      |  miniy.xyzw vf12, vf12, vf17
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf15, vu.vi11);
//  vu.vf12.mini(Mask::xyzw, vu.vf12, vu.vf17.y());
//  // sq.xyzw vf15, 0(vi14)      |  miniw.w vf10, vf10, vf03
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf15, vu.vi14);
//  vu.vf10.mini(Mask::w, vu.vf10, vu.vf03.w());
//  // sq.xyzw vf21, 2(vi14)      |  mulaw.xyzw ACC, vf25, vf08
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi14 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf25, vu.vf08.w());
//  // lq.xyzw vf28, 3(vi08)      |  mulw.xyzw vf13, vf13, vf20
//  lq_buffer(Mask::xyzw, vu.vf28, vu.vi08 + 3);
//  vu.vf13.mul(Mask::xyzw, vu.vf13, vu.vf20.w());
//  // erleng.xyz P, vf11         |  ftoi0.xyzw vf12, vf12
//  vu.P = erleng(Mask::xyz, vu.vf11); /* TODO erleng */
//  vu.vf12.ftoi0(Mask::xyzw, vu.vf12);
//  // BRANCH!
...
//  // lqi.xyzw vf09, vi01        |  mulax.xyzw ACC, vf01, vf13
//  lq_buffer(Mask::xyzw, vu.vf09, vu.vi01++);
//  vu.acc.mula(Mask::xyzw, vu.vf01, vu.vf13.x());
//  // sq.xyzw vf12, 1(vi11)      |  madday.xyzw ACC, vf02, vf13
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf12, vu.vi11 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf02, vu.vf13.y());
//  // sq.xyzw vf12, 1(vi14)      |  maddz.xyzw vf13, vf03, vf13
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf12, vu.vi14 + 1);
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf03, vu.vf13.z());
//  // lqi.xyzw vf12, vi01        |  add.xyzw vf08, vf08, vf28
//  lq_buffer(Mask::xyzw, vu.vf12, vu.vi01++);
//  vu.vf08.add(Mask::xyzw, vu.vf08, vu.vf28);
//  // lqi.xyzw vf15, vi01        |  maxw.w vf10, vf10, vf02
//  lq_buffer(Mask::xyzw, vu.vf15, vu.vi01++);
//  vu.vf10.max(Mask::w, vu.vf10, vu.vf02.w());
//  // mtir vi08, vf09.x          |  itof0.xyzw vf23, vf23
//  vu.vi08 = vu.vf09.x_as_u16();
//  vu.vf23.itof0(Mask::xyzw, vu.vf23);
//  // ilw.y vi09, -9(vi01)       |  maxx.xyzw vf13, vf13, vf00
//  ilw_buffer(Mask::y, vu.vi09, vu.vi01 + -9);
//  vu.vf13.max(Mask::xyzw, vu.vf13, vu.vf00.x());
//  // div Q, vf01.w, vf08.w      |  add.zw vf09, vf09, vf17
//  vu.Q = vu.vf01.w() / vu.vf08.w();
//  vu.vf09.add(Mask::zw, vu.vf09, vu.vf17);
//  // move.xyzw vf21, vf10       |  add.xyzw vf12, vf12, vf18
//  vu.vf21.move(Mask::xyzw, vu.vf10);
//  vu.vf12.add(Mask::xyzw, vu.vf12, vu.vf18);
//  // lq.xyz vf29, 4(vi08)       |  add.xyzw vf15, vf15, vf19
//  lq_buffer(Mask::xyz, vu.vf29, vu.vi08 + 4);
//  vu.vf15.add(Mask::xyzw, vu.vf15, vu.vf19);
...
//  // ibgtz vi09, L23            |  madday.xyzw ACC, vf05, vf13
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf13.y());
//  // lq.xyzw vf31, 6(vi08)      |  maddaz.xyzw ACC, vf06, vf13
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi08 + 6);
//  vu.acc.madda(Mask::xyzw, vu.vf06, vu.vf13.z());
//  if (bc) {
...
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf09.z());
//  // sq.xyzw vf21, 2(vi12)      |  maddaz.xyzw ACC, vf30, vf12
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi12 + 2);
//  vu.acc.madda(Mask::xyzw, vu.vf30, vu.vf12.z());
//  if (bc) {
//    goto L24;
//  }
...
//  vu.acc.madd(Mask::xyz, vu.vf12, vu.vf31, vu.vf15.z());
//  // sq.xyzw vf16, 0(vi12)      |  miniy.xyzw vf13, vf13, vf17
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf16, vu.vi12);
//  vu.vf13.mini(Mask::xyzw, vu.vf13, vu.vf17.y());
//  // sq.xyzw vf16, 0(vi15)      |  miniw.w vf08, vf08, vf03
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf16, vu.vi15);
//  vu.vf08.mini(Mask::w, vu.vf08, vu.vf03.w());
//  // sq.xyzw vf21, 2(vi15)      |  mulaw.xyzw ACC, vf25, vf09
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi15 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf25, vu.vf09.w());
//  // lq.xyzw vf28, 3(vi08)      |  mulw.xyzw vf11, vf11, vf20
//  lq_buffer(Mask::xyzw, vu.vf28, vu.vi08 + 3);
//  vu.vf11.mul(Mask::xyzw, vu.vf11, vu.vf20.w());
...
//  lq_buffer(Mask::xyzw, vu.vf26, vu.vi13 + 1);
//  // lq.xyzw vf20, 2(vi10)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi10 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyzw vf27, 2(vi13)      |  maddy.xyzw vf25, vf25, vf24
//  lq_buffer(Mask::xyzw, vu.vf27, vu.vi13 + 2);
//  vu.acc.madd(Mask::xyzw, vu.vf25, vu.vf25, vu.vf24.y());
//  // lq.xyzw vf23, 3(vi10)      |  mulax.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi10 + 3);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // lq.xyzw vf28, 3(vi13)      |  maddy.xyzw vf26, vf26, vf24
//  lq_buffer(Mask::xyzw, vu.vf28, vu.vi13 + 3);
//  vu.acc.madd(Mask::xyzw, vu.vf26, vu.vf26, vu.vf24.y());
//  // lq.xyzw vf20, 4(vi10)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi10 + 4);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyz vf29, 4(vi13)       |  maddy.xyzw vf27, vf27, vf24
//  lq_buffer(Mask::xyz, vu.vf29, vu.vi13 + 4);
//  vu.acc.madd(Mask::xyzw, vu.vf27, vu.vf27, vu.vf24.y());
//  // lq.xyzw vf23, 5(vi10)      |  mulax.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi10 + 5);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // lq.xyz vf30, 5(vi13)       |  maddy.xyzw vf28, vf28, vf24
//  lq_buffer(Mask::xyz, vu.vf30, vu.vi13 + 5);
//  vu.acc.madd(Mask::xyzw, vu.vf28, vu.vf28, vu.vf24.y());
//  // lq.xyzw vf20, 6(vi10)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi10 + 6);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyzw vf31, 6(vi13)      |  maddy.xyz vf29, vf29, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi13 + 6);
//  vu.acc.madd(Mask::xyz, vu.vf29, vu.vf29, vu.vf24.y());
//  // mtir vi10, vf11.x          |  mulax.xyzw ACC, vf23, vf24
//  vu.vi10 = vu.vf11.x_as_u16();
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // mtir vi13, vf11.y          |  maddy.xyz vf30, vf30, vf24
//  vu.vi13 = vu.vf11.y_as_u16();
//  vu.acc.madd(Mask::xyz, vu.vf30, vu.vf30, vu.vf24.y());
//  // nop                        |  mulax.xyzw ACC, vf20, vf24
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // nop                        |  maddy.xyzw vf31, vf31, vf24
//  vu.acc.madd(Mask::xyzw, vu.vf31, vu.vf31, vu.vf24.y());
...
//L27:
//  // lq.xyzw vf20, 0(vi11)      |  mul.xyzw vf14, vf14, Q
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi11);
//  vu.vf14.mul(Mask::xyzw, vu.vf14, vu.Q); /* TODO mulq */
//  // lq.xyzw vf25, 0(vi14)      |  nop
//  lq_buffer(Mask::xyzw, vu.vf25, vu.vi14);
//  // lq.xyzw vf23, 1(vi11)      |  nop
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi11 + 1);
//  // lq.xyzw vf26, 1(vi14)      |  add.xyzw vf08, vf08, vf22
//  lq_buffer(Mask::xyzw, vu.vf26, vu.vi14 + 1);
//  vu.vf08.add(Mask::xyzw, vu.vf08, vu.vf22);
//  // lq.xyzw vf20, 2(vi11)      |  mulaz.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi11 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.z());
//  // lq.xyzw vf27, 2(vi14)      |  maddw.xyzw vf25, vf25, vf24
//  lq_buffer(Mask::xyzw, vu.vf27, vu.vi14 + 2);
//  vu.acc.madd(Mask::xyzw, vu.vf25, vu.vf25, vu.vf24.w());
//  // lq.xyzw vf23, 3(vi11)      |  mulaz.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi11 + 3);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.z());
//  // lq.xyzw vf28, 3(vi14)      |  maddw.xyzw vf26, vf26, vf24
//  lq_buffer(Mask::xyzw, vu.vf28, vu.vi14 + 3);
//  vu.acc.madd(Mask::xyzw, vu.vf26, vu.vf26, vu.vf24.w());
//  // lq.xyzw vf20, 4(vi11)      |  mulaz.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi11 + 4);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.z());
//  // lq.xyz vf29, 4(vi14)       |  maddw.xyzw vf27, vf27, vf24
//  lq_buffer(Mask::xyz, vu.vf29, vu.vi14 + 4);
//  vu.acc.madd(Mask::xyzw, vu.vf27, vu.vf27, vu.vf24.w());
//  // lq.xyzw vf23, 5(vi11)      |  mulaz.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi11 + 5);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.z());
//  // lq.xyz vf30, 5(vi14)       |  maddw.xyzw vf28, vf28, vf24
//  lq_buffer(Mask::xyz, vu.vf30, vu.vi14 + 5);
//  vu.acc.madd(Mask::xyzw, vu.vf28, vu.vf28, vu.vf24.w());
//  // lq.xyzw vf20, 6(vi11)      |  mulaz.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi11 + 6);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.z());
//  // lq.xyzw vf31, 6(vi14)      |  maddw.xyz vf29, vf29, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi14 + 6);
//  vu.acc.madd(Mask::xyz, vu.vf29, vu.vf29, vu.vf24.w());
//  // lqi.xyzw vf23, vi02        |  mulaz.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi02++);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.z());
//  // mtir vi11, vf12.x          |  maddw.xyz vf30, vf30, vf24
//  vu.vi11 = vu.vf12.x_as_u16();
//  vu.acc.madd(Mask::xyz, vu.vf30, vu.vf30, vu.vf24.w());
//  // mtir vi14, vf12.y          |  mulaz.xyzw ACC, vf20, vf24
//  vu.vi14 = vu.vf12.y_as_u16();
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.z());
//  // iaddiu vi08, vi00, 0x1a1   |  maddw.xyzw vf31, vf31, vf24
//  vu.vi08 = 0x1a1; /* 417 */
//  vu.acc.madd(Mask::xyzw, vu.vf31, vu.vf31, vu.vf24.w());
//  // BRANCH!
//  // ibeq vi00, vi15, L28       |  nop
//  bc = (vu.vi15 == 0);
//  // lqi.xyzw vf23, vi03        |  itof0.xyzw vf24, vf23
...
//  vu.I = 1024.0;
//  // BRANCH!
//  // ibne vi00, vi15, L92       |  mulaw.xyzw ACC, vf25, vf09
//  bc = (vu.vi15 != 0);
//  vu.acc.mula(Mask::xyzw, vu.vf25, vu.vf09.w());
//  // ilw.y vi09, -6(vi01)       |  mulw.xyzw vf11, vf11, vf20
//  ilw_buffer(Mask::y, vu.vi09, vu.vi01 + -6);
...
//  vu.P = erleng(Mask::xyz, vu.vf12); /* TODO erleng */
//                                     // BRANCH!
//  // ibeq vi06, vi03, L64       |  maddaw.xyzw ACC, vf26, vf12
//  bc = (vu.vi06 == vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf12.w());
//  // mr32.z vf15, vf00          |  maddw.xyzw vf09, vf27, vf15
//  vu.vf15.mr32(Mask::z, vu.vf00);
...
//  vu.vf08.max(Mask::w, vu.vf08, vu.vf02.w());
//  // mtir vi12, vf10.x          |  itof0.xyzw vf23, vf23
//  vu.vi12 = vu.vf10.x_as_u16();
//  vu.vf23.itof0(Mask::xyzw, vu.vf23);
//  // mtir vi15, vf10.y          |  maxx.xyzw vf11, vf11, vf00
//  vu.vi15 = vu.vf10.y_as_u16();
//  vu.vf11.max(Mask::xyzw, vu.vf11, vu.vf00.x());
//  // div Q, vf01.w, vf09.w      |  add.zw vf10, vf10, vf17
//  vu.Q = vu.vf01.w() / vu.vf09.w();
//  vu.vf10.add(Mask::zw, vu.vf10, vu.vf17);
...
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf09, vf09, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
//  vu.vf09.mul(Mask::xyz, vu.vf09, vu.Q); /* TODO mulq */
//  if (bc) {
//    goto L32;
//  }
...
//L32:
//  // lq.xyzw vf20, 0(vi12)      |  mul.xyzw vf15, vf15, Q
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi12);
//  vu.vf15.mul(Mask::xyzw, vu.vf15, vu.Q); /* TODO mulq */
//  // nop                        |  mulw.xyzw vf24, vf24, vf29
//  vu.vf24.mul(Mask::xyzw, vu.vf24, vu.vf29.w());
//  // lq.xyzw vf25, 0(vi15)      |  ftoi4.xyzw vf21, vf21
//  lq_buffer(Mask::xyzw, vu.vf25, vu.vi15);
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // lq.xyzw vf23, 1(vi12)      |  mul.xyzw vf11, vf11, vf23
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi12 + 1);
//  vu.vf11.mul(Mask::xyzw, vu.vf11, vu.vf23);
//  // lq.xyzw vf26, 1(vi15)      |  add.xyzw vf09, vf09, vf22
//  lq_buffer(Mask::xyzw, vu.vf26, vu.vi15 + 1);
//  vu.vf09.add(Mask::xyzw, vu.vf09, vu.vf22);
//  // lq.xyzw vf20, 2(vi12)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi12 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyzw vf27, 2(vi15)      |  maddy.xyzw vf25, vf25, vf24
//  lq_buffer(Mask::xyzw, vu.vf27, vu.vi15 + 2);
//  vu.acc.madd(Mask::xyzw, vu.vf25, vu.vf25, vu.vf24.y());
//  // lq.xyzw vf23, 3(vi12)      |  mulax.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi12 + 3);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // lq.xyzw vf28, 3(vi15)      |  maddy.xyzw vf26, vf26, vf24
//  lq_buffer(Mask::xyzw, vu.vf28, vu.vi15 + 3);
//  vu.acc.madd(Mask::xyzw, vu.vf26, vu.vf26, vu.vf24.y());
//  // lq.xyzw vf20, 4(vi12)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi12 + 4);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyz vf29, 4(vi15)       |  maddy.xyzw vf27, vf27, vf24
//  lq_buffer(Mask::xyz, vu.vf29, vu.vi15 + 4);
//  vu.acc.madd(Mask::xyzw, vu.vf27, vu.vf27, vu.vf24.y());
//  // lq.xyzw vf23, 5(vi12)      |  mulax.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi12 + 5);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // lq.xyz vf30, 5(vi15)       |  maddy.xyzw vf28, vf28, vf24
//  lq_buffer(Mask::xyz, vu.vf30, vu.vi15 + 5);
//  vu.acc.madd(Mask::xyzw, vu.vf28, vu.vf28, vu.vf24.y());
//  // lq.xyzw vf20, 6(vi12)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi12 + 6);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyzw vf31, 6(vi15)      |  maddy.xyz vf29, vf29, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi15 + 6);
//  vu.acc.madd(Mask::xyz, vu.vf29, vu.vf29, vu.vf24.y());
//  // mtir vi12, vf13.x          |  mulax.xyzw ACC, vf23, vf24
//  vu.vi12 = vu.vf13.x_as_u16();
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
...
//  vu.acc.madd(Mask::xyz, vu.vf30, vu.vf30, vu.vf24.y());
//  // BRANCH!
//  // b L48                      |  mulax.xyzw ACC, vf20, vf24
//  bc = true;
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lqi.xyzw vf23, vi03        |  maddy.xyzw vf31, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//  vu.acc.madd(Mask::xyz, vu.vf30, vu.vf30, vu.vf24.y());
//  // BRANCH!
//  // b L53                      |  mulax.xyzw ACC, vf20, vf24
//  bc = true;
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lqi.xyzw vf23, vi03        |  maddy.xyzw vf31, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//  vu.acc.madd(Mask::xyz, vu.vf30, vu.vf30, vu.vf24.y());
//  // BRANCH!
//  // b L58                      |  mulax.xyzw ACC, vf20, vf24
//  bc = true;
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lqi.xyzw vf23, vi03        |  maddy.xyzw vf31, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf11.x());
//  // BRANCH!
//  // ibgtz vi09, L46            |  madday.xyzw ACC, vf05, vf11
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf11.y());
//  // iand vi15, vi15, vi05      |  maddaz.xyzw ACC, vf06, vf11
//  vu.vi15 = vu.vi15 & vu.vi05;
...
//L46:
//  // BRANCH!
//  // ibne vi05, vi12, L47       |  maddw.xyzw vf11, vf07, vf00
//  bc = (vu.vi05 != vu.vi12);
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf09, vf09, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//L48:
//  // BRANCH!
//  // ibgez vi09, L49            |  mulaz.xyzw ACC, vf29, vf10
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf10.z());
//  // sq.xyzw vf21, 2(vi10)      |  maddaz.xyzw ACC, vf30, vf13
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi10 + 2);
...
//  vu.vf11.ftoi0(Mask::xyzw, vu.vf11);
//  // BRANCH!
//  // ibne vi06, vi03, L50       |  maddaw.xyzw ACC, vf26, vf13
//  bc = (vu.vi06 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf13.w());
//  // mr32.z vf16, vf00          |  maddw.xyzw vf10, vf27, vf16
//  vu.vf16.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf12.x());
//  // BRANCH!
//  // ibgtz vi09, L51            |  madday.xyzw ACC, vf05, vf12
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf12.y());
//  // iand vi13, vi13, vi05      |  maddaz.xyzw ACC, vf06, vf12
//  vu.vi13 = vu.vi13 & vu.vi05;
...
//L51:
//  // BRANCH!
//  // ibne vi05, vi10, L52       |  maddw.xyzw vf12, vf07, vf00
//  bc = (vu.vi05 != vu.vi10);
//  vu.acc.madd(Mask::xyzw, vu.vf12, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf10, vf10, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//
//L53:
//  // Here we have bad matrix data (vf25, vf26, vf27)
//  // BRANCH!
//  // ibgez vi09, L54            |  mulaz.xyzw ACC, vf29, vf08
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf08.z());
//  // sq.xyzw vf21, 2(vi11)      |  maddaz.xyzw ACC, vf30, vf11
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi11 + 2);
...
//  vu.vf12.ftoi0(Mask::xyzw, vu.vf12);
//  // BRANCH!
//  // ibne vi06, vi03, L55       |  maddaw.xyzw ACC, vf26, vf11
//  bc = (vu.vi06 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf11.w());
//  // mr32.z vf14, vf00          |  maddw.xyzw vf08, vf27, vf14
//  vu.vf14.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf13.x());
//  // BRANCH!
//  // ibgtz vi09, L56            |  madday.xyzw ACC, vf05, vf13
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf13.y());
//  // iand vi14, vi14, vi05      |  maddaz.xyzw ACC, vf06, vf13
//  vu.vi14 = vu.vi14 & vu.vi05;
...
//L56:
//  // BRANCH!
//  // ibne vi05, vi11, L57       |  maddw.xyzw vf13, vf07, vf00
//  bc = (vu.vi05 != vu.vi11);
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf08, vf08, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//L58:
//  // BRANCH!
//  // ibgez vi09, L59            |  mulaz.xyzw ACC, vf29, vf09
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf09.z());
//  // sq.xyzw vf21, 2(vi12)      |  maddaz.xyzw ACC, vf30, vf12
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi12 + 2);
...
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi10 + 1);
//  // lq.xyzw vf20, 1(vi13)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi13 + 1);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyzw vf26, 1(vi08)      |  madday.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf26, vu.vi08 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf31, vu.vf24.y());
//  // lq.xyzw vf31, 2(vi10)      |  maddz.xyzw vf25, vf25, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi10 + 2);
//  vu.acc.madd(Mask::xyzw, vu.vf25, vu.vf25, vu.vf24.z());
//  // lq.xyzw vf23, 2(vi13)      |  mulax.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi13 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // lq.xyzw vf27, 2(vi08)      |  madday.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf27, vu.vi08 + 2);
//  vu.acc.madda(Mask::xyzw, vu.vf20, vu.vf24.y());
//  // lq.xyzw vf20, 3(vi10)      |  maddz.xyzw vf26, vf26, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi10 + 3);
//  vu.acc.madd(Mask::xyzw, vu.vf26, vu.vf26, vu.vf24.z());
//  // lq.xyzw vf31, 3(vi13)      |  mulax.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi13 + 3);
//  vu.acc.mula(Mask::xyzw, vu.vf31, vu.vf24.x());
//  // lq.xyzw vf28, 3(vi08)      |  madday.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf28, vu.vi08 + 3);
//  vu.acc.madda(Mask::xyzw, vu.vf23, vu.vf24.y());
//  // lq.xyzw vf23, 4(vi10)      |  maddz.xyzw vf27, vf27, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi10 + 4);
//  vu.acc.madd(Mask::xyzw, vu.vf27, vu.vf27, vu.vf24.z());
//  // lq.xyzw vf20, 4(vi13)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi13 + 4);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyz vf29, 4(vi08)       |  madday.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyz, vu.vf29, vu.vi08 + 4);
//  vu.acc.madda(Mask::xyzw, vu.vf31, vu.vf24.y());
//  // lq.xyzw vf31, 5(vi10)      |  maddz.xyzw vf28, vf28, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi10 + 5);
//  vu.acc.madd(Mask::xyzw, vu.vf28, vu.vf28, vu.vf24.z());
//  // lq.xyzw vf23, 5(vi13)      |  mulax.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi13 + 5);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // lq.xyz vf30, 5(vi08)       |  madday.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyz, vu.vf30, vu.vi08 + 5);
//  vu.acc.madda(Mask::xyzw, vu.vf20, vu.vf24.y());
//  // lq.xyzw vf20, 6(vi10)      |  maddz.xyz vf29, vf29, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi10 + 6);
//  vu.acc.madd(Mask::xyz, vu.vf29, vu.vf29, vu.vf24.z());
//  // lq.xyzw vf22, 6(vi13)      |  mulax.xyzw ACC, vf31, vf24
...
//  // lqi.xyzw vf23, vi02        |  maddz.xyz vf30, vf30, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi02++);
//  vu.acc.madd(Mask::xyz, vu.vf30, vu.vf30, vu.vf24.z());
//  // mtir vi10, vf11.x          |  mulax.xyzw ACC, vf20, vf24
//  vu.vi10 = vu.vf11.x_as_u16();
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // mtir vi13, vf11.y          |  madday.xyzw ACC, vf22, vf24
//  vu.vi13 = vu.vf11.y_as_u16();
//  vu.acc.madda(Mask::xyzw, vu.vf22, vu.vf24.y());
//  // lq.xyzw vf22, 2(vi00)      |  maddz.xyzw vf31, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf22, 2);
//  vu.acc.madd(Mask::xyzw, vu.vf31, vu.vf31, vu.vf24.z());
//  // nop                        |  itof0.xyzw vf24, vf23
//  vu.vf24.itof0(Mask::xyzw, vu.vf23);
//  // nop                        |  mulaz.xyzw ACC, vf29, vf08
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf08.z());
...
//  vu.vf08.add(Mask::xyzw, vu.vf08, vu.vf22);
//  // lq.xyzw vf20, 1(vi14)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi14 + 1);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyzw vf26, 1(vi08)      |  madday.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf26, vu.vi08 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf31, vu.vf24.y());
//  // lq.xyzw vf31, 2(vi11)      |  maddz.xyzw vf25, vf25, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi11 + 2);
//  vu.acc.madd(Mask::xyzw, vu.vf25, vu.vf25, vu.vf24.z());
//  // lq.xyzw vf23, 2(vi14)      |  mulax.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi14 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // lq.xyzw vf27, 2(vi08)      |  madday.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf27, vu.vi08 + 2);
//  vu.acc.madda(Mask::xyzw, vu.vf20, vu.vf24.y());
//  // lq.xyzw vf20, 3(vi11)      |  maddz.xyzw vf26, vf26, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi11 + 3);
//  vu.acc.madd(Mask::xyzw, vu.vf26, vu.vf26, vu.vf24.z());
//  // lq.xyzw vf31, 3(vi14)      |  mulax.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi14 + 3);
//  vu.acc.mula(Mask::xyzw, vu.vf31, vu.vf24.x());
//  // lq.xyzw vf28, 3(vi08)      |  madday.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf28, vu.vi08 + 3);
//  vu.acc.madda(Mask::xyzw, vu.vf23, vu.vf24.y());
//  // lq.xyzw vf23, 4(vi11)      |  maddz.xyzw vf27, vf27, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi11 + 4);
//  vu.acc.madd(Mask::xyzw, vu.vf27, vu.vf27, vu.vf24.z());
//  // lq.xyzw vf20, 4(vi14)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi14 + 4);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyz vf29, 4(vi08)       |  madday.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyz, vu.vf29, vu.vi08 + 4);
//  vu.acc.madda(Mask::xyzw, vu.vf31, vu.vf24.y());
//  // lq.xyzw vf31, 5(vi11)      |  maddz.xyzw vf28, vf28, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi11 + 5);
//  vu.acc.madd(Mask::xyzw, vu.vf28, vu.vf28, vu.vf24.z());
//  // lq.xyzw vf23, 5(vi14)      |  mulax.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi14 + 5);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // lq.xyz vf30, 5(vi08)       |  madday.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyz, vu.vf30, vu.vi08 + 5);
//  vu.acc.madda(Mask::xyzw, vu.vf20, vu.vf24.y());
...
//  vu.acc.madd(Mask::xyz, vu.vf29, vu.vf29, vu.vf24.z());
//  // lq.xyzw vf22, 6(vi14)      |  mulax.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf22, vu.vi14 + 6);
//  vu.acc.mula(Mask::xyzw, vu.vf31, vu.vf24.x());
//  // lq.xyzw vf31, 6(vi08)      |  madday.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi08 + 6);
//  vu.acc.madda(Mask::xyzw, vu.vf23, vu.vf24.y());
...
//  vu.I = 1024.0;
//  // BRANCH!
//  // ibne vi00, vi15, L124      |  mulaw.xyzw ACC, vf25, vf09
//  bc = (vu.vi15 != 0);
//  vu.acc.mula(Mask::xyzw, vu.vf25, vu.vf09.w());
//  // ilw.y vi09, -6(vi01)       |  mulw.xyzw vf11, vf11, vf20
//  ilw_buffer(Mask::y, vu.vi09, vu.vi01 + -6);
...
//  vu.acc.mula(Mask::xyzw, vu.vf01, vu.vf11.x());
//  // BRANCH!
//  // b L66                      |  madday.xyzw ACC, vf02, vf11
//  bc = true;
//  vu.acc.madda(Mask::xyzw, vu.vf02, vu.vf11.y());
//  // nop                        |  maddz.xyzw vf11, vf03, vf11
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf03, vu.vf11.z());
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf11.x());
//  // BRANCH!
//  // ibgtz vi09, L67            |  madday.xyzw ACC, vf05, vf11
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf11.y());
//  // iand vi15, vi15, vi05      |  maddaz.xyzw ACC, vf06, vf11
//  vu.vi15 = vu.vi15 & vu.vi05;
...
//L67:
//  // BRANCH!
//  // ibne vi05, vi12, L68       |  maddw.xyzw vf11, vf07, vf00
//  bc = (vu.vi05 != vu.vi12);
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf09, vf09, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//  vu.vf24.mul(Mask::xyzw, vu.vf24, vu.vf29.w());
//  // lq.xyzw vf31, 0(vi15)      |  ftoi4.xyzw vf21, vf21
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi15);
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // lq.xyzw vf25, 0(vi08)      |  mul.xyzw vf11, vf11, vf23
//  lq_buffer(Mask::xyzw, vu.vf25, vu.vi08);
//  vu.vf11.mul(Mask::xyzw, vu.vf11, vu.vf23);
...
//  vu.vf09.add(Mask::xyzw, vu.vf09, vu.vf22);
//  // lq.xyzw vf20, 1(vi15)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi15 + 1);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyzw vf26, 1(vi08)      |  madday.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf26, vu.vi08 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf31, vu.vf24.y());
//  // lq.xyzw vf31, 2(vi12)      |  maddz.xyzw vf25, vf25, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi12 + 2);
//  vu.acc.madd(Mask::xyzw, vu.vf25, vu.vf25, vu.vf24.z());
//  // lq.xyzw vf23, 2(vi15)      |  mulax.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi15 + 2);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // lq.xyzw vf27, 2(vi08)      |  madday.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf27, vu.vi08 + 2);
//  vu.acc.madda(Mask::xyzw, vu.vf20, vu.vf24.y());
//  // lq.xyzw vf20, 3(vi12)      |  maddz.xyzw vf26, vf26, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi12 + 3);
//  vu.acc.madd(Mask::xyzw, vu.vf26, vu.vf26, vu.vf24.z());
//  // lq.xyzw vf31, 3(vi15)      |  mulax.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi15 + 3);
//  vu.acc.mula(Mask::xyzw, vu.vf31, vu.vf24.x());
//  // lq.xyzw vf28, 3(vi08)      |  madday.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf28, vu.vi08 + 3);
//  vu.acc.madda(Mask::xyzw, vu.vf23, vu.vf24.y());
//  // lq.xyzw vf23, 4(vi12)      |  maddz.xyzw vf27, vf27, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi12 + 4);
//  vu.acc.madd(Mask::xyzw, vu.vf27, vu.vf27, vu.vf24.z());
//  // lq.xyzw vf20, 4(vi15)      |  mulax.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyzw, vu.vf20, vu.vi15 + 4);
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lq.xyz vf29, 4(vi08)       |  madday.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyz, vu.vf29, vu.vi08 + 4);
//  vu.acc.madda(Mask::xyzw, vu.vf31, vu.vf24.y());
//  // lq.xyzw vf31, 5(vi12)      |  maddz.xyzw vf28, vf28, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi12 + 5);
//  vu.acc.madd(Mask::xyzw, vu.vf28, vu.vf28, vu.vf24.z());
//  // lq.xyzw vf23, 5(vi15)      |  mulax.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi15 + 5);
//  vu.acc.mula(Mask::xyzw, vu.vf23, vu.vf24.x());
//  // lq.xyz vf30, 5(vi08)       |  madday.xyzw ACC, vf20, vf24
//  lq_buffer(Mask::xyz, vu.vf30, vu.vi08 + 5);
//  vu.acc.madda(Mask::xyzw, vu.vf20, vu.vf24.y());
...
//  vu.acc.madd(Mask::xyz, vu.vf29, vu.vf29, vu.vf24.z());
//  // lq.xyzw vf22, 6(vi15)      |  mulax.xyzw ACC, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf22, vu.vi15 + 6);
//  vu.acc.mula(Mask::xyzw, vu.vf31, vu.vf24.x());
//  // lq.xyzw vf31, 6(vi08)      |  madday.xyzw ACC, vf23, vf24
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi08 + 6);
//  vu.acc.madda(Mask::xyzw, vu.vf23, vu.vf24.y());
...
//L69:
//  // BRANCH!
//  // ibgez vi09, L70            |  mulaz.xyzw ACC, vf29, vf10
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf10.z());
//  // sq.xyzw vf21, 2(vi10)      |  maddaz.xyzw ACC, vf30, vf13
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi10 + 2);
...
//  vu.vf11.ftoi0(Mask::xyzw, vu.vf11);
//  // BRANCH!
//  // ibeq vi07, vi03, L142      |  maddaw.xyzw ACC, vf26, vf13
//  bc = (vu.vi07 == vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf13.w());
//  // mr32.z vf16, vf00          |  maddw.xyzw vf10, vf27, vf16
//  vu.vf16.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf12.x());
//  // BRANCH!
//  // ibgtz vi09, L72            |  madday.xyzw ACC, vf05, vf12
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf12.y());
//  // iand vi13, vi13, vi05      |  maddaz.xyzw ACC, vf06, vf12
//  vu.vi13 = vu.vi13 & vu.vi05;
...
//L72:
//  // BRANCH!
//  // ibne vi05, vi10, L73       |  maddw.xyzw vf12, vf07, vf00
//  bc = (vu.vi05 != vu.vi10);
//  vu.acc.madd(Mask::xyzw, vu.vf12, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf10, vf10, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//L74:
//  // BRANCH!
//  // ibgez vi09, L75            |  mulaz.xyzw ACC, vf29, vf08
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf08.z());
//  // sq.xyzw vf21, 2(vi11)      |  maddaz.xyzw ACC, vf30, vf11
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi11 + 2);
...
//  vu.vf12.ftoi0(Mask::xyzw, vu.vf12);
//  // BRANCH!
//  // ibeq vi07, vi03, L152      |  maddaw.xyzw ACC, vf26, vf11
//  bc = (vu.vi07 == vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf11.w());
//  // mr32.z vf14, vf00          |  maddw.xyzw vf08, vf27, vf14
//  vu.vf14.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf13.x());
//  // BRANCH!
//  // ibgtz vi09, L77            |  madday.xyzw ACC, vf05, vf13
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf13.y());
//  // iand vi14, vi14, vi05      |  maddaz.xyzw ACC, vf06, vf13
//  vu.vi14 = vu.vi14 & vu.vi05;
...
//L77:
//  // BRANCH!
//  // ibne vi05, vi11, L78       |  maddw.xyzw vf13, vf07, vf00
//  bc = (vu.vi05 != vu.vi11);
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf08, vf08, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//L79:
//  // BRANCH!
//  // ibgez vi09, L80            |  mulaz.xyzw ACC, vf29, vf09
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf09.z());
//  // sq.xyzw vf21, 2(vi12)      |  maddaz.xyzw ACC, vf30, vf12
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi12 + 2);
...
//  vu.vf13.ftoi0(Mask::xyzw, vu.vf13);
//  // BRANCH!
//  // ibne vi07, vi03, L65       |  maddaw.xyzw ACC, vf26, vf12
//  bc = (vu.vi07 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf12.w());
//  // mr32.z vf15, vf00          |  maddw.xyzw vf09, vf27, vf15
//  vu.vf15.mr32(Mask::z, vu.vf00);
...
//  // erleng.xyz P, vf12         |  maxi.xy vf08, vf08, I
//  vu.P = erleng(Mask::xyz, vu.vf12); /* TODO erleng */
//  vu.vf08.maxi(Mask::xy, vu.vf08, vu.I);
//  // 3072.0                     |  nop :i
//  vu.I = 3072.0;
//  // nop                        |  minii.xy vf08, vf08, I
//  vu.vf08.minii(Mask::xy, vu.vf08, vu.I);
...
//  vu.acc.mula(Mask::xyzw, vu.vf01, vu.vf11.x());
//  // BRANCH!
//  // ibne vi04, vi03, L83       |  madday.xyzw ACC, vf02, vf11
//  bc = (vu.vi04 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf02, vu.vf11.y());
//  // nop                        |  maddz.xyzw vf11, vf03, vf11
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf03, vu.vf11.z());
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf11.x());
//  // BRANCH!
//  // ibgtz vi09, L84            |  madday.xyzw ACC, vf05, vf11
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf11.y());
//  // lq.xyzw vf31, 6(vi08)      |  maddaz.xyzw ACC, vf06, vf11
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi08 + 6);
...
//  vu.vf09.add(Mask::xyzw, vu.vf09, vu.vf22);
//  // BRANCH!
//  // ibne vi00, vi09, L85       |  mulaz.xyzw ACC, vf29, vf10
//  bc = (vu.vi09 != 0);
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf10.z());
//  // sq.xyzw vf21, 2(vi10)      |  maddaz.xyzw ACC, vf30, vf13
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi10 + 2);
...
//  // erleng.xyz P, vf13         |  maxi.xy vf09, vf09, I
//  vu.P = erleng(Mask::xyz, vu.vf13); /* TODO erleng */
//  vu.vf09.maxi(Mask::xy, vu.vf09, vu.I);
//  // BRANCH!
//  // ibne vi04, vi03, L86       |  maddaw.xyzw ACC, vf26, vf13
//  bc = (vu.vi04 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf13.w());
//  // mr32.z vf16, vf00          |  maddw.xyzw vf10, vf27, vf16
//  vu.vf16.mr32(Mask::z, vu.vf00);
...
//  // lqi.xyzw vf08, vi01        |  minii.xy vf09, vf09, I
//  lq_buffer(Mask::xyzw, vu.vf08, vu.vi01++);
//  vu.vf09.minii(Mask::xy, vu.vf09, vu.I);
//  // sq.xyzw vf11, 1(vi10)      |  madday.xyzw ACC, vf02, vf12
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf11, vu.vi10 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf02, vu.vf12.y());
//  // sq.xyzw vf11, 1(vi13)      |  maddz.xyzw vf12, vf03, vf12
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf12.x());
//  // BRANCH!
//  // ibgtz vi09, L87            |  madday.xyzw ACC, vf05, vf12
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf12.y());
//  // lq.xyzw vf31, 6(vi08)      |  maddaz.xyzw ACC, vf06, vf12
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi08 + 6);
...
//  vu.vf10.add(Mask::xyzw, vu.vf10, vu.vf22);
//  // BRANCH!
//  // ibne vi00, vi09, L88       |  mulaz.xyzw ACC, vf29, vf08
//  bc = (vu.vi09 != 0);
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf08.z());
//  // sq.xyzw vf21, 2(vi11)      |  maddaz.xyzw ACC, vf30, vf11
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi11 + 2);
...
//  // erleng.xyz P, vf11         |  maxi.xy vf10, vf10, I
//  vu.P = erleng(Mask::xyz, vu.vf11); /* TODO erleng */
//  vu.vf10.maxi(Mask::xy, vu.vf10, vu.I);
//  // BRANCH!
//  // ibne vi04, vi03, L89       |  maddaw.xyzw ACC, vf26, vf11
//  bc = (vu.vi04 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf11.w());
//  // mr32.z vf14, vf00          |  maddw.xyzw vf08, vf27, vf14
//  vu.vf14.mr32(Mask::z, vu.vf00);
...
//  // lqi.xyzw vf09, vi01        |  minii.xy vf10, vf10, I
//  lq_buffer(Mask::xyzw, vu.vf09, vu.vi01++);
//  vu.vf10.minii(Mask::xy, vu.vf10, vu.I);
//  // sq.xyzw vf12, 1(vi11)      |  madday.xyzw ACC, vf02, vf13
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf12, vu.vi11 + 1);
//  vu.acc.madda(Mask::xyzw, vu.vf02, vu.vf13.y());
//  // sq.xyzw vf12, 1(vi14)      |  maddz.xyzw vf13, vf03, vf13
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf13.x());
//  // BRANCH!
//  // ibgtz vi09, L90            |  madday.xyzw ACC, vf05, vf13
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf13.y());
//  // lq.xyzw vf31, 6(vi08)      |  maddaz.xyzw ACC, vf06, vf13
//  lq_buffer(Mask::xyzw, vu.vf31, vu.vi08 + 6);
...
//  vu.vf08.add(Mask::xyzw, vu.vf08, vu.vf22);
//  // BRANCH!
//  // ibne vi00, vi09, L91       |  mulaz.xyzw ACC, vf29, vf09
//  bc = (vu.vi09 != 0);
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf09.z());
//  // sq.xyzw vf21, 2(vi12)      |  maddaz.xyzw ACC, vf30, vf12
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi12 + 2);
...
//  vu.vf08.maxi(Mask::xy, vu.vf08, vu.I);
//  // BRANCH!
//  // ibne vi04, vi03, L82       |  maddaw.xyzw ACC, vf26, vf12
//  bc = (vu.vi04 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf12.w());
//  // mr32.z vf15, vf00          |  maddw.xyzw vf09, vf27, vf15
//  vu.vf15.mr32(Mask::z, vu.vf00);
...
//  vu.vf08.minii(Mask::xy, vu.vf08, vu.I);
//  // BRANCH!
//  // ibeq vi06, vi03, L125      |  maddaw.xyzw ACC, vf26, vf12
//  bc = (vu.vi06 == vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf12.w());
//  // mr32.z vf15, vf00          |  maddw.xyzw vf09, vf27, vf15
//  vu.vf15.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf11.x());
//  // BRANCH!
//  // ibgtz vi09, L95            |  madday.xyzw ACC, vf05, vf11
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf11.y());
//  // iand vi15, vi15, vi05      |  maddaz.xyzw ACC, vf06, vf11
//  vu.vi15 = vu.vi15 & vu.vi05;
...
//L95:
//  // BRANCH!
//  // ibne vi05, vi12, L96       |  maddw.xyzw vf11, vf07, vf00
//  bc = (vu.vi05 != vu.vi12);
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf09, vf09, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//  vu.acc.madd(Mask::xyz, vu.vf30, vu.vf30, vu.vf24.y());
//  // BRANCH!
//  // b L112                     |  mulax.xyzw ACC, vf20, vf24
//  bc = true;
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lqi.xyzw vf23, vi03        |  maddy.xyzw vf31, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//L97:
//  // BRANCH!
//  // ibgez vi09, L98            |  mulaz.xyzw ACC, vf29, vf10
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf10.z());
//  // sq.xyzw vf21, 2(vi10)      |  maddaz.xyzw ACC, vf30, vf13
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi10 + 2);
...
//  vu.vf09.maxi(Mask::xy, vu.vf09, vu.I);
//  // BRANCH!
//  // ibne vi06, vi03, L99       |  maddaw.xyzw ACC, vf26, vf13
//  bc = (vu.vi06 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf13.w());
//  // mr32.z vf16, vf00          |  maddw.xyzw vf10, vf27, vf16
//  vu.vf16.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf12.x());
//  // BRANCH!
//  // ibgtz vi09, L100           |  madday.xyzw ACC, vf05, vf12
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf12.y());
//  // iand vi13, vi13, vi05      |  maddaz.xyzw ACC, vf06, vf12
//  vu.vi13 = vu.vi13 & vu.vi05;
...
//L100:
//  // BRANCH!
//  // ibne vi05, vi10, L101      |  maddw.xyzw vf12, vf07, vf00
//  bc = (vu.vi05 != vu.vi10);
//  vu.acc.madd(Mask::xyzw, vu.vf12, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf10, vf10, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // BRANCH!
//  // b L102                     |  mul.xyzw vf12, vf12, vf23
//  bc = true;
//  vu.vf12.mul(Mask::xyzw, vu.vf12, vu.vf23);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf10, vf10, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//  vu.acc.madd(Mask::xyz, vu.vf30, vu.vf30, vu.vf24.y());
//  // BRANCH!
//  // b L117                     |  mulax.xyzw ACC, vf20, vf24
//  bc = true;
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lqi.xyzw vf23, vi03        |  maddy.xyzw vf31, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//L102:
//  // BRANCH!
//  // ibgez vi09, L103           |  mulaz.xyzw ACC, vf29, vf08
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf08.z());
//  // sq.xyzw vf21, 2(vi11)      |  maddaz.xyzw ACC, vf30, vf11
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi11 + 2);
...
//  vu.vf10.maxi(Mask::xy, vu.vf10, vu.I);
//  // BRANCH!
//  // ibne vi06, vi03, L104      |  maddaw.xyzw ACC, vf26, vf11
//  bc = (vu.vi06 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf11.w());
//  // mr32.z vf14, vf00          |  maddw.xyzw vf08, vf27, vf14
//  vu.vf14.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf13.x());
//  // BRANCH!
//  // ibgtz vi09, L105           |  madday.xyzw ACC, vf05, vf13
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf13.y());
//  // iand vi14, vi14, vi05      |  maddaz.xyzw ACC, vf06, vf13
//  vu.vi14 = vu.vi14 & vu.vi05;
...
//L105:
//  // BRANCH!
//  // ibne vi05, vi11, L106      |  maddw.xyzw vf13, vf07, vf00
//  bc = (vu.vi05 != vu.vi11);
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf08, vf08, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // BRANCH!
//  // b L107                     |  mul.xyzw vf13, vf13, vf23
//  bc = true;
//  vu.vf13.mul(Mask::xyzw, vu.vf13, vu.vf23);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf08, vf08, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//  vu.acc.madd(Mask::xyz, vu.vf30, vu.vf30, vu.vf24.y());
//  // BRANCH!
//  // b L122                     |  mulax.xyzw ACC, vf20, vf24
//  bc = true;
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.x());
//  // lqi.xyzw vf23, vi03        |  maddy.xyzw vf31, vf31, vf24
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//L107:
//  // BRANCH!
//  // ibgez vi09, L108           |  mulaz.xyzw ACC, vf29, vf09
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf09.z());
//  // sq.xyzw vf21, 2(vi12)      |  maddaz.xyzw ACC, vf30, vf12
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi12 + 2);
...
//  vu.vf08.maxi(Mask::xy, vu.vf08, vu.I);
//  // BRANCH!
//  // ibne vi06, vi03, L93       |  maddaw.xyzw ACC, vf26, vf12
//  bc = (vu.vi06 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf12.w());
//  // mr32.z vf15, vf00          |  maddw.xyzw vf09, vf27, vf15
//  vu.vf15.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf11.x());
//  // BRANCH!
//  // ibgtz vi09, L110           |  madday.xyzw ACC, vf05, vf11
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf11.y());
//  // iand vi15, vi15, vi05      |  maddaz.xyzw ACC, vf06, vf11
//  vu.vi15 = vu.vi15 & vu.vi05;
...
//L110:
//  // BRANCH!
//  // ibne vi05, vi12, L111      |  maddw.xyzw vf11, vf07, vf00
//  bc = (vu.vi05 != vu.vi12);
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf09, vf09, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // BRANCH!
//  // b L112                     |  mul.xyzw vf11, vf11, vf23
//  bc = true;
//  vu.vf11.mul(Mask::xyzw, vu.vf11, vu.vf23);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf09, vf09, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.z());
//  // BRANCH!
//  // b L97                      |  maddw.xyzw vf31, vf31, vf24
//  bc = true;
//  vu.acc.madd(Mask::xyzw, vu.vf31, vu.vf31, vu.vf24.w());
//  // lqi.xyzw vf23, vi03        |  itof0.xyzw vf24, vf23
//  vu.vf24.itof0(Mask::xyzw, vu.vf23);
...
//L112:
//  // BRANCH!
//  // ibgez vi09, L113           |  mulaz.xyzw ACC, vf29, vf10
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf10.z());
//  // sq.xyzw vf21, 2(vi10)      |  maddaz.xyzw ACC, vf30, vf13
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi10 + 2);
...
//  vu.vf09.maxi(Mask::xy, vu.vf09, vu.I);
//  // BRANCH!
//  // ibne vi06, vi03, L114      |  maddaw.xyzw ACC, vf26, vf13
//  bc = (vu.vi06 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf13.w());
//  // mr32.z vf16, vf00          |  maddw.xyzw vf10, vf27, vf16
//  vu.vf16.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf12.x());
//  // BRANCH!
//  // ibgtz vi09, L115           |  madday.xyzw ACC, vf05, vf12
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf12.y());
//  // iand vi13, vi13, vi05      |  maddaz.xyzw ACC, vf06, vf12
//  vu.vi13 = vu.vi13 & vu.vi05;
...
//L115:
//  // BRANCH!
//  // ibne vi05, vi10, L116      |  maddw.xyzw vf12, vf07, vf00
//  bc = (vu.vi05 != vu.vi10);
//  vu.acc.madd(Mask::xyzw, vu.vf12, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf10, vf10, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // BRANCH!
//  // b L117                     |  mul.xyzw vf12, vf12, vf23
//  bc = true;
//  vu.vf12.mul(Mask::xyzw, vu.vf12, vu.vf23);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf10, vf10, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.z());
//  // BRANCH!
//  // b L102                     |  maddw.xyzw vf31, vf31, vf24
//  bc = true;
//  vu.acc.madd(Mask::xyzw, vu.vf31, vu.vf31, vu.vf24.w());
//  // lqi.xyzw vf23, vi03        |  itof0.xyzw vf24, vf23
//  vu.vf24.itof0(Mask::xyzw, vu.vf23);
...
//L117:
//  // BRANCH!
//  // ibgez vi09, L118           |  mulaz.xyzw ACC, vf29, vf08
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf08.z());
//  // sq.xyzw vf21, 2(vi11)      |  maddaz.xyzw ACC, vf30, vf11
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi11 + 2);
...
//  vu.vf10.maxi(Mask::xy, vu.vf10, vu.I);
//  // BRANCH!
//  // ibne vi06, vi03, L119      |  maddaw.xyzw ACC, vf26, vf11
//  bc = (vu.vi06 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf11.w());
//  // mr32.z vf14, vf00          |  maddw.xyzw vf08, vf27, vf14
//  vu.vf14.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf13.x());
//  // BRANCH!
//  // ibgtz vi09, L120           |  madday.xyzw ACC, vf05, vf13
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf13.y());
//  // iand vi14, vi14, vi05      |  maddaz.xyzw ACC, vf06, vf13
//  vu.vi14 = vu.vi14 & vu.vi05;
...
//L120:
//  // BRANCH!
//  // ibne vi05, vi11, L121      |  maddw.xyzw vf13, vf07, vf00
//  bc = (vu.vi05 != vu.vi11);
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf08, vf08, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // BRANCH!
//  // b L122                     |  mul.xyzw vf13, vf13, vf23
//  bc = true;
//  vu.vf13.mul(Mask::xyzw, vu.vf13, vu.vf23);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf08, vf08, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//  vu.acc.mula(Mask::xyzw, vu.vf20, vu.vf24.z());
//  // BRANCH!
//  // b L107                     |  maddw.xyzw vf31, vf31, vf24
//  bc = true;
//  vu.acc.madd(Mask::xyzw, vu.vf31, vu.vf31, vu.vf24.w());
//  // lqi.xyzw vf23, vi03        |  itof0.xyzw vf24, vf23
//  vu.vf24.itof0(Mask::xyzw, vu.vf23);
...
//L122:
//  // BRANCH!
//  // ibgez vi09, L123           |  mulaz.xyzw ACC, vf29, vf09
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf09.z());
//  // sq.xyzw vf21, 2(vi12)      |  maddaz.xyzw ACC, vf30, vf12
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi12 + 2);
...
//  vu.vf08.maxi(Mask::xy, vu.vf08, vu.I);
//  // BRANCH!
//  // ibne vi06, vi03, L109      |  maddaw.xyzw ACC, vf26, vf12
//  bc = (vu.vi06 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf12.w());
//  // mr32.z vf15, vf00          |  maddw.xyzw vf09, vf27, vf15
//  vu.vf15.mr32(Mask::z, vu.vf00);
...
//  vu.acc.mula(Mask::xyzw, vu.vf01, vu.vf11.x());
//  // BRANCH!
//  // b L127                     |  madday.xyzw ACC, vf02, vf11
//  bc = true;
//  vu.acc.madda(Mask::xyzw, vu.vf02, vu.vf11.y());
//  // nop                        |  maddz.xyzw vf11, vf03, vf11
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf03, vu.vf11.z());
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf11.x());
//  // BRANCH!
//  // ibgtz vi09, L128           |  madday.xyzw ACC, vf05, vf11
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf11.y());
//  // iand vi15, vi15, vi05      |  maddaz.xyzw ACC, vf06, vf11
//  vu.vi15 = vu.vi15 & vu.vi05;
...
//L128:
//  // BRANCH!
//  // ibne vi05, vi12, L129      |  maddw.xyzw vf11, vf07, vf00
//  bc = (vu.vi05 != vu.vi12);
//  vu.acc.madd(Mask::xyzw, vu.vf11, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf09, vf09, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // BRANCH!
//  // b L130                     |  mul.xyzw vf11, vf11, vf23
//  bc = true;
//  vu.vf11.mul(Mask::xyzw, vu.vf11, vu.vf23);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf09, vf09, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//L130:
//  // BRANCH!
//  // ibgez vi09, L131           |  mulaz.xyzw ACC, vf29, vf10
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf10.z());
//  // sq.xyzw vf21, 2(vi10)      |  maddaz.xyzw ACC, vf30, vf13
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi10 + 2);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf12.x());
//  // BRANCH!
//  // ibgtz vi09, L133           |  madday.xyzw ACC, vf05, vf12
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf12.y());
//  // iand vi13, vi13, vi05      |  maddaz.xyzw ACC, vf06, vf12
//  vu.vi13 = vu.vi13 & vu.vi05;
...
//  assert(false);
//  // BRANCH!
//  // ibne vi05, vi10, L134      |  maddw.xyzw vf12, vf07, vf00
//  bc = (vu.vi05 != vu.vi10);
//  vu.acc.madd(Mask::xyzw, vu.vf12, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf10, vf10, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // BRANCH!
//  // b L135                     |  mul.xyzw vf12, vf12, vf23
//  bc = true;
//  vu.vf12.mul(Mask::xyzw, vu.vf12, vu.vf23);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf10, vf10, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//L135:
//  // BRANCH!
//  // ibgez vi09, L136           |  mulaz.xyzw ACC, vf29, vf08
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf08.z());
//  // sq.xyzw vf21, 2(vi11)      |  maddaz.xyzw ACC, vf30, vf11
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi11 + 2);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf13.x());
//  // BRANCH!
//  // ibgtz vi09, L138           |  madday.xyzw ACC, vf05, vf13
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf13.y());
//  // iand vi14, vi14, vi05      |  maddaz.xyzw ACC, vf06, vf13
//  vu.vi14 = vu.vi14 & vu.vi05;
...
//L138:
//  // BRANCH!
//  // ibne vi05, vi11, L139      |  maddw.xyzw vf13, vf07, vf00
//  bc = (vu.vi05 != vu.vi11);
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -9(vi01)       |  mul.xyz vf08, vf08, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -9);
...
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // BRANCH!
//  // b L140                     |  mul.xyzw vf13, vf13, vf23
//  bc = true;
//  vu.vf13.mul(Mask::xyzw, vu.vf13, vu.vf23);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf08, vf08, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
...
//L140:
//  // BRANCH!
//  // ibgez vi09, L141           |  mulaz.xyzw ACC, vf29, vf09
//  bc = ((s16)vu.vi09) >= 0;
//  vu.acc.mula(Mask::xyzw, vu.vf29, vu.vf09.z());
//  // sq.xyzw vf21, 2(vi12)      |  maddaz.xyzw ACC, vf30, vf12
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi12 + 2);
...
//  vu.vf08.maxi(Mask::xy, vu.vf08, vu.I);
//  // BRANCH!
//  // ibne vi07, vi03, L126      |  maddaw.xyzw ACC, vf26, vf12
//  bc = (vu.vi07 != vu.vi03);
//  vu.acc.madda(Mask::xyzw, vu.vf26, vu.vf12.w());
//  // mr32.z vf15, vf00          |  maddw.xyzw vf09, vf27, vf15
//  vu.vf15.mr32(Mask::z, vu.vf00);
...
//  vu.acc.madd(Mask::xyzw, vu.vf12, vu.vf03, vu.vf12.z());
//  // iaddiu vi04, vi02, 0x8c    |  add.xyzw vf10, vf10, vf28
//  vu.vi04 = vu.vi02 + 0x8c; /* 140 */
//  vu.vf10.add(Mask::xyzw, vu.vf10, vu.vf28);
//  // ilwr.x vi05, vi04          |  maxw.w vf09, vf09, vf02
//  ilw_buffer(Mask::x, vu.vi05, vu.vi04);
//  vu.vf09.max(Mask::w, vu.vf09, vu.vf02.w());
//  // ilw.w vi06, 1(vi04)        |  itof0.xyzw vf23, vf23
//  ilw_buffer(Mask::w, vu.vi06, vu.vi04 + 1);
//  vu.vf23.itof0(Mask::xyzw, vu.vf23);
//  // BRANCH!
//  // ibne vi00, vi08, L150      |  nop
//  bc = (vu.vi08 != 0);
//  // ilw.x vi07, 2(vi04)        |  maxx.xyzw vf12, vf12, vf00
//  ilw_buffer(Mask::x, vu.vi07, vu.vi04 + 2);
//  vu.vf12.max(Mask::xyzw, vu.vf12, vu.vf00.x());
//  if (bc) {
//    goto L150;
//  }
...
//  // div Q, vf01.w, vf10.w      |  minix.xyzw vf25, vf00, vf00
//  vu.Q = vu.vf01.w() / vu.vf10.w();
//  vu.vf25.mini(Mask::xyzw, vu.vf00, vu.vf00.x());
//  // move.xyzw vf21, vf09       |  minix.xyzw vf26, vf00, vf00
//  vu.vf21.move(Mask::xyzw, vu.vf09);
//  vu.vf26.mini(Mask::xyzw, vu.vf00, vu.vf00.x());
//  // iadd vi05, vi05, vi04      |  nop
//  vu.vi05 = vu.vi05 + vu.vi04;
//  // iaddiu vi04, vi02, 0x173   |  mulax.xyzw ACC, vf04, vf12
//  vu.vi04 = vu.vi02 + 0x173; /* 371 */
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf12.x());
//  // BRANCH!
//  // ibgtz vi09, L144           |  madday.xyzw ACC, vf05, vf12
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf12.y());
//  // iadd vi06, vi06, vi05      |  maddaz.xyzw ACC, vf06, vf12
//  vu.vi06 = vu.vi06 + vu.vi05;
//  vu.acc.madda(Mask::xyzw, vu.vf06, vu.vf12.z());
//  if (bc) {
//    goto L144;
//  }
...
//  vu.acc.madd(Mask::xyzw, vu.vf12, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -6(vi01)       |  mul.xyz vf10, vf10, Q
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -6);
//  vu.vf10.mul(Mask::xyz, vu.vf10, vu.Q); /* TODO mulq */
//  // iaddiu vi08, vi00, 0x1ba   |  mul.xyzw vf16, vf16, Q
//  vu.vi08 = 0x1ba;                        /* 442 */
//  vu.vf16.mul(Mask::xyzw, vu.vf16, vu.Q); /* TODO mulq */
//  // isub vi08, vi08, vi02      |  ftoi4.xyzw vf21, vf21
//  vu.vi08 = vu.vi08 - vu.vi02;
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
//  // iaddiu vi08, vi08, 0x173   |  mul.xyzw vf12, vf12, vf23
//  vu.vi08 = vu.vi08 + 0x173; /* 371 */
//  vu.vf12.mul(Mask::xyzw, vu.vf12, vu.vf23);
//  // lqi.xyzw vf23, vi03        |  add.xyzw vf10, vf10, vf22
//  lq_buffer(Mask::xyzw, vu.vf23, vu.vi03++);
//  vu.vf10.add(Mask::xyzw, vu.vf10, vu.vf22);
...
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi14 + 2);
//  // ilw.y vi09, -3(vi01)       |  mulw.xyzw vf13, vf13, vf20
//  ilw_buffer(Mask::y, vu.vi09, vu.vi01 + -3);
//  vu.vf13.mul(Mask::xyzw, vu.vf13, vu.vf20.w());
//  // mfir.x vf25, vi04          |  ftoi0.xyzw vf12, vf12
//  vu.vf25.mfir(Mask::x, vu.vi04);
//  vu.vf12.ftoi0(Mask::xyzw, vu.vf12);
//  // mfir.y vf25, vi04          |  nop
//  vu.vf25.mfir(Mask::y, vu.vi04);
//  // mfir.x vf26, vi08          |  nop
...
//
//  // BRANCH!
//  // ibne vi00, vi02, L151      |  maxw.w vf10, vf10, vf02
//  bc = (vu.vi02 != 0);
//  vu.vf10.max(Mask::w, vu.vf10, vu.vf02.w());
//  // nop                        |  itof0.xyzw vf23, vf23
//  vu.vf23.itof0(Mask::xyzw, vu.vf23);
...
//  vu.I = 8388608.0;
//  // 256.0                      |  maxi.xy vf27, vf00, I :i
//  vu.vf27.maxi(Mask::xy, vu.vf00, vu.I);
//  vu.I = 256.0;
//  // move.xyzw vf21, vf10       |  maxi.w vf27, vf00, I
//  vu.vf21.move(Mask::xyzw, vu.vf10);
//  vu.vf27.maxi(Mask::w, vu.vf00, vu.I);
//  // nop                        |  nop
//
//  // nop                        |  mulax.xyzw ACC, vf04, vf13
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf13.x());
//  // BRANCH!
//  // ibgtz vi09, L147           |  madday.xyzw ACC, vf05, vf13
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf13.y());
//  // nop                        |  maddaz.xyzw ACC, vf06, vf13
//  vu.acc.madda(Mask::xyzw, vu.vf06, vu.vf13.z());
...
//  vu.acc.madd(Mask::xyzw, vu.vf13, vu.vf07, vu.vf00.w());
//  // ilw.x vi09, -3(vi01)       |  itof0.xyzw vf25, vf25
//  ilw_buffer(Mask::x, vu.vi09, vu.vi01 + -3);
//  vu.vf25.itof0(Mask::xyzw, vu.vf25);
//  // nop                        |  itof0.xyzw vf26, vf26
//  vu.vf26.itof0(Mask::xyzw, vu.vf26);
//  // nop                        |  ftoi4.xyzw vf21, vf21
//  vu.vf21.ftoi4(Mask::xyzw, vu.vf21);
...
//  // ior vi02, vi05, vi00       |  add.xyzw vf25, vf25, vf27
//  vu.vi02 = vu.vi05;
//  vu.vf25.add(Mask::xyzw, vu.vf25, vu.vf27);
//  // BRANCH!
//  // ibgez vi09, L148           |  add.xyzw vf26, vf26, vf27
//  bc = ((s16)vu.vi09) >= 0;
//  vu.vf26.add(Mask::xyzw, vu.vf26, vu.vf27);
//  // sq.xyzw vf21, 2(vi12)      |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi12 + 2);
//  if (bc) {
//    goto L148;
...
//  // ior vi06, vi07, vi00       |  max.xyzw vf25, vf26, vf26
//  vu.vi06 = vu.vi07;
//  vu.vf25.max(Mask::xyzw, vu.vf26, vu.vf26);
//L149:
//  // sq.xyzw vf16, 0(vi15)      |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf16, vu.vi15);
//  // sq.xyzw vf21, 2(vi15)      |  nop
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf13.x());
//  // BRANCH!
//  // ibgtz vi09, L154           |  madday.xyzw ACC, vf05, vf13
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf13.y());
//  // iadd vi06, vi06, vi05      |  maddaz.xyzw ACC, vf06, vf13
//  vu.vi06 = vu.vi06 + vu.vi05;
...
//
//  // BRANCH!
//  // ibne vi00, vi02, L161      |  maxw.w vf08, vf08, vf02
//  bc = (vu.vi02 != 0);
//  vu.vf08.max(Mask::w, vu.vf08, vu.vf02.w());
//  // nop                        |  itof0.xyzw vf23, vf23
//  vu.vf23.itof0(Mask::xyzw, vu.vf23);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf11.x());
//  // BRANCH!
//  // ibgtz vi09, L157           |  madday.xyzw ACC, vf05, vf11
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf11.y());
//  // nop                        |  maddaz.xyzw ACC, vf06, vf11
//  vu.acc.madda(Mask::xyzw, vu.vf06, vu.vf11.z());
...
//  vu.vf25.add(Mask::xyzw, vu.vf25, vu.vf27);
//  // BRANCH!
//  // ibgez vi09, L158           |  add.xyzw vf26, vf26, vf27
//  bc = ((s16)vu.vi09) >= 0;
//  vu.vf26.add(Mask::xyzw, vu.vf26, vu.vf27);
//  // sq.xyzw vf21, 2(vi10)      |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi10 + 2);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf11.x());
//  // BRANCH!
//  // ibgtz vi09, L164           |  madday.xyzw ACC, vf05, vf11
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf11.y());
//  // iadd vi06, vi06, vi05      |  maddaz.xyzw ACC, vf06, vf11
//  vu.vi06 = vu.vi06 + vu.vi05;
...
//
//  // BRANCH!
//  // ibne vi00, vi02, L171      |  maxw.w vf09, vf09, vf02
//  bc = (vu.vi02 != 0);
//  vu.vf09.max(Mask::w, vu.vf09, vu.vf02.w());
//  // nop                        |  itof0.xyzw vf23, vf23
//  vu.vf23.itof0(Mask::xyzw, vu.vf23);
...
//  vu.acc.mula(Mask::xyzw, vu.vf04, vu.vf12.x());
//  // BRANCH!
//  // ibgtz vi09, L167           |  madday.xyzw ACC, vf05, vf12
//  bc = ((s16)vu.vi09) > 0;
//  vu.acc.madda(Mask::xyzw, vu.vf05, vu.vf12.y());
//  // nop                        |  maddaz.xyzw ACC, vf06, vf12
//  vu.acc.madda(Mask::xyzw, vu.vf06, vu.vf12.z());
...
//  vu.vf25.add(Mask::xyzw, vu.vf25, vu.vf27);
//  // BRANCH!
//  // ibgez vi09, L168           |  add.xyzw vf26, vf26, vf27
//  bc = ((s16)vu.vi09) >= 0;
//  vu.vf26.add(Mask::xyzw, vu.vf26, vu.vf27);
//  // sq.xyzw vf21, 2(vi11)      |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf21, vu.vi11 + 2);
...
//  bc = (vu.vi06 != vu.vi05);
//  vu.vf11.add(Mask::xyzw, vu.vf27, vu.vf25);
//  // nop                        |  nop
//
//  if (bc) {
//    goto L173;
...
//
//  // lq.xyzw vf16, 2(vi08)      |  maxx.xyzw vf15, vf11, vf00
//  lq_buffer(Mask::xyzw, vu.vf16, vu.vi08 + 2);
//  vu.vf15.max(Mask::xyzw, vu.vf11, vu.vf00.x());
//  // lq.xyzw vf13, 0(vi08)      |  nop
//  lq_buffer(Mask::xyzw, vu.vf13, vu.vi08);
//  // BRANCH!
//  // b L177                     |  nop
...
//  vu.vi10 = vu.vf11.y_as_u16();
//  // sq.xyzw vf13, 0(vi09)      |  itof0.xyzw vf27, vf27
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf13, vu.vi09);
//  vu.vf27.itof0(Mask::xyzw, vu.vf27);
//  // sq.xyzw vf14, 1(vi09)      |  add.w vf12, vf12, vf15
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf14, vu.vi09 + 1);
//  vu.vf12.add(Mask::w, vu.vf12, vu.vf15);
//  // lq.xyzw vf16, 2(vi08)      |  maxx.xyzw vf15, vf11, vf00
//  lq_buffer(Mask::xyzw, vu.vf16, vu.vi08 + 2);
//  vu.vf15.max(Mask::xyzw, vu.vf11, vu.vf00.x());
//  // lq.xyzw vf13, 0(vi08)      |  nop
...
//  vu.vf11.add(Mask::xyzw, vu.vf27, vu.vf25);
//  // sq.xyzw vf12, 2(vi09)      |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf12, vu.vi09 + 2);
//  if (bc) {
//    goto L175;
//  }
//
...
//  vu.vi09 = vu.vf11.y_as_u16();
//  // sq.xyzw vf13, 0(vi10)      |  itof0.xyzw vf27, vf27
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf13, vu.vi10);
//  vu.vf27.itof0(Mask::xyzw, vu.vf27);
//  // sq.xyzw vf14, 1(vi10)      |  add.w vf16, vf16, vf15
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf14, vu.vi10 + 1);
//  vu.vf16.add(Mask::w, vu.vf16, vu.vf15);
//  // lq.xyzw vf12, 2(vi08)      |  maxx.xyzw vf15, vf11, vf00
//  lq_buffer(Mask::xyzw, vu.vf12, vu.vi08 + 2);
//  vu.vf15.max(Mask::xyzw, vu.vf11, vu.vf00.x());
//  // lq.xyzw vf13, 0(vi08)      |  nop
...
//  vu.vf11.add(Mask::xyzw, vu.vf27, vu.vf25);
//  // sq.xyzw vf16, 2(vi10)      |  nop
//  sq_buffer(__LINE__, Mask::xyzw, vu.vf16, vu.vi10 + 2);
//  if (bc) {
//    goto L174;
//  }
//
...
//  // iaddiu vi02, vi00, 0x47    |  maxw.x vf20, vf00, vf20
//  vu.vi02 = 0x47; /* 71 */
//  vu.vf20.max(Mask::x, vu.vf00, vu.vf20.w());
//  // isw.z vi02, -1(vi04)       |  nop
//  isw_buffer(Mask::z, vu.vi02, vu.vi04 + -1);
//  // sq.yzw vf21, -2(vi04)      |  nop
//  sq_buffer(__LINE__, Mask::yzw, vu.vf21, vu.vi04 + -2);
//  // isw.w vi00, 132(vi00)      |  nop
//  isw_buffer(Mask::w, vu.vi00, 132);
//  // sq.x vf20, -1(vi04)        |  nop
//  sq_buffer(__LINE__, Mask::x, vu.vf20, vu.vi04 + -1);
//  // iaddi vi04, vi04, -0x2     |  nop
//  vu.vi04 = vu.vi04 + -2;
//  // xgkick vi04                |  nop
//  xgkick(vu.vi04, render_state, prof);
