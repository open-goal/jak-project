...
(text
  ...
  ;; "patch" files so we can fix some errors and maintain consistency
  (jak1-v2 "game/assets/jak1/text/text_patch_fr.gs")
  (jak1-v2 "game/assets/jak1/text/text_patch_de.gs")
