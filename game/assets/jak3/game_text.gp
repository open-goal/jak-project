...
(text
  ...
  (file-json 16 jak3 "common" '("game/assets/jak2/text/game_custom_text_pt-BR.json"))
  (file-json 17 jak3 "common" '("game/assets/jak2/text/game_custom_text_hu-HU.json"))
  (file-json 18 jak3 "common" '("game/assets/jak2/text/game_custom_text_ca-ES.json"))
  (file-json 19 jak3 "common" '("game/assets/jak2/text/game_custom_text_is-IS.json"))
  (file-json 20 jak3 "common" '("game/assets/jak2/text/game_custom_text_pl-PL.json"))
  (file-json 21 jak3 "common" '("game/assets/jak2/text/game_custom_text_lt-LT.json"))
  (file-json 22 jak3 "common" '("game/assets/jak2/text/game_custom_text_cs-CZ.json"))
  (file-json 23 jak3 "common" '("game/assets/jak2/text/game_custom_text_hr-HR.json"))
  (file-json 24 jak3 "common" '("game/assets/jak2/text/game_custom_text_gl-ES.json"))
  )
