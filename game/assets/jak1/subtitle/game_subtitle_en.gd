...
("sage-intro-sequence-a"
  ...
  (323 :offscreen "SAGE" "WHY DID THEY CREATE THE VAST MONOLITHS THAT LITHER OUR PLANET?")
  (451)
...
("warrior-reminder-1"
  ...
  (123 "WARRIOR" "I'M NOT LOOKING TO FIX THE PONTOON BRIGE ANY TIME SOON.")
  )
...
("asstvb20" :hint #x327
  ...
  (310 "KEIRA" "THAT'S ONE MORE POWER CELL!")
  )
