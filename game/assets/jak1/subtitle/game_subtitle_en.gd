...
("death-0202" (5 "DAXTER" "SAY GOODNIGHT, JAK!"))
...
("oracle-reminder-2" (190 "ORACLE" "PRESENT 120 PRECURSOR ORBS, AND A POWER CELL WILL BE YOUR REWARD."))
...
("sksp0021" :hint #x0 (0 "DAXTER" "THERE'RE THOSE SEAGULLS AGAIN. LET'S GET 'EM!!"))
...
("geologist-reminder-money" (30 "GEOLOGIST" "I NEED THOSE ORBS IF I'M GOING TO CONTINUE MY RESEARCH!"))
...
("warrior-reminder-1" (36 "WARRIOR" "TAKE ALL THE TIME YOU WANT BRINGING ME THE PRECURSOR ORBS - I'M NOT LOOKING TO FIX THE PONTOON BRIGE ANY TIME SOON."))
...
("BIL-AM08" :hint #x0 (0 "BILLY" "DARN... SEAT'S GIVIN' ME A RASH."))
...
("BIL-LO02" :hint #x0 (0 "BILLY" "SUI, SUI, SUI, SUI, SOO-EE!"))
("BIL-LO03" :hint #x0 (0 "BILLY" "SUI, SUI, SOO-EE!"))
("BIL-LO1A" :hint #x0 (0 "BILLY" "FARTHY!"))
("BIL-LO2A" :hint #x0 (0 "BILLY" "SUI, SUI, SOO-EE!"))
("BIL-LO2B" :hint #x0 (0 "BILLY" "SOO-EE! SOO-EE!"))
...
("BIL-TA08" :hint #x0 (0 "BILLY" "GOTTEM."))
("BIL-TA09" :hint #x0 (0 "BILLY" "YEEEEE-HAW!"))
("BIL-TA1A" :hint #x0 (0 "BILLY" "GIT 'EM!"))
...
("billy-reject" (7 "BILLY" "WELL, IF YOU CHANGE YOUR MIND, YOU KNOW WHERE TO FIND ME! (LAUGHS)"))
("billy-reminder-1" (36 "BILLY" "AHH, Y'ALL BACK TO HELP STOP THEM RATS?"))
("billy-resolution" (1 "BILLY" "WELL FRY MY HIDE! YOU SURE KNOW HOW TO SHOOT! THANKS A HEAP FOR THE HELP."))
...
("sksp0143" :hint #x0 (0 "DAXTER" "WAAH! BREAK THE TONGUE'S GRIP!"))
("sksp0144" :hint #x358 (0 "DAXTER" "SHOOT THOSE RAT NESTS TO STOP THE RATS FROM COMING OUT."))
("sksp0151" :hint #x0 (0 "DAXTER" "RUN AWAY, JAK!"))
("sksp0152" :hint #x360 (0 "DAXTER" "LOOK OUT, JAK! IT'S AN AMBUSH!"))
("sksp0156" :hint #x0 (0 "DAXTER" "MAYBE WE CAN DUCK THE BATS!"))
("sksp0157" :hint #x0 (0 "DAXTER" "DID YOU SEE THAT?! ONLY THREE MORE TETHERS TO GO!"))
...
("sksp0130" :hint #x34a (0 "DAXTER" "UHH, I THINK WE HAVE TO SWITCH ON ALL THOSE PLATFORMS OR SOMETHIN'."))
...
("gamcam23" :hint #x0 (242 "KLAWW" "(ROARS)"))
...
("ASSTLP36" :hint #x0 (0 "KEIRA" "HUH. THE HEAT SHIELD'S GONNA NEED EVEN MORE POWER TO WITHSTAND THE LAVA."))
("ASSTLP37" :hint #x0 (0 "KEIRA" "OHH... WE'VE GOT TO SAVE THE OTHER SAGES..."))
...
("MSH-AM10" :hint #x0 (0 "GORDY" "THIS LOOKS LIKE A RARE CRYSTITE LARCONIA! (LAUGHS GIDDILY)"))
...
("MTA-AM01" :hint #x0 (0 "WILLARD" "UH, ARE WE ALMOST DONE?"))
("MTA-AM02" :hint #x0 (0 "WILLARD" "GEE, CAN WE TAKE A BREAK?"))
("MTA-AM03" :hint #x0 (0 "WILLARD" "AWW, I'M HUNGRY..."))
("MTA-AM04" :hint #x0 (0 "WILLARD" "UHH... I THINK BIRDIE'S CAGE NEEDS CLEANING..."))
("MTA-AM05" :hint #x0 (0 "WILLARD" "GEE, THAT'S AN AWFULLY BIG GEM!"))
("MTA-AM06" :hint #x0 (0 "WILLARD" "I ALWAYS WANTED TO BE A LUMBERJACK..."))
("MTA-AM07" :hint #x0 (0 "WILLARD" "UH, GORDY PROMISED TO GIVE ME HALF OF WHATEVER I COULD CARRY!"))
("MTA-AM08" :hint #x0 (0 "WILLARD" "EH HEH... BIRDIE IS MY BEST FRIEND<TIL>"))
("MTA-AM09" :hint #x0 (0 "WILLARD" "I LOVE MY LITTLE BIRDIE<TIL>"))
...
("SAGELP34" :hint #x0 (0 "SAGE" "RNN, DARK ECO'S POWERS CANNOT BE CONTROLLED!"))
...
("asstvb75" :hint #x429 (0 "KEIRA" "THIS GONDOLA SEEMS TO BE MALFUNCTIONING. I'LL TRY TO WORK ON IT AND GET IT RUNNING AGAIN."))
...
("YEL-AM01" :hint #x0 (0 "RED SAGE" "TIME IS RUNNIN' OUT!"))
("YEL-AM02" :hint #x0 (0 "RED SAGE" "HEY! GET ME OUTTA HERE!"))
("YEL-AM03" :hint #x0 (0 "RED SAGE" "WHEN I GET OUTTA HERE, SOME SHOOTIN'S GONNA START!"))
