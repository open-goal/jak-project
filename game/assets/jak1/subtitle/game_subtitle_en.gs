...
("sage-intro-sequence-a"
  ...
  (1064)
  (1091 "SAGE" "EVERY BONE IN MY BODY TELLS ME THAT THE ANSWERS REST ON THE SHOULDERS OF A YOUNG BOY")
  ...
  (2286 "SAGE" "IT BEGINS WITH BUT A SMALL ACT OF DISOBEDIENCE.")
  (2440 "DAXTER" "HEY! UH, JAK? OL' GREEN STUFF TOLD US NOT TO COME HERE!")
  )

("sidekick-human-intro-sequence-b"
  (547 "MALE FIGURE" "CONTINUE YOUR SEARCH FOR ARTIFACTS AND ECO.")
  (675 "MALE FIGURE" "IF THE LOCALS POSSESS PRECURSOR ITEMS, YOU KNOW WHAT TO DO.")
  (842 "FEMALE FIGURE" "DEAL HARSHLY WITH ANYBODY WHO STRAYS FROM THE VILLAGE.")
  (937 "FEMALE FIGURE" "WE WILL ATTACK IT IN DUE TIME.")
  (1027)
  )
...
("sidekick-human-intro-sequence-c"
  ...
  (1133 "DAXTER" "BUT IF YOU ASK ME, THEY MUST HAVE BEEN REAL LOSERS.")
  (1213 "DAXTER" "WHOA! HOW DID YOU DO THAT?")
  (1271)
