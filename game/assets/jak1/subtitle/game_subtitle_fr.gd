...
("assistant-introduction-race-bike"
  ...
  (63 "KEIRA" "FAIT ATTENTION A CA ! J'ESSAYE DE TROUVER UN MOYEN POUR TRANSPORTER LE ZOOMER")
  (200 "KEIRA" "GRACE AUX TRANS-PADS QUE LES PRECURSORS ONT LAISSE PARTOUT DANS LE MONDE")
  (308)
...
("assistant-reminder-1-generic"
  (25 "KEIRA" "HEY LES GARS ! CONTINUEZ À RÉCUPÉRER DES PILES D'ENERGIE")
  (98 "KEIRA" "GRÂCE À ELLES, VOUS IREZ DANS LE NORD.")
  )

("assistant-reminder-1-race-bike"
  (19 "KEIRA" "J'AI FINALEMENT REUSSI A UTILISER LES TRANS-PADS")
...
("explorer-reminder-2"
  (33 "ONCLE DE JAK" "VOYONS VOIR, C'EST 90 ORBES PRECURSOR POUR UNE PILE D'ENERGIE.")
...
("sage-reminder-2-generic"
  ...
  (137 "SAGE" "CA NE SE LIMITE PAS A L'HISTOIRE D'UN GARCON QUI A PERDU LA BOULE, IL S'AGIT DE LA VIE ELLE MÊME.")
  (320)
...
("sksp0015" :hint #x234
  (0 "DAXTER" "CA DOIT ÊTRE UN ORACLE PRECUSOR DONT LE SAGE PARLE TOUJOURS.")
...
("asstvb04" :hint #x2b1
  ...
  (543 "KEIRA" "AMMENEZ LES PILES D'ÉNERGIE, ET DEPECHEZ VOUS")
