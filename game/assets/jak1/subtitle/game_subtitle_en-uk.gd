...
("sage-bluehut-introduction-prec-arm"
  ...
  (417 :offscreen "SAMOS" "TO LIFT AN IMPORTANT PRECURSOR ARTEFACT FROM THE MUCK.")
  (531)
  (549 :offscreen "SAMOS" "YOU'RE GOING TO HAVE TO GET OVER THERE TO DISLODGE THEIR TETHERS.")
  (675)
  (685 "SAMOS" "WHO KNOWS WHAT THEY MIGHT WANT WITH THE ARTEFACT,")
...
("green-sagecage-introduction"
  ...
  (709 :offscreen "SAMOS" "WITH SCAVENGED ARTEFACTS FROM ACROSS THE LAND.")
  (800)
