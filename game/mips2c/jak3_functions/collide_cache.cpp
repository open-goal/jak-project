...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(s3) == c->sgpr64(s7);              // beq s3, s7, L92
  // nop                                            // sll r0, r0, 0
...
block_9:
  ...
  bc = c->sgpr64(a3) == 0;                          // beq a3, r0, L92
...
block_12:
  ...
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(a0))) {// beql s7, a0, L91
...
block_7:
  // daddiu a0, fp, L181                               // daddiu a0, fp, L181
  //   .word 0x0
  //   .word 0x45800000
  //   .word 0x0
  //   .word 0x3f800000
...
block_20:
  c->load_symbol2(t9, cache.format);                // lw t9, format(s7)
  c->addiu(a0, r0, 0);                              // addiu a0, r0, 0
  // daddiu a1, fp, L180                               // daddiu a1, fp, L180
  call_addr = c->gprs[t9].du32[0];                  // function call:
  c->sll(v0, ra, 0);                                // sll v0, ra, 0
  // c->jalr(call_addr);                               // jalr ra, t9
