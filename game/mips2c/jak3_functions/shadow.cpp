...
u64 execute(void* ctxt) {
  ...
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a3) == 0;                          // beq a3, r0, L117
  // nop                                            // sll r0, r0, 0
...
block_1:
  ...
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a3) != 0;                          // bne a3, r0, L116
  // nop                                            // sll r0, r0, 0
...
block_2:
  ...
  bc = c->sgpr64(a0) == 0;                          // beq a0, r0, L119
  // nop                                            // sll r0, r0, 0
...
block_3:
  ...
  c->daddiu(a2, a2, 16);                            // daddiu a2, a2, 16
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a0) != 0;                          // bne a0, r0, L118
  // nop                                            // sll r0, r0, 0
...
u64 execute(void* ctxt) {
  ...
  c->mov64(a2, a2);                                 // or a2, a2, r0
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a0) == 0;                          // beq a0, r0, L114
  // nop                                            // sll r0, r0, 0
  ...
  c->lq(a3, 0, a2);                                 // lq a3, 0(a2)
  bc = ((s64)c->sgpr64(a0)) <= 0;                   // blez a0, L112
  c->lq(t0, 16, a2);                                // lq t0, 16(a2)
...
block_3:
  ...
  // nop                                            // sll r0, r0, 0
  c->mov128_vf_gpr(vf5, t1);                        // qmtc2.ni vf5, t1
  bc = ((s64)c->sgpr64(a0)) > 0;                    // bgtz a0, L111
  c->mov128_vf_gpr(vf6, t2);                        // qmtc2.ni vf6, t2
  if (bc) {goto block_3;}                           // branch non-likely
...
block_4:
  ...
  bc = c->sgpr64(a2) == 0;                          // beq a2, r0, L113
  c->sq(a3, 0, v1);                                 // sq a3, 0(v1)
  ...
  bc = c->sgpr64(t2) == 0;                          // beq t2, r0, L113
...
u64 execute(void* ctxt) {
  ...
  c->mov64(a2, a2);                                 // or a2, a2, r0
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a0) == 0;                          // beq a0, r0, L109
  // nop                                            // sll r0, r0, 0
...
block_1:
  ...
  bc = ((s64)c->sgpr64(t0)) < 0;                    // bltz t0, L107
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_4;}                           // branch non-likely

  bc = ((s64)c->sgpr64(t1)) > 0;                    // bgtz t1, L108
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_5;}                           // branch non-likely
...
block_4:
  bc = ((s64)c->sgpr64(t1)) < 0;                    // bltz t1, L108
  c->daddiu(a3, a3, 1);                             // daddiu a3, a3, 1
  if (bc) {goto block_5;}                           // branch non-likely
...
block_5:
  ...
  c->daddiu(a0, a0, -1);                            // daddiu a0, a0, -1
  bc = c->sgpr64(a0) != 0;                          // bne a0, r0, L106
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_1;}                           // branch non-likely
...
block_1:
  ...
  // nop                                            // sll r0, r0, 0
  bc = ((s64)c->sgpr64(a2)) < 0;                    // bltz a2, L103
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_3;}                           // branch non-likely
...
block_3:
  ...
  c->daddiu(a1, a1, 16);                            // daddiu a1, a1, 16
  c->daddiu(a0, a0, -1);                            // daddiu a0, a0, -1
  bc = c->sgpr64(a0) != 0;                          // bne a0, r0, L102
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_1;}                           // branch non-likely
...
u64 execute(void* ctxt) {
  ...
  bc = ((s64)c->sgpr64(t0)) < 0;                    // bltz t0, L96
  c->daddiu(t0, t0, 4);                             // daddiu t0, t0, 4
...
block_2:
  ...
  bc = ((s64)c->sgpr64(t3)) >= 0;                   // bgez t3, L92
...
block_4:
  bc = ((s64)c->sgpr64(t4)) >= 0;                   // bgez t4, L93
...
block_6:
  bc = ((s64)c->sgpr64(t2)) >= 0;                   // bgez t2, L94
  c->daddiu(a3, a3, 4);                             // daddiu a3, a3, 4
  if (bc) {goto block_8;}                           // branch non-likely
...
block_8:
  bc = ((s64)c->sgpr64(t3)) >= 0;                   // bgez t3, L95
  c->daddiu(a3, a3, 4);                             // daddiu a3, a3, 4
...
block_10:
  bc = ((s64)c->sgpr64(t0)) > 0;                    // bgtz t0, L91
  c->daddiu(a3, a3, 4);                             // daddiu a3, a3, 4
  if (bc) {goto block_2;}                           // branch non-likely


block_11:
  bc = ((s64)c->sgpr64(t0)) <= 0;                   // blez t0, L99
  // nop                                            // sll r0, r0, 0
...
block_12:
  ...
  // nop                                            // sll r0, r0, 0
  bc = ((s64)c->sgpr64(t1)) >= 0;                   // bgez t1, L98
  c->addiu(t1, r0, 1);                              // addiu t1, r0, 1
...
block_14:
  ...
  bc = c->sgpr64(t0) != 0;                          // bne t0, r0, L97
  c->daddiu(a3, a3, 4);                             // daddiu a3, a3, 4
...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(a3) == 0;                          // beq a3, r0, L89
...
block_2:
  ...
  bc = c->sgpr64(t4) == c->sgpr64(t2);              // beq t4, t2, L86
  ...
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(t4) == c->sgpr64(t5);              // beq t4, t5, L88
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_7;}                           // branch non-likely
...
block_5:
  ...
  bc = c->sgpr64(t4) == 0;                          // beq t4, r0, L88
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_7;}                           // branch non-likely
...
block_7:
  bc = c->sgpr64(a3) != 0;                          // bne a3, r0, L85
...
u64 execute(void* ctxt) {
  ...
  bc = ((s64)c->sgpr64(a1)) < 0;                    // bltz a1, L80
...
block_2:
  ...
  // nop                                            // sll r0, r0, 0
  c->mov128_gpr_vf(a3, vf24);                       // qmfc2.ni a3, vf24
  bc = ((s64)c->sgpr64(t0)) >= 0;                   // bgez t0, L76
...
block_4:
  bc = ((s64)c->sgpr64(t1)) >= 0;                   // bgez t1, L77
  c->daddiu(v1, v1, 4);                             // daddiu v1, v1, 4
  if (bc) {goto block_6;}                           // branch non-likely
...
block_6:
  bc = ((s64)c->sgpr64(a3)) >= 0;                   // bgez a3, L78
  c->daddiu(v1, v1, 4);                             // daddiu v1, v1, 4
  if (bc) {goto block_8;}                           // branch non-likely
...
block_8:
  bc = ((s64)c->sgpr64(t0)) >= 0;                   // bgez t0, L79
  c->daddiu(v1, v1, 4);                             // daddiu v1, v1, 4
  if (bc) {goto block_10;}                          // branch non-likely
...
block_10:
  bc = ((s64)c->sgpr64(a1)) > 0;                    // bgtz a1, L75
  c->daddiu(v1, v1, 4);                             // daddiu v1, v1, 4
  if (bc) {goto block_2;}                           // branch non-likely


block_11:
  bc = ((s64)c->sgpr64(a1)) <= 0;                   // blez a1, L83
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_15;}                          // branch non-likely
...
block_12:
  ...
  c->mov128_gpr_vf(a2, vf5);                        // qmfc2.i a2, vf5
  // nop                                            // sll r0, r0, 0
  bc = ((s64)c->sgpr64(a2)) >= 0;                   // bgez a2, L82
  c->addiu(a2, r0, 1);                              // addiu a2, r0, 1
  if (bc) {goto block_14;}                          // branch non-likely
...
block_14:
  ...
  bc = c->sgpr64(a1) != 0;                          // bne a1, r0, L81
  c->daddiu(v1, v1, 4);                             // daddiu v1, v1, 4
  if (bc) {goto block_12;}                          // branch non-likely
...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(a3) == 0;                          // beq a3, r0, L73
...
block_2:
  ...
  bc = c->sgpr64(t3) == c->sgpr64(t2);              // beq t3, t2, L71
  ...
  bc = c->sgpr64(t4) == c->sgpr64(t3);              // beq t4, t3, L72
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_6;}                           // branch non-likely
...
u64 execute(void* ctxt) {
  ...
  bc = ((s64)c->sgpr64(t4)) < 0;                    // bltz t4, L63
...
block_1:
  ...
  bc = ((s64)c->sgpr64(t7)) >= 0;                   // bgez t7, L62
...
block_7:
  ...
  bc = c->sgpr64(a3) != 0;                          // bne a3, r0, L68
  ...
  c->mov64(a2, a2);                                 // or a2, a2, r0
  bc = ((s64)c->sgpr64(t0)) < 0;                    // bltz t0, L66
...
block_9:
  ...
  bc = ((s64)c->sgpr64(t3)) >= 0;                   // bgez t3, L65
...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L60
...
block_2:
  ...
  c->sw(a3, 0, a2);                                 // sw a3, 0(a2)
  c->daddiu(a2, a2, 4);                             // daddiu a2, a2, 4
  bc = ((s64)c->sgpr64(v1)) > 0;                    // bgtz v1, L59
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_2;}                           // branch non-likely
...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L57
...
block_2:
  ...
  c->daddiu(v1, v1, -1);                            // daddiu v1, v1, -1
  c->daddiu(a3, a3, 4);                             // daddiu a3, a3, 4
  bc = ((s64)c->sgpr64(v1)) > 0;                    // bgtz v1, L56
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_2;}                           // branch non-likely
...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(a1) == 0;                          // beq a1, r0, L54
  c->daddu(v1, v1, a0);                             // daddu v1, v1, a0
  if (bc) {goto block_4;}                           // branch non-likely
...
block_2:
  ...
  c->daddiu(a1, a1, -1);                            // daddiu a1, a1, -1
  c->sw(a3, 0, a2);                                 // sw a3, 0(a2)
  bc = ((s64)c->sgpr64(a1)) > 0;                    // bgtz a1, L53
  c->daddiu(a2, a2, 4);                             // daddiu a2, a2, 4
  if (bc) {goto block_2;}                           // branch non-likely
...
block_2:
  ...
  c->sw(a3, 0, a2);                                 // sw a3, 0(a2)
  c->daddiu(a2, a2, 4);                             // daddiu a2, a2, 4
  bc = ((s64)c->sgpr64(v1)) > 0;                    // bgtz v1, L50
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_2;}                           // branch non-likely
...
block_2:
  ...
  c->daddiu(v1, v1, -1);                            // daddiu v1, v1, -1
  c->daddiu(a3, a3, 4);                             // daddiu a3, a3, 4
  bc = ((s64)c->sgpr64(v1)) > 0;                    // bgtz v1, L47
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_2;}                           // branch non-likely
...
block_4:
  ...
  bc = c->sgpr64(a3) == 0;                          // beq a3, r0, L26
...
block_5:
  ...
  c->daddiu(a3, a3, 1);                             // daddiu a3, a3, 1
  bc = c->sgpr64(t0) != 0;                          // bne t0, r0, L25
  c->sw(a3, 0, a2);                                 // sw a3, 0(a2)
  if (bc) {goto block_5;}                           // branch non-likely
*/
...
/*
  ...
  bc = c->sgpr64(a1) == 0;                          // beq a1, r0, L28
  DANGER jump to delay slot, this MUST be fixed manually!
...
*/
  ...
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L29
  c->mov64(v1, s7);                                 // or v1, s7, r0
...
block_13:
  ...
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L30
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_15;}                          // branch non-likely
...
block_16:
  ...
  if (((s64)c->sgpr64(v1)) == ((s64)0)) {           // beql v1, r0, L32
...
block_23:
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(v1))) {// beql s7, v1, L34
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_27;
  }
...
block_33:
  ...
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L38
  c->mov64(v1, s7);                                 // or v1, s7, r0
...
block_37:
  bc = c->sgpr64(s4) != 0;                          // bne s4, r0, L22
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_1;}                           // branch non-likely
