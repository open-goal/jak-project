...
block_2:
  ...
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a3) != 0;                          // bne a3, r0, L170
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_2;}                           // branch non-likely

  bc = c->sgpr64(a2) != 0;                          // bne a2, r0, L169
  // nop                                            // sll r0, r0, 0
...
//   bc = c->sgpr64(a1) == 0;                          // beq a1, r0, L172
...
//   bc = c->sgpr64(a2) != 0;                          // bne a2, r0, L171
...
block_8:
  ...
  bc = ((s64)c->sgpr64(ra)) > 0;                    // bgtz ra, L88
  ...
  bc = c->sgpr64(t1) == 0;                          // beq t1, r0, L90
...
block_29:
  c->daddiu(a0, a0, -1);                            // daddiu a0, a0, -1
  c->sq(a3, 144, a1);                               // sq a3, 144(a1)
  bc = c->sgpr64(a0) == 0;                          // beq a0, r0, L108
...
block_43:
  ...
  bc = c->sgpr64(a1) != c->sgpr64(a3);              // bne a1, a3, L111
...
block_51:
  ...
  c->daddiu(v0, v0, 48);                            // daddiu v0, v0, 48
  bc = c->sgpr64(s4) == c->sgpr64(s5);              // beq s4, s5, L119
  ...
  c->addiu(s4, s4, 2);                              // addiu s4, s4, 2
  c->sqc2(vf15, 64, v1);                            // sqc2 vf15, 64(v1)
  bc = c->sgpr64(t5) == c->sgpr64(s5);              // beq t5, s5, L120
  c->daddiu(t5, t5, 2);                             // daddiu t5, t5, 2
  ...
  c->daddiu(s6, s6, 16);                            // daddiu s6, s6, 16
  bc = c->sgpr64(s4) != c->sgpr64(s5);              // bne s4, s5, L116
  c->sqc2(vf15, 96, v1);                            // sqc2 vf15, 96(v1)
...
block_58:
  ...
  bc = c->sgpr64(s1) == 0;                          // beq s1, r0, L122
...
block_59:
  ...
  bc = c->sgpr64(s0) != c->sgpr64(s1);              // bne s0, s1, L121
...
block_61:
  ...
  bc = c->sgpr64(s2) == 0;                          // beq s2, r0, L125
  ...
  c->daddiu(s5, s5, 1);                             // daddiu s5, s5, 1
  bc = c->sgpr64(s0) == c->sgpr64(s2);              // beq s0, s2, L124
  // nop                                            // sll r0, r0, 0
...
block_63:
  ...
  c->sb(s5, 0, s6);                                 // sb s5, 0(s6)
  c->daddiu(s5, s5, 1);                             // daddiu s5, s5, 1
  bc = c->sgpr64(s0) != c->sgpr64(s2);              // bne s0, s2, L123
...
u64 execute(void* ctxt) {
  ...
  c->daddiu(a3, a3, -1);                            // daddiu a3, a3, -1
  bc = c->sgpr64(a3) == 0;                          // beq a3, r0, L84
...
block_2:
  ...
  c->daddiu(a1, a1, 128);                           // daddiu a1, a1, 128
  c->daddiu(a3, a3, -1);                            // daddiu a3, a3, -1
  bc = c->sgpr64(a3) != 0;                          // bne a3, r0, L83
  c->gprs[t0].du64[0] = vis[2];                     // cfc2.ni t0, vi2
  if (bc) {goto block_2;}                           // branch non-likely


block_18:
  bc = c->sgpr64(a0) == 0;                          // beq a0, r0, L85
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_20;}                          // branch non-likely
...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(a2) != 0;                          // bne a2, r0, L78
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_2;}                           // branch non-likely
...
//   bc = c->sgpr64(t3) != 0;                          // bne t3, r0, L80
...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(v1) != 0;                          // bne v1, r0, L73
...
block_3:
  ...
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L75
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_5;}                           // branch non-likely
...
block_6:
  ...
  bc = c->sgpr64(v1) != 0;                          // bne v1, r0, L74
  // nop                                            // sll r0, r0, 0
...
//   c->andi(a2, a2, 256);                             // andi a2, a2, 256
//   bc = c->sgpr64(a2) == 0;                          // beq a2, r0, L22
//   DANGER jump to delay slot, this MUST be fixed manually!
...
//   c->daddiu(a2, a2, 1);                             // daddiu a2, a2, 1
//   bc = c->sgpr64(a3) != 0;                          // bne a3, r0, L21
...
block_19:
  bc = c->sgpr64(gp) != 0;                          // bne gp, r0, L34
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_21;}                          // branch non-likely
...
//   c->andi(a3, a3, 256);                             // andi a3, a3, 256
//   bc = c->sgpr64(a3) == 0;                          // beq a3, r0, L37
//   DANGER jump to delay slot, this MUST be fixed manually!
...
//   c->daddiu(a3, a3, 1);                             // daddiu a3, a3, 1
//   bc = c->sgpr64(t0) != 0;                          // bne t0, r0, L36
//   c->sw(a3, 0, a2);                                 // sw a3, 0(a2)
//   if (bc) {goto block_23;}                          // branch non-likely

  c->gprs[a1].du64[0] = 0;                          // or a1, r0, r0
  c->lwu(s2, 12, v1);                               // lwu s2, 12(v1)
  bc = c->sgpr64(s2) == 0;                          // beq s2, r0, L38
...
block_27:
  ...
  c->mov64(a1, a1);                                 // or a1, a1, r0
  bc = ((s64)c->sgpr64(a3)) < 0;                    // bltz a3, L40
  c->mov64(a2, a2);                                 // or a2, a2, r0
  if (bc) {goto block_30;}                          // branch non-likely
...
block_29:
  ...
  bc = ((s64)c->sgpr64(t2)) >= 0;                   // bgez t2, L39
  c->sq(t1, -16, a1);                               // sq t1, -16(a1)
  if (bc) {goto block_29;}                          // branch non-likely


block_30:
  bc = c->sgpr64(a0) == 0;                          // beq a0, r0, L41
...
block_38:
  ...
  bc = c->sgpr64(a0) == 0;                          // beq a0, r0, L44
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_40;}                          // branch non-likely
...
block_41:
  ...
  bc = c->sgpr64(a1) != 0;                          // bne a1, r0, L46
  c->mov64(a1, s7);                                 // or a1, s7, r0
...
block_44:
  ...
  bc = c->sgpr64(a3) == 0;                          // beq a3, r0, L49
  c->vmax_bc(DEST::xyzw, BC::w, vf9, vf0, vf0);     // vmaxw.xyzw vf9, vf0, vf0
  if (bc) {goto block_50;}                          // branch non-likely
  ...
  bc = ((s64)c->sgpr64(a0)) < 0;                    // bltz a0, L48
  ...
  bc = c->sgpr64(a0) == 0;                          // beq a0, r0, L49
  // DANGER jump to delay slot, this MUST be fixed manually!
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_50;}                          // branch non-likely
...
block_56:
  ...
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L66
  c->mov64(v1, s7);                                 // or v1, s7, r0
...
block_59:
  ...
  get_fake_spad_addr2(a0, cache.fake_scratchpad_data, 0, c);// lui a0, 28672
  c->lbu(a0, 6854, a0);                             // lbu a0, 6854(a0)
  bc = c->sgpr64(a0) != c->sgpr64(v1);              // bne a0, v1, L56
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_64;}                          // branch non-likely
  ...
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L54
  // nop                                            // sll r0, r0, 0
...
block_69:
  ...
  c->lbu(v1, 6955, v1);                             // lbu v1, 6955(v1)
  c->andi(v1, v1, 1);                               // andi v1, v1, 1
  if (((s64)c->sgpr64(v1)) == ((s64)0)) {           // beql v1, r0, L59
    c->mov64(v1, s7);                               // or v1, s7, r0
    goto block_72;
  }
...
block_72:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L63
  // nop                                            // sll r0, r0, 0
  ...
  bc = c->sgpr64(a1) == 0;                          // beq a1, r0, L60
  c->mov64(a1, s7);                                 // or a1, s7, r0
...
block_80:
  ...
  // nop                                            // sll r0, r0, 0
// dma sync
//   bc = c->sgpr64(t1) == 0;                          // beq t1, r0, L65
//   // nop                                            // sll r0, r0, 0
...
block_85:
  ...
  bc = c->sgpr64(s5) != c->sgpr64(v1);              // bne s5, v1, L67
  c->mov64(v1, s7);                                 // or v1, s7, r0
...
block_88:
  bc = c->sgpr64(s2) != 0;                          // bne s2, r0, L23
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_4;}                           // branch non-likely
...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L19
...
//   if (bc) {goto block_2;}                           // branch non-likely
  ...
  bc = c->sgpr64(s4) == c->sgpr64(a3);              // beq s4, a3, L18
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_6;}                           // branch non-likely
