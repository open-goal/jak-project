...
block_1:
  ...
  bc = c->sgpr64(s0) != 0;                          // bne s0, r0, L87
  // nop                                            // sll r0, r0, 0
  ...
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L85
  // nop                                            // sll r0, r0, 0
...
block_1:
  ...
  c->lw(v1, 100, s5);                               // lw v1, 100(s5)
  c->addiu(a0, r0, -1);                             // addiu a0, r0, -1
  bc = c->sgpr64(v1) == c->sgpr64(a0);              // beq v1, a0, L69
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_5;}                           // branch non-likely
...
block_7:
  c->lw(v1, 100, s5);                               // lw v1, 100(s5)
  c->addiu(a0, r0, -1);                             // addiu a0, r0, -1
  bc = c->sgpr64(v1) == c->sgpr64(a0);              // beq v1, a0, L71
...
block_12:
  c->lw(t9, 112, s5);                               // lw t9, 112(s5)
  bc = c->sgpr64(t9) == 0;                          // beq t9, r0, L73
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_14;}                          // branch non-likely
...
block_20:
  ...
  // nop                                            // sll r0, r0, 0
  c->lq(v1, 48, sp);                                // lq v1, 48(sp)
  bc = ((s64)c->sgpr64(v1)) > 0;                    // bgtz v1, L76
  // nop                                            // sll r0, r0, 0
...
block_24:
  ...
  c->lw(a0, 104, s5);                               // lw a0, 104(s5)
  c->andi(a1, a0, 2);                               // andi a1, a0, 2
  bc = c->sgpr64(a1) == 0;                          // beq a1, r0, L79
  c->andi(a1, a0, 4);                               // andi a1, a0, 4
...
block_27:
  ...
  c->pcpyud(v1, v1, r0);                            // pcpyud v1, v1, r0
  c->pexew(v1, v1);                                 // pexew v1, v1
  bc = ((s64)c->sgpr64(v1)) <= 0;                   // blez v1, L81
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_32;}                          // branch non-likely
...
block_29:
  ...
  c->pcpyud(v1, v1, r0);                            // pcpyud v1, v1, r0
  c->pexew(v1, v1);                                 // pexew v1, v1
  bc = ((s64)c->sgpr64(v1)) < 0;                    // bltz v1, L81
  c->mov128_gpr_vf(v1, vf9);                        // qmfc2.i v1, vf9
  if (bc) {goto block_32;}                          // branch non-likely

  c->pcpyud(v1, v1, r0);                            // pcpyud v1, v1, r0
  c->pexew(v1, v1);                                 // pexew v1, v1
  bc = ((s64)c->sgpr64(v1)) >= 0;                   // bgez v1, L82
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_33;}                          // branch non-likely
...
block_33:
  ...
  c->daddiu(s5, s5, 144);                           // daddiu s5, s5, 144
  c->daddiu(s4, s4, 48);                            // daddiu s4, s4, 48
  bc = c->sgpr64(s3) != 0;                          // bne s3, r0, L68
