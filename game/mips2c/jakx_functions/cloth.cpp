...
block_3:
  ...
  bc = ((s64)c->sgpr64(t3)) >= 0;                   // bgez t3, L182
  // nop                                            // sll r0, r0, 0
...
block_6:
  ...
  bc = c->sgpr64(t3) != 0;                          // bne t3, r0, L181
  // nop                                            // sll r0, r0, 0
...
block_8:
  ...
  bc = c->sgpr64(t1) != 0;                          // bne t1, r0, L180
  // nop                                            // sll r0, r0, 0
...
block_10:
  ...
  bc = c->sgpr64(t0) != 0;                          // bne t0, r0, L179
  // nop                                            // sll r0, r0, 0
