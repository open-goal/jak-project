...
void link() {
  ...
  gLinkedFunctionTable.reg("sparticle-motion-blur", execute, 256);
}
...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(v1) == c->sgpr64(s7);              // beq v1, s7, L312
  ...
  bc = c->sgpr64(v1) == c->sgpr64(s7);              // beq v1, s7, L314
  c->sq(s2, 48, sp);                                // sq s2, 48(sp)
  if (bc) {goto block_8;}                           // branch non-likely

  bc = c->sgpr64(a3) != c->sgpr64(s7);              // bne a3, s7, L313
  c->lui(v1, 16256);                                // lui v1, 16256
  if (bc) {goto block_7;}                           // branch non-likely

  bc = c->sgpr64(t0) != c->sgpr64(s7);              // bne t0, s7, L313
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_7;}                           // branch non-likely

  bc = c->sgpr64(t1) != c->sgpr64(v1);              // bne t1, v1, L313
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_7;}                           // branch non-likely
...
block_8:
  ...
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(s0) == c->sgpr64(s7);              // beq s0, s7, L315
  ...
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L338
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_64;}                          // branch non-likely

  //beq r0, r0, L316                                // beq r0, r0, L316
  // nop                                            // sll r0, r0, 0
...
block_12:
  ...
  bc = c->sgpr64(s1) == c->sgpr64(s7);              // beq s1, s7, L317
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_15;}                          // branch non-likely

  c->lw(v1, 12, s1);                                // lw v1, 12(s1)
  bc = c->sgpr64(v1) == c->sgpr64(s7);              // beq v1, s7, L317
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_15;}                          // branch non-likely
...
block_15:
  ...
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L318
  // nop                                            // sll r0, r0, 0
...
block_18:
  bc = c->sgpr64(s6) != c->sgpr64(s7);              // bne s6, s7, L321
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_26;}                          // branch non-likely

  bc = c->sgpr64(s1) == c->sgpr64(s7);              // beq s1, s7, L319
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_24;}                          // branch non-likely

  c->lw(v1, 12, s1);                                // lw v1, 12(s1)
  bc = c->sgpr64(v1) == c->sgpr64(s7);              // beq v1, s7, L319
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_24;}                          // branch non-likely
  ...
  bc = c->sgpr64(v1) == 0;                          // beq v1, r0, L319
  c->lb(v1, 28, s1);                                // lb v1, 28(s1)
  if (bc) {goto block_24;}                          // branch non-likely

  c->lui(a1, 1);                                    // lui a1, 1
  c->and_(a1, a0, a1);                              // and a1, a0, a1
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a1) != 0;                          // bne a1, r0, L320
  // nop                                            // sll r0, r0, 0
...
block_28:
  c->gprs[v1].du64[0] = vi14;                       // cfc2.i v1, vi14
  c->sb(v1, 129, s2);                               // sb v1, 129(s2)
  bc = c->sgpr64(s1) == c->sgpr64(s7);              // beq s1, s7, L323
...
block_31:
  ...
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(s0) == c->sgpr64(s7);              // beq s0, s7, L327
  // nop                                            // sll r0, r0, 0
  ...
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a1) == 0;                          // beq a1, r0, L327
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_40;}                          // branch non-likely

  c->lw(t0, 0, s1);                                 // lw t0, 0(s1)
...
block_34:
  ...
  if (((s64)c->sgpr64(s6)) != ((s64)c->sgpr64(s7))) {// bnel s6, s7, L325
...
block_38:
  ...
  // nop                                            // sll r0, r0, 0
  c->subu(v1, t0, a2);                              // subu v1, t0, a2
  // nop                                            // sll r0, r0, 0
  c->sw(v1, 136, s2);                               // sw v1, 136(s2)
  // nop                                            // sll r0, r0, 0
  //beq r0, r0, L327                                // beq r0, r0, L327
  // nop                                            // sll r0, r0, 0
  goto block_40;                                    // branch always

  
block_39:
  bc = c->sgpr64(a2) != 0;                          // bne a2, r0, L324
...
block_40:
  ...
  c->daddiu(v1, v1, -63);                           // daddiu v1, v1, -63
  bc = ((s64)c->sgpr64(v1)) >= 0;                   // bgez v1, L328
...
block_42:
  bc = c->sgpr64(s6) == c->sgpr64(s7);              // beq s6, s7, L329
  // nop                                            // sll r0, r0, 0
...
block_44:
  bc = c->sgpr64(s0) == c->sgpr64(s7);              // beq s0, s7, L330
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_48;}                          // branch non-likely

  c->lw(a2, 12, s0);                                // lw a2, 12(s0)
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a2) == c->sgpr64(s7);              // beq a2, s7, L330
  c->daddiu(a0, sp, 192);                           // daddiu a0, sp, 192
  if (bc) {goto block_48;}                          // branch non-likely

  bc = c->sgpr64(a2) == 0;                          // beq a2, r0, L330
  c->mov64(a1, s2);                                 // or a1, s2, r0
  if (bc) {goto block_48;}                          // branch non-likely
...
block_48:
  ...
  c->ori(a1, a3, 4715);                             // ori a1, a3, 4715
  if (((s64)c->sgpr64(a0)) != ((s64)0)) {           // bnel a0, r0, L331
...
block_54:
  c->andi(v1, s5, 32896);                           // andi v1, s5, 32896
  c->ori(a0, r0, 32768);                            // ori a0, r0, 32768
  bc = c->sgpr64(v1) != c->sgpr64(a0);              // bne v1, a0, L334
  c->load_symbol2(a0, cache.time_of_day_context);   // lw a0, *time-of-day-context*(s7)
  if (bc) {goto block_56;}                          // branch non-likely

  c->lqc2(vf4, 156, a0);                            // lqc2 vf4, 156(a0)
  // nop                                            // sll r0, r0, 0
...
block_56:
  // nop                                            // sll r0, r0, 0
  c->andi(v1, s5, 128);                             // andi v1, s5, 128
  bc = c->sgpr64(v1) != 0;                          // bne v1, r0, L335
  c->lqc2(vf5, 224, sp);                            // lqc2 vf5, 224(sp)
...
block_58:
  ...
  // nop                                            // sll r0, r0, 0
  c->sw(s7, 132, s2);                               // sw s7, 132(s2)
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(s1) == c->sgpr64(s7);              // beq s1, s7, L336
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_60;}                          // branch non-likely

  c->lw(v1, 32, s1);                                // lw v1, 32(s1)
  // nop                                            // sll r0, r0, 0
...
block_60:
  ...
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(s0) == c->sgpr64(s7);              // beq s0, s7, L337
  c->lui(v1, 16256);                                // lui v1, 16256
  ...
  c->mfc1(v1, f2);                                  // mfc1 v1, f2
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(v1) != 0;                          // bne v1, r0, L316
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_12;}                          // branch non-likely

  //beq r0, r0, L338                                // beq r0, r0, L338
  // nop                                            // sll r0, r0, 0
...
void link() {
  ...
  gLinkedFunctionTable.reg("sp-launch-particles-var", execute, 256);
}
...
void link() {
  ...
  gLinkedFunctionTable.reg("particle-adgif", execute, 256);
}
...
block_1:
  ...
  // nop                                            // sll r0, r0, 0
  // nop                                            // sll r0, r0, 0
  if (((s64)c->sgpr64(a1)) < 0) {                   // bltzl a1, L367
...
block_3:
  ...
  // nop                                            // sll r0, r0, 0
  bc = ((s64)c->sgpr64(a1)) >= 0;                   // bgez a1, L382
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_44;}                          // branch non-likely
...
block_4:
  c->lh(a1, 0, v0);                                 // lh a1, 0(v0)
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a1) != c->sgpr64(a2);              // bne a1, a2, L380
  ...
  bc = c->sgpr64(a1) == c->sgpr64(t1);              // beq a1, t1, L370
  c->addiu(t1, r0, 2);                              // addiu t1, r0, 2
  if (bc) {goto block_18;}                          // branch non-likely

  bc = c->sgpr64(a1) == c->sgpr64(t1);              // beq a1, t1, L374
  c->addiu(t1, r0, 7);                              // addiu t1, r0, 7
  if (bc) {goto block_28;}                          // branch non-likely

  bc = c->sgpr64(a1) == c->sgpr64(t1);              // beq a1, t1, L372
  c->addiu(t1, r0, 3);                              // addiu t1, r0, 3
  if (bc) {goto block_23;}                          // branch non-likely

  bc = c->sgpr64(a1) == c->sgpr64(t1);              // beq a1, t1, L375
  c->addiu(t1, r0, 5);                              // addiu t1, r0, 5
  if (bc) {goto block_31;}                          // branch non-likely

  bc = c->sgpr64(a1) == c->sgpr64(t1);              // beq a1, t1, L377
  c->addiu(t1, r0, 6);                              // addiu t1, r0, 6
  if (bc) {goto block_35;}                          // branch non-likely

  bc = c->sgpr64(a1) == c->sgpr64(t1);              // beq a1, t1, L378
  c->addiu(t1, r0, 4);                              // addiu t1, r0, 4
  if (bc) {goto block_37;}                          // branch non-likely

  bc = c->sgpr64(a1) == c->sgpr64(t1);              // beq a1, t1, L379
  c->addiu(t1, r0, 8);                              // addiu t1, r0, 8
  if (bc) {goto block_39;}                          // branch non-likely

  bc = c->sgpr64(a1) == c->sgpr64(t1);              // beq a1, t1, L376
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_33;}                          // branch non-likely

  bc = c->sgpr64(t2) == 0;                          // beq t2, r0, L369
  // nop                                            // sll r0, r0, 0
  ...
  bc = c->sgpr64(a2) != c->sgpr64(a3);              // bne a2, a3, L368
  c->daddiu(v0, v0, 16);                            // daddiu v0, v0, 16
  if (bc) {goto block_4;}                           // branch non-likely
...
block_18:
  bc = c->sgpr64(t2) == 0;                          // beq t2, r0, L371
  c->vrxor(vf2, BC::w);                             // vrxorw vf2
...
block_23:
  bc = c->sgpr64(t2) == 0;                          // beq t2, r0, L373
  c->vrxor(vf2, BC::w);                             // vrxorw vf2
  if (bc) {goto block_26;}                          // branch non-likely
...
block_41:
  if (((s64)c->sgpr64(t0)) != ((s64)c->sgpr64(s7))) {// bnel t0, s7, L381
