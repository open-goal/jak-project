...
void link() {
  gLinkedFunctionTable.reg("ripple-matrix-scale", execute, 256);
}
...
void link() {
  ...
  gLinkedFunctionTable.reg("ripple-apply-wave-table", execute, 256);
}
...
void link() {
  ...
  gLinkedFunctionTable.reg("ripple-create-wave-table", execute, 256);
}
...
void link() {
  ...
  gLinkedFunctionTable.reg("ripple-execute-init", execute, 256);
}
