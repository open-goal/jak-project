...
block_2:
  ...
  c->lwu(t2, 16, a0);                               // lwu t2, 16(a0)
  c->lwu(t2, 44, t2);                               // lwu t2, 44(t2)
  c->sw(t2, 24, t0);                                // sw t2, 24(t0)
  c->lwu(t2, 28, a0);                               // lwu t2, 28(a0)
  ...
  c->addiu(a1, r0, 480);                            // addiu a1, r0, 480
  c->lbu(t1, 130, a0);                              // lbu t1, 130(a0)
...
block_8:
  ...
  c->addiu(t0, r0, 9264);                           // addiu t0, r0, 9264
  get_fake_spad_addr2(t2, cache.fake_scratchpad_data, 0, c);// lui t2, 28672
...
void link() {
  ...
  gLinkedFunctionTable.reg("foreground-check-longest-edge-asm", execute, 256);
}
...
void link() {
  ...
  gLinkedFunctionTable.reg("foreground-generic-merc", execute, 512);
}
