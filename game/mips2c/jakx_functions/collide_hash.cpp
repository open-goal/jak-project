...
block_8:
  ...
  c->lw(s4, 124, a0);                               // lw s4, 124(a0)
  c->dsubu(s2, s3, s2);                             // dsubu s2, s3, s2
  // nop                                            // sll r0, r0, 0
...
void link() {
  ...
  gLinkedFunctionTable.reg("fill-bg-using-line-sphere-new", execute, 512);
}
...
block_10:
  ...
  c->lw(s3, 4, a0);                                 // lw s3, 4(a0)
  c->lw(s5, 124, a0);                               // lw s5, 124(a0)
  c->dsubu(s3, s4, s3);                             // dsubu s3, s4, s3
  // nop                                            // sll r0, r0, 0
...
void link() {
  ...
  cache.debug = intern_from_c(-1, 0, "debug").c();
  cache.print_exceeded_max_cache_tris = intern_from_c(-1, 0, "print-exceeded-max-cache-tris").c();
  gLinkedFunctionTable.reg("fill-bg-using-box-new", execute, 512);
}
...
void link() {
  cache.fake_scratchpad_data = intern_from_c(-1, 0, "*fake-scratchpad-data*").c();
  gLinkedFunctionTable.reg("(method 12 collide-hash)", execute, 512);
}
