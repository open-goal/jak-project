...
u64 execute(void* ctxt) {
  ...
  bc = c->sgpr64(t0) == 0;                          // beq t0, r0, L119
  // nop                                            // sll r0, r0, 0
...
u64 execute(void* ctxt) {
  ...
  c->daddiu(a2, a0, 1424);                          // daddiu a2, a0, 1424
  ...
  block_3:
  c->daddiu(a3, a0, 1008);                          // daddiu a3, a0, 1008
  ...
  c->lui(t0, 17727);                                // lui t0, 17727
  c->ori(t0, t0, 61440);                            // ori t0, t0, 61440
...
void link() {
  cache.math_camera = intern_from_c("*math-camera*").c();
  gLinkedFunctionTable.reg("(method 16 sky-work)", execute, 64);
}
...
u64 execute(void* ctxt) {
  ...
  c->daddiu(v1, a0, 1424);                          // daddiu v1, a0, 1424
...
u64 execute(void* ctxt) {
  ...
  c->lqc2(vf31, 1488, gp);                          // lqc2 vf31, 1488(gp)
  c->lqc2(vf30, 1504, gp);                          // lqc2 vf30, 1504(gp)
  c->lqc2(vf29, 1520, gp);                          // lqc2 vf29, 1520(gp)
  ...
  // nop                                            // sll r0, r0, 0
  bc = ((s64)c->sgpr64(a2)) >= 0;                   // bgez a2, L33
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_3;}                           // branch non-likely
  ...
  block_3:
  bc = ((s64)c->sgpr64(a3)) >= 0;                   // bgez a3, L34
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_5;}                           // branch non-likely
  ...
  block_5:
  bc = ((s64)c->sgpr64(t0)) >= 0;                   // bgez t0, L35
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_7;}                           // branch non-likely
  ...
  block_7:
  bc = ((s64)c->sgpr64(t1)) >= 0;                   // bgez t1, L36
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_9;}                           // branch non-likely
  ...
  block_9:
  c->sqc2(vf15, 1888, v1);                          // sqc2 vf15, 1888(v1)
  // nop                                            // sll r0, r0, 0
  c->sqc2(vf16, 1904, v1);                          // sqc2 vf16, 1904(v1)
  // nop                                            // sll r0, r0, 0
  c->sqc2(vf17, 1920, v1);                          // sqc2 vf17, 1920(v1)
  // nop                                            // sll r0, r0, 0
  c->sqc2(vf18, 1936, v1);                          // sqc2 vf18, 1936(v1)
  ...
  c->daddiu(v1, v1, 1888);                          // daddiu v1, v1, 1888
  ...
  bc = c->sgpr64(v1) != 0;                          // bne v1, r0, L38
  // nop                                            // sll r0, r0, 0
...
u64 execute(void* ctxt) {
  ...
  c->sw(gp, 1868, s5);                              // sw gp, 1868(s5)
  c->load_symbol2(t9, cache.lookup_texture_by_id_fast);// lw t9, lookup-texture-by-id-fast(s7)
  c->lui(v1, 18256);                                // lui v1, 18256
  c->ori(a0, v1, 1280);                             // ori a0, v1, 1280
  call_addr = c->gprs[t9].du32[0];                  // function call:
  c->sll(v0, ra, 0);                                // sll v0, ra, 0
  c->jalr(call_addr);                               // jalr ra, t9
  c->mov64(a1, v0);                                 // or a1, v0, r0
  bc = c->sgpr64(s7) == c->sgpr64(a1);              // beq s7, a1, L30
  c->mov64(a3, s7);                                 // or a3, s7, r0
  if (bc) {goto block_15;}                          // branch non-likely

  c->lwu(v1, 1868, s5);                             // lwu v1, 1868(s5)
  ...
  c->lwu(a0, 1868, s5);                             // lwu a0, 1868(s5)
  c->sw(v1, 4, a0);                                 // sw v1, 4(a0)
  c->lw(a3, 4, gp);                                 // lw a3, 4(gp)
  c->mov64(v1, s5);                                 // or v1, s5, r0
  c->addiu(a1, r0, 0);                              // addiu a1, r0, 0
  c->lqc2(vf2, 784, s5);                            // lqc2 vf2, 784(s5)
  c->lqc2(vf5, 800, s5);                            // lqc2 vf5, 800(s5)
  ...
  block_3:
  c->lqc2(vf15, 1888, v1);                          // lqc2 vf15, 1888(v1)
  c->daddiu(v1, v1, 16);                            // daddiu v1, v1, 16
  c->vmula_bc(DEST::xyzw, BC::x, vf31, vf15);       // vmulax.xyzw acc, vf31, vf15
  c->lqc2(vf1, 384, s5);                            // lqc2 vf1, 384(s5)
  c->vmadda_bc(DEST::xyzw, BC::y, vf30, vf15);      // vmadday.xyzw acc, vf30, vf15
  c->lqc2(vf4, 400, s5);                            // lqc2 vf4, 400(s5)
  ...
  c->lqc2(vf3, 528, a2);                            // lqc2 vf3, 528(a2)
  ...
  c->sqc2(vf1, 1552, s5);                           // sqc2 vf1, 1552(s5)
  c->sqc2(vf4, 1568, s5);                           // sqc2 vf4, 1568(s5)
  c->lw(a2, 1552, s5);                              // lw a2, 1552(s5)
  c->ori(t0, r0, 36864);                            // ori t0, r0, 36864
  c->slt(a2, a2, t0);                               // slt a2, a2, t0
  c->daddiu(t0, s7, 4);                             // daddiu t0, s7, 4
  c->movz(t0, s7, a2);                              // movz t0, s7, a2
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(t0))) {// beql s7, t0, L27
    c->mov64(a2, t0);                               // or a2, t0, r0
    goto block_10;
  }

  c->lw(a2, 1556, s5);                              // lw a2, 1556(s5)
  ...
  bc = c->sgpr64(a2) != 0;                          // bne a2, r0, L26
  // nop                                            // sll r0, r0, 0
  if (bc) {goto block_3;}                           // branch non-likely
...
void link() {
  cache.adgif_shader_texture_simple = intern_from_c("adgif-shader<-texture-simple!").c();
  cache.lookup_texture_by_id_fast = intern_from_c("lookup-texture-by-id-fast").c();
  gLinkedFunctionTable.reg("(method 33 sky-work)", execute, 256);
}
...
u64 execute(void* ctxt) {
  ...
  c->lqc2(vf15, 1168, gp);                          // lqc2 vf15, 1168(gp)
  c->vmula_bc(DEST::xyzw, BC::x, vf31, vf15);       // vmulax.xyzw acc, vf31, vf15
  ...
  c->lqc2(vf3, 416, gp);                            // lqc2 vf3, 416(gp)
  c->lqc2(vf6, 432, gp);                            // lqc2 vf6, 432(gp)
  c->vwaitq();                                      // vwaitq
  c->vmulq(DEST::xyz, vf15, vf15);                  // vmulq.xyz vf15, vf15, Q
  ...
  c->vftoi4(DEST::xyzw, vf4, vf4);                  // vftoi4.xyzw vf4, vf4
  c->sqc2(vf1, 1552, gp);                           // sqc2 vf1, 1552(gp)
  c->sqc2(vf4, 1568, gp);                           // sqc2 vf4, 1568(gp)
  c->lw(v1, 1564, gp);                              // lw v1, 1564(gp)
  ...
  block_3:
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(v1))) {// beql s7, v1, L54
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_12;
  }

  c->lw(v1, 1552, gp);                              // lw v1, 1552(gp)
  c->ori(a0, r0, 36864);                            // ori a0, r0, 36864
  c->slt(v1, v1, a0);                               // slt v1, v1, a0
  c->daddiu(a0, s7, 4);                             // daddiu a0, s7, 4
  c->movz(a0, s7, v1);                              // movz a0, s7, v1
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(a0))) {// beql s7, a0, L54
    c->mov64(v1, a0);                               // or v1, a0, r0
    goto block_12;
  }

  c->lw(v1, 1556, gp);                              // lw v1, 1556(gp)
  ...
  c->lwu(v1, 1868, gp);                             // lwu v1, 1868(gp)
  c->lwu(v1, 4, v1);                                // lwu v1, 4(v1)
  ...
  c->lwu(a0, 1868, gp);                             // lwu a0, 1868(gp)
  c->sw(v1, 4, a0);                                 // sw v1, 4(a0)
...
void link() {
  cache.adgif_shader_texture_simple = intern_from_c("adgif-shader<-texture-simple!").c();
  cache.lookup_texture_by_id_fast = intern_from_c("lookup-texture-by-id-fast").c();
  gLinkedFunctionTable.reg("(method 28 sky-work)", execute, 128);
}
...
u64 execute(void* ctxt) {
  ...
  c->lqc2(vf15, 1232, gp);                          // lqc2 vf15, 1232(gp)
  c->vmula_bc(DEST::xyzw, BC::x, vf31, vf15);       // vmulax.xyzw acc, vf31, vf15
  ...
  block_3:
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(v1))) {// beql s7, v1, L50
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_12;
  }
  ...
  c->daddiu(a0, s7, 4);                             // daddiu a0, s7, 4
  c->movz(a0, s7, v1);                              // movz a0, s7, v1
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(a0))) {// beql s7, a0, L50
    c->mov64(v1, a0);                               // or v1, a0, r0
    goto block_12;
  }
...
u64 execute(void* ctxt) {
  ...
  c->load_symbol2(t9, cache.lookup_texture_by_id_fast);// lw t9, lookup-texture-by-id-fast(s7)
  c->lui(v1, 18256);                                // lui v1, 18256
  c->ori(a0, v1, 256);                              // ori a0, v1, 256
  call_addr = c->gprs[t9].du32[0];                  // function call:
  c->sll(v0, ra, 0);                                // sll v0, ra, 0
  c->jalr(call_addr);                               // jalr ra, t9
  c->sw(v0, 20, sp);                                // sw v0, 20(sp)
  c->lwu(v1, 16, sp);                               // lwu v1, 16(sp)
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(v1))) {// beql s7, v1, L44
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_3;
  }
  ...
  block_3:
  bc = c->sgpr64(s7) == c->sgpr64(v1);              // beq s7, v1, L47
  c->mov64(v1, s7);                                 // or v1, s7, r0
  if (bc) {goto block_17;}                          // branch non-likely

  c->lqc2(vf15, 1296, gp);                          // lqc2 vf15, 1296(gp)
  c->vmula_bc(DEST::xyzw, BC::x, vf31, vf15);       // vmulax.xyzw acc, vf31, vf15
  ...
  c->sqc2(vf7, 1552, gp);                           // sqc2 vf7, 1552(gp)
  c->sqc2(vf10, 1568, gp);                          // sqc2 vf10, 1568(gp)
  c->lw(v1, 1564, gp);                              // lw v1, 1564(gp)
  c->mtc1(f0, v1);                                  // mtc1 f0, v1
  c->mtc1(f1, r0);                                  // mtc1 f1, r0
  cop1_bc = c->fprs[f0] < c->fprs[f1];              // c.lt.s f0, f1
  ...
  block_6:
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(v1))) {// beql s7, v1, L46
    c->mov64(v1, v1);                               // or v1, v1, r0
    goto block_15;
  }
  ...
  c->daddiu(a0, s7, 4);                             // daddiu a0, s7, 4
  c->movz(a0, s7, v1);                              // movz a0, s7, v1
  if (((s64)c->sgpr64(s7)) == ((s64)c->sgpr64(a0))) {// beql s7, a0, L46
    c->mov64(v1, a0);                               // or v1, a0, r0
    goto block_15;
  }
