...
void link() {
  cache.fake_scratchpad_data = intern_from_c("*fake-scratchpad-data*").c();
  cache.warp_shader = intern_from_c("*warp-shader*").c();
  cache.generic_no_light_proc = intern_from_c("generic-no-light-proc").c();
  cache.generic_warp_dest_proc = intern_from_c("generic-warp-dest-proc").c();
