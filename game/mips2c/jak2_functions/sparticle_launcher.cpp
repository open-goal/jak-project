...
u64 execute(void* ctxt) {
  ...
  // nop                                            // sll r0, r0, 0
  // nop                                            // sll r0, r0, 0
  if (((s64)c->sgpr64(a1)) < 0) {                   // bltzl a1, L277
  ...
  c->lh(a1, 0, v0);                                 // lh a1, 0(v0)
  // nop                                            // sll r0, r0, 0
  bc = c->sgpr64(a1) != c->sgpr64(a2);              // bne a1, a2, L290
  ...
  bc = c->sgpr64(a2) != c->sgpr64(a3);              // bne a2, a3, L278
  c->daddiu(v0, v0, 16);                            // daddiu v0, v0, 16
  ...
  block_20:
  bc = c->sgpr64(t2) == 0;                          // beq t2, r0, L282
  c->vrxor(vf2, BC::w);                             // vrxorw vf2
  ...
  block_25:
  bc = c->sgpr64(t2) == 0;                          // beq t2, r0, L284
  c->vrxor(vf2, BC::w);                             // vrxorw vf2
  ...
  block_41:
  if (((s64)c->sgpr64(t0)) != ((s64)c->sgpr64(s7))) {// bnel t0, s7, L291
...
void link() {
  ...
  cache.sp_temp = intern_from_c("*sp-temp*").c();
