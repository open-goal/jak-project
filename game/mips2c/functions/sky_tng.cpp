...
end_of_function:
  sky_regs_vfs.copy_vfs_from_other(c);  // added, saves vfs in setup.
...
void link() {
  ...
  gLinkedFunctionTable.reg("init-sky-regs", execute, 64);
}
...
void link() {
  gLinkedFunctionTable.reg("clip-polygon-against-positive-hyperplane", execute, 64);
}
...
void link() {
  gLinkedFunctionTable.reg("clip-polygon-against-negative-hyperplane", execute, 64);
}

}  // namespace clip_polygon_against_negative_hyperplane
}  // namespace Mips2C
// add clip_polygon_against_negative_hyperplane::link to the link callback table for the object
// file. FWD DEC:
namespace clip_polygon_against_negative_hyperplane {
extern void link();
}
...
void link() {
  cache.clip_polygon_against_negative_hyperplane =
      intern_from_c("clip-polygon-against-negative-hyperplane").c();
  cache.clip_polygon_against_positive_hyperplane =
      intern_from_c("clip-polygon-against-positive-hyperplane").c();
  gLinkedFunctionTable.reg("draw-large-polygon", execute, 128);
}
