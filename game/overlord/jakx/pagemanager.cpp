...
void jakx_overlord_init_globals_pagemanager() {
 ...
 */
CPageList* CPageManager::GrowPageList(jakx::CPageList* in, int page_count) {
  ASSERT(in);
 ...
 */
void CPageManager::FreePageList(jakx::CPageList* list) {
  ASSERT(list);
 ...
 */
void CPageManager::GarbageCollectPageList(jakx::CPageList* list) {
  ASSERT(list);
  list->GarbageCollect();
