...
InstructionARM64 load32_simd32_gpr64_plus_gpr64(Register simd_dest, Register addr1, Register addr2);
 ...
 */
InstructionARM64 store128_gpr64_simd128(Register gpr_addr, Register simd_value);
