...
Val* Compiler::compile_defmethod(const goos::Object& form, const goos::Object& _rest, Env* env) {
  ...
  lambda.debug_name = fmt::format("(method {} {})", method_name.print(), type_name);
  ...
  auto method_info = m_ts.lookup_method(type_name, symbol_string(method_name));
  ...
  auto info = m_ts.define_method(type_name, symbol_string(method_name), lambda_ts, docstring);
