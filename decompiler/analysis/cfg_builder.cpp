...
//    }
//    //        auto condition_as_seq =
//    dynamic_cast<IR_Begin*>(cne->entries.front().condition.get());
...
//  }
//
//  bool is_arith = is_op_3(dsrav_candidate, SimpleExpression::Kind::RIGHT_SHIFT_ARITH,
//  result.reg(),
...
//    // an else which is actually more cases and compacts it into a single statement.  At this
//    point
...
//        entries.push_back(std::move(e));
//      }
//      auto result = pool.alloc_single_element_form<CondWithElseElement>(nullptr, entries,
//      else_ir); clean_up_cond_with_else(
