...
inline const FlavaSet* lookup(std::string music_name) {
  ...
  static const std::map<std::string, FlavaSet> table = {
      ...
      {"jungle",
       {0,
        {{"none", 0}, {"jungle-temple-exit", 1}, {"jungle-lurkerm", 2}, {"jungle-temple-top", 3}}}},
      {"jungleb", {0, {{"none", 0}, {"jungleb-eggtop", 1}}}},
      {"beach",
       {0,
        {{"none", 0},
         {"beach-sentinel", 1},
         ...
         {"beach-grotto", 3},
         {"birdlady", 4}}}},
      {"misty", {0, {{"none", 0}, {"misty-battle", 1}, {"misty-boat", 2}, {"racer", 3}}}},
      {"firecany", {0, {{"none", 0}, {"racer", 1}, {"unused", 2}}}},
      {"village2",
       {0,
        {{"none", 0},
         {"sage", 1},
         ...
         {"gambler", 5},
         {"levitator", 6}}}},
      {"swamp", {0, {{"none", 0}, {"swamp-launcher", 2}, {"swamp-battle", 3}, {"flutflut", 4}}}},
      {"rolling", {0, {{"none", 0}, {"rolling-gorge", 1}}}},
      {"ogre", {0, {{"none", 0}, {"ogre-middle", 1}, {"ogre-end", 2}}}},
      {"village3",
       {0,
        {{"none", 0},
         {"miners", 1},
         ...
         {"to-snow", 5}}}},
      {"maincave",
       {0, {{"none", 0}, {"robocave", 1}, {"robocave-top", 2}, {"maincave", 3}, {"darkcave", 4}}}},
      {"snow",
       {0,
        {{"none", 0},
         {"snow-battle", 1},
